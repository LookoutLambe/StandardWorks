...
(function() {
  'use strict';
  var RSC_V = '392';   // bump when the generated data files change
  ...
  var TRANSLIT_TERMS = {"אדםאונדיאהמן":"Adam-ondi-Ahman","אהמן":"Ahman","שדולמק":"Shedolamak","אנישגואוןדוש":"Enish-go-on-dosh","יוגהיועי":"Jah-oh-eh","כעעענטרש":"Kae-e-vanrash","פלועיש":"Floeese","קליפלוסאיסאס":"Kli-flos-is-es","טימס":"Times","אנד":"and","סיזנס":"Seasons","סיזונס":"Seasons","ונטורת":"Wentworth","פרנקלין":"Franklin","סיטי":"City","נאבו":"Nauvoo","מסטר":"Mr.","כריס":"Chris","לאמב":"Lambe","אנתרופיק":"Anthropic","קלוד":"Claude","איפון":"iPhone","וינדזור":"Windsor","אירופה":"Europe"};
  ...
  function numeralNote(surface, glossText) {
    /* The gloss is the number itself, but it arrives dressed as the sentence
       ...
       falling through to a blank card in the Pearl of Great Price front
