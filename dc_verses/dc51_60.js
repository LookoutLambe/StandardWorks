...
var dc53_ch1Verses = [
  { num: "א", words: [["הִנֵּה","behold"], ["אֲנִי","I"], ["אֹמֵר","say"], ["לְךָ","unto thee"], ["עַבְדִּי","my servant"], ["סִידְנִי","Sidney"], ["גִּילְבֶּרְט","Gilbert"], ["שָׁמַעְתִּי","I have heard"], ["תְּפִלּוֹתֶיךָ","thy prayers"], ["וְקָרָאתָ","and thou hast called"], ["אֵלַי","upon me"], ["כִּי","that"], ["יוּדַע","(it) should be made known"], ["לְךָ","unto thee"], ["מֵאֵת","of"], ["יְהוָה","the Lord"], ["אֱלֹהֶיךָ","thy God"], ["עַל","concerning"], ["קְרִיאָתְךָ","thy calling"], ["וּבְחִירָתְךָ","and election"], ["בַּכְּנֵסִיָּה","in the church"], ["אֲשֶׁר","which"], ["אֲנִי","I"], ["יְהוָה","the Lord"], ["הֲקִימוֹתִי","have raised up"], ["בַּיָּמִים","in (the) days"], ["הָאַחֲרוֹנִים","the last"], ["הָאֵלֶּה׃","these"]]},
  { num: "ב", words: [
    ["הִנֵּה","behold"],
    ["אֲנִי","I"],
    ["יְהוָה","the Lord"],
...
var dc57_ch1Verses = [
  ...
  { num: "ו", words: [["וְעַבְדִּי","and (let) my servant"], ["סִידְנִי","Sidney"], ["גִילְבֶּרְט","Gilbert"], ["יַעֲמֹד","stand"], ["בַּתַּפְקִיד","in the office"], ["אֲשֶׁר","to which"], ["מִנִּיתִיו","I have appointed him"], ["לְקַבֵּל","to receive"], ["כְּסָפִים","moneys"], ["לִהְיוֹת","to be"], ["סוֹכֵן","an agent"], ["לַכְּנֵסִיָּה","unto the church"], ["לִקְנוֹת","to buy"], ["אֲרָצוֹת","lands"], ["בְּכׇל","in all"], ["הַסְּבִיבוֹת","the regions round about"], ["כַּאֲשֶׁר","inasmuch as"], ["יוּכַל","(it) can (be done)"], ["בְּצֶדֶק","in righteousness"], ["וְכַאֲשֶׁר","and as"], ["תַּנְחֶה","shall direct"], ["הַחׇכְמָה׃","the wisdom"]]},
  { num: "ז", words: [
...
var dc58_ch1Verses = [
  ...
  { num: "כג", words: [["הִנֵּה","behold"], ["הַחֻקִּים","the laws"], ["אֲשֶׁר","which"], ["קִבַּלְתֶּם","ye have received"], ["מִיָּדִי","from my hand"], ["הֵם","(are)"], ["חֻקֵּי","(the) laws of"], ["הַכְּנֵסִיָּה","the church"], ["וּבְאוֹר","and in (the) light"], ["זֶה","this"], ["תַּצִּיגוּם","ye shall hold them forth"], ["הִנֵּה","behold"], ["זֹאת","this (is)"], ["חׇכְמָה׃","wisdom"]]},
  { num: "כד", words: [
    ["וְעַתָּה","and now"],
    ["כַּאֲשֶׁר","as"],
