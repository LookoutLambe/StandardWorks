...
var dc51_ch1Verses = [
  ...
  { num: "ה", words: [["וְאִם","and if"], ["יִפְשַׁע","he shall transgress"], ["וְלֹא","and not"], ["יֵחָשֵׁב","is accounted"], ["רָאוּי","worthy"], ["לִהְיוֹת","to belong"], ["לַכְּנֵסִיָּה","to the church"], ["לֹא","not"], ["יִהְיֶה־לּוֹ","shall have unto him"], ["כֹּחַ","power"], ["לִדְרֹשׁ","to claim"], ["הַחֵלֶק","the portion"], ["אֲשֶׁר","which"], ["הִקְדִּישׁ","he has consecrated"], ["לַפָּקִיד","unto the bishop"], ["לַעֲנִיֵּי","for the poor"], ["וְאֶבְיוֹנֵי","and the needy of"], ["כְּנֵסִיָּתִי","my church"], ["לָכֵן","therefore"], ["לֹא","not"], ["יַחֲזִיק","he shall retain"], ["הַמַּתָּנָה","the gift"], ["כִּי","but"], ["אִם","rather"], ["יִדְרֹשׁ","shall claim"], ["רַק","only"], ["הַחֵלֶק","the portion"], ["הַנָּתוּן","that is given"], ["לוֹ","unto him"], ["בִּכְתָב׃","by deed"]]},
  { num: "ו", words: [
    ["וְכֵן","and thus"],
    ["יִהְיוּ","shall be"],
    ["כׇּל","all"],
...
var dc52_ch1Verses = [
  ...
  { num: "מב", words: [
    ...
    ["תִּהְיוּ","you are"],
    ["נֶאֱמָנִים","faithful"],
    ["תֵּאָסְפוּ","you shall assemble yourselves"],
...
var dc55_ch1Verses = [
  ...
  { num: "ג", words: [["וְעַל","and on"], ["כׇּל","every one"], ["אֲשֶׁר","whom"], ["תָּשִׂים","you shall lay"], ["יָדֶיךָ","your hands"], ["אִם","if"], ["הֵם","they are"], ["נִשְׁבְּרֵי","contrite of"], ["לֵב","heart"], ["לְפָנַי","before me"], ["יִהְיֶה־לְּךָ","shall be unto you"], ["כֹּחַ","power"], ["לָתֵת","to give"], ["רוּחַ","the Spirit of"], ["הַקֹּדֶשׁ׃","the Holy"]]},
...
var dc56_ch1Verses = [
  ...
  { num: "י", words: [["וְאִם","and if"], ["לֹא","not"], ["יְקַבֵּל","he shall receive"], ["הַכֶּסֶף","the money"], ["אֲשֶׁר","which"], ["שִׁלֵּם","he has paid"], ["וְיַעֲזֹב","and shall leave"], ["הַמָּקוֹם","the place"], ["וְיִכָּרֵת","and shall be cut off"], ["מִכְּנֵסִיָּתִי","out of my church"], ["אָמַר","says"], ["יְהוָה","the Lord"], ["אֱלֹהֵי","God of"], ["צְבָאוֹת׃","hosts"]]},
  { num: "יא", words: [
    ["וְאַף","even though"],
    ["כִּי","that"],
...
var dc58_ch1Verses = [
  ...
  { num: "כג", words: [["הִנֵּה","behold"], ["הַחֻקִּים","the laws"], ["אֲשֶׁר","which"], ["קִבַּלְתֶּם","you have received"], ["מִיָּדִי","from my hand"], ["הֵם","are"], ["חֻקֵּי","the laws of"], ["הַכְּנֵסִיָּה","the church"], ["וּבְאוֹר","and in the light"], ["זֶה","this"], ["תַּצִּיגוּם","you shall hold them forth"], ["הִנֵּה","behold"], ["זֹאת","this is"], ["חׇכְמָה׃","wisdom"]]},
  { num: "כד", words: [
    ["וְעַתָּה","and now"],
    ["כַּאֲשֶׁר","as"],
...
var dc59_ch1Verses = [
  ...
  { num: "ה", words: [
    ...
    ["יֵשׁוּעַ","Jesus"],
    ["הַמָּשִׁיחַ","Christ"],
    ["תַּעַבְדֶנּוּ׃","you shall serve him"]
  ]},
  { num: "ו", words: [
    ["וְאָהַבְתָּ","you shall love"],
    ["לְרֵעֲךָ","your neighbor"],
    ["כָּמוֹךָ","as thyself"],
    ["לֹא","not"],
    ["תִגְנֹב","shall you steal"],
    ["וְלֹא","and not"],
    ["תִנְאָף","commit adultery"],
    ["וְלֹא","and not"],
    ["תִרְצָח","kill"],
    ["וְלֹא","and not"],
    ["תַעֲשֶׂה","shall you do"],
    ["כׇּל","any"],
    ["דָּבָר","thing"],
    ["הַדּוֹמֶה","like"],
    ["לָזֶה׃","unto this"]
  ...
  { num: "ח", words: [
    ["וְהִקְרַבְתָּ","and you shall offer"],
  ...
  { num: "ט", words: [
    ["וּלְמַעַן","and that"],
    ["תִּשָּׁמֵר","you may keep thyself"],
    ["יוֹתֵר","more"],
    ["נָקִי","unspotted"],
    ["מִן","from"],
    ["הָעוֹלָם","the world"],
    ["תֵּלֵךְ","you shall go"],
  ...
  { num: "יב", words: [
    ...
    ["יוֹם","the day of"],
    ["יְהוָה","the Lord"],
    ["תַּקְרִיב","you shall offer"],
    ["מִנְחוֹתֶיךָ","your oblations"],
    ["וְקָרְבְּנוֹתֶיךָ","and your sacraments"],
    ["לָעֶלְיוֹן","unto the Most High"],
...
var dc60_ch1Verses = [
  ...
  { num: "יג", words: [
    ...
    ["כֹּה","thus"],
    ["לֹא","not"],
    ["תַּשְׁחִית","shall you idle away"],
    ["עִתְּךָ","your time"],
    ["וְלֹא","and not"],
    ["תִטְמֹן","shall you bury"],
    ["אֶת־כִּשְׁרוֹנְךָ","your talent"],
    ["לְבַל","that not"],
