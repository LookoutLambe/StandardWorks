...
var dc51_ch1Verses = [
  ...
  { num: "יג", words: [["וְעוֹד","and again"], ["הַפָּקִיד","let the bishop"], ["יְמַנֶּה","appoint"], ["אוֹצָר","a storehouse"], ["לַכְּנֵסִיָּה","unto the church"], ["הַזֹּאת","this"], ["וְכׇל","and all"], ["דָּבָר","things"], ["גַּם","both"], ["בְּכֶסֶף","in money"], ["וְגַם","and"], ["בְּמָזוֹן","in meat"], ["הָעוֹדֵף","which is more"], ["עַל","above"], ["צָרְכֵי","the wants of"], ["הָעָם","the people"], ["הַזֶּה","this"], ["יִשָּׁמֵר","be kept"], ["בִּידֵי","in the hands of"], ["הַפָּקִיד׃","the bishop"]]},
...
var dc53_ch1Verses = [
  ...
  { num: "ז", words: [["וְעוֹד","and again"], ["אֲנִי","I"], ["חָפֵץ","would"], ["כִּי","that"], ["תִלְמַד","you should learn"], ["כִּי","that"], ["רַק","only"], ["הַמַּחֲזִיק","he that endures"], ["עַד־הַקֵּץ","unto the end"], ["הוּא","he"], ["נוֹשָׁע","is saved"], ["כֵּן","even so"], ["יְהִי","be it"], ["אָמֵן׃","Amen"]]}
];
...
var dc54_ch1Verses = [
  ...
  { num: "י", words: [["וְעוֹד","and again"], ["הוֹחִילוּ","be patient"], ["בַּצָּרָה","in tribulation"], ["עַד","until"], ["בוֹאִי","my coming"], ["וְהִנֵּה","and behold"], ["מְהֵרָה","quickly"], ["אָבוֹא","I come"], ["וּשְׂכָרִי","and my reward"], ["אִתִּי","with me"], ["וּמְשַׁחֲרַי","and they who seek me early"], ["יִמְצְאוּ","shall find"], ["מַרְגּוֹעַ","rest"], ["לְנַפְשָׁם","to their souls"], ["כֵּן","even so"], ["יְהִי","be it"], ["אָמֵן׃","Amen"]]}
];
...
var dc55_ch1Verses = [
  ...
  { num: "ו", words: [["וְעוֹד","and again"], ["עַבְדִּי","my servant"], ["יוֹסֵף","Joseph"], ["קוֹ","Coe"], ["גַּם","also"], ["יֵצֵא","let him take"], ["לְדַרְכּוֹ","his journey"], ["עִמָּהֶם","with them"], ["הַשְּׁאָר","the residue"], ["יוּדַע","shall be made known"], ["אַחֲרֵי־כֵן","hereafter"], ["כִּרְצוֹנִי","as I will"], ["אָמֵן׃","Amen"]]}
];
...
var dc56_ch1Verses = [
  ...
  { num: "יג", words: [["כִּי","for"], ["לְפִי","according to"], ["מַעֲשֵׂיהֶם","their works"], ["יְקַבֵּלוּ","they shall receive"], ["גַּם","even"], ["בַּאֲרָצוֹת","in lands"], ["לְנַחֲלָתָם׃","for their inheritance"]]},
  { num: "יד", words: [
    ["הִנֵּה","behold"],
    ["כֹּה","thus"],
    ["אָמַר","says"],
  ...
  { num: "יט", words: [["כִּי","for"], ["הִנֵּה","behold"], ["יָבוֹא","shall come"], ["יְהוָה","the Lord"], ["וּפְעֻלָּתוֹ","and his recompense"], ["אִתּוֹ","with him"], ["וִישַׁלֵּם","and he shall reward"], ["לְכׇל","to every"], ["אִישׁ","man"], ["וְהָעֲנִיִּים","and the poor"], ["יָגִילוּ׃","shall rejoice"]]},
  { num: "כ", words: [
...
var dc58_ch1Verses = [
  ...
  { num: "כו", words: [["כִּי","for"], ["הִנֵּה","behold"], ["לֹא","it is not"], ["נָכוֹן","meet"], ["כִּי","that"], ["אֲצַוֶּה","I should command"], ["בְּכׇל","in all"], ["דָּבָר","things"], ["כִּי","for"], ["הַנֶּאֱלָץ","he that is compelled"], ["בְּכׇל","in all"], ["דָּבָר","things"], ["עֶבֶד","is a servant"], ["עָצֵל","slothful"], ["הוּא","the same"], ["וְלֹא","and not"], ["חָכָם","wise"], ["לָכֵן","wherefore"], ["אֵינֶנּוּ","he does not"], ["מְקַבֵּל","receive"], ["שָׂכָר׃","reward"]]},
  { num: "כז", words: [
    ["אָמֵן","verily"],
    ["אֲנִי","I"],
    ["אֹמֵר","say"],
  ...
  { num: "ל", words: [["מִי","who"], ["אֲנִי","am I"], ["אֲשֶׁר","that"], ["יָצַרְתִּי","made"], ["אָדָם","man"], ["אָמַר","says"], ["יְהוָה","the Lord"], ["כִּי","that"], ["אֲנַקֶּה","I should hold guiltless"], ["אֶת־אֲשֶׁר","him who"], ["לֹא","not"], ["יִשְׁמַע","obeys"], ["מִצְוֹתָי׃","my commandments"]]},
  { num: "לא", words: [
    ["מִי","who"],
    ["אֲנִי","am I"],
    ["אָמַר","says"],
...
var dc59_ch1Verses = [
  ...
  { num: "ח", words: [["וְהִקְרַבְתָּ","and you shall offer"], ["קָרְבָּן","a sacrifice"], ["לַיהוָה","unto the Lord"], ["אֱלֹהֶיךָ","your God"], ["בְּצֶדֶק","in righteousness"], ["גַּם","even"], ["לֵב","a heart"], ["נִשְׁבָּר","broken"], ["וְרוּחַ","and a spirit"], ["נִדְכָּאָה׃","contrite"]]},
  ...
  { num: "טו", words: [["וּכְפִי","and inasmuch"], ["אֲשֶׁר","as"], ["תַּעֲשׂוּ","you do"], ["הַדְּבָרִים","the things"], ["הָאֵלֶּה","these"], ["בְּתוֹדָה","with thanksgiving"], ["בְּלֵב","with heart"], ["שָׂמֵחַ","cheerful"], ["וּבְפָנִים","and with countenances"], ["שְׂמֵחוֹת","cheerful"], ["לֹא","not"], ["בִּשְׂחוֹק","with laughter"], ["רַב","much"], ["כִּי","for"], ["זֶה","this is"], ["חֵטְא","sin"], ["כִּי־אִם","but"], ["בְּלֵב","with a heart"], ["טוֹב","glad"], ["וּבְפָנִים","and a countenance"], ["שְׂמֵחוֹת׃","cheerful"]]},
  { num: "טז", words: [
    ["אָמֵן","verily"],
    ["אֲנִי","I"],
    ["אֹמֵר","say"],
  ...
  { num: "יח", words: [["אָכֵן","yea"], ["כׇּל","all"], ["הַיֹּצֵא","things which come"], ["מִן","of"], ["הָאָרֶץ","the earth"], ["בְּעִתּוֹ","in its season"], ["נַעֲשָׂה","is made"], ["לְטוֹבַת","for the benefit"], ["הָאָדָם","of man"], ["וְלַעֲבֹדָתוֹ","and for his use"], ["גַּם","both"], ["לִרְצוֹת","to please"], ["הָעַיִן","the eye"], ["וְגַם","and"], ["לְשַׂמֵּחַ","to gladden"], ["הַלֵּב׃","the heart"]]},
  { num: "יט", words: [
    ["אָכֵן","yea"],
    ["לְאֹכֶל","for food"],
