...
var dc42_ch1Verses = [
  ...
  { num: "כג", words: [["וְהַמַּבִּיט","and he that looks"], ["אֶל","upon"], ["אִשָּׁה","a woman"], ["לְהִתְאַוּוֹת","to lust"], ["אֵלֶיהָ","after her"], ["יְכַחֵשׁ","shall deny"], ["בָּאֱמוּנָה","the faith"], ["וְלֹא","and not"], ["תִהְיֶה־לּוֹ","shall he have"], ["הָרוּחַ","the Spirit"], ["וְאִם","and if"], ["לֹא","not"], ["יָשׁוּב","he repents"], ["יְגֹרָשׁ׃","he shall be cast out"]]},
  { num: "כד", words: [
    ["לֹא","not"],
  ...
  { num: "כו", words: [["אַךְ","but"], ["אִם","if"], ["יַעֲשֶׂנּוּ","he does it"], ["שֵׁנִית","again"], ["לֹא","not"], ["יִסָּלַח","shall it be forgiven"], ["לוֹ","him"], ["כִּי־אִם","but"], ["יְגֹרָשׁ׃","shall be cast out"]]},
  { num: "כז", words: [
    ["לֹא","not"],
  ...
  { num: "סא", words: [["אִם","if"], ["תִּשְׁאַל","you shall ask"], ["תְּקַבֵּל","you shall receive"], ["חָזוֹן","revelation"], ["עַל","upon"], ["חָזוֹן","revelation"], ["דַּעַת","knowledge"], ["עַל","upon"], ["דַּעַת","knowledge"], ["לְמַעַן","that"], ["תֵּדַע","you may know"], ["סוֹדוֹת","the mysteries"], ["וְדִבְרֵי","and the things"], ["שָׁלוֹם","peaceable"], ["אֶת־הַמֵּבִיא","that which brings"], ["שִׂמְחָה","joy"], ["אֶת־הַמֵּבִיא","that which brings"], ["חַיֵּי","life"], ["עוֹלָם׃","eternal"]]},
  { num: "סב", words: [
    ["שְׁאַל","you shall ask"],
  ...
  { num: "סד", words: [["וְגַם","and even"], ["עַתָּה","now"], ["הַהֹלֵךְ","let him that goes"], ["לַמִּזְרָח","to the east"], ["יְלַמֵּד","teach"], ["אֶת־הַשָּׁבִים","them that shall be converted"], ["לָנוּס","to flee"], ["לַמַּעֲרָב","to the west"], ["וְזֹאת","and this"], ["בִּגְלַל","because of"], ["הַבָּא","that which is coming"], ["עַל","on"], ["הָאָרֶץ","the earth"], ["וּבִגְלַל","and because of"], ["קִשְׁרֵי","combinations"], ["סֵתֶר׃","secret"]]},
  { num: "סה", words: [
    ["הִנֵּה","behold"],
  ...
  { num: "פט", words: [["וְאִם","and if"], ["לֹא","not"], ["יוֹדֶה","he or she confess"], ["תִּמְסֹר","you shall deliver"], ["אֹתוֹ","him"], ["אוֹ","or"], ["אֹתָהּ","her"], ["לַכְּנֵסִיָּה","up unto the church"], ["לֹא","not"], ["לַחֲבֵרִים","to the members"], ["כִּי־אִם","but"], ["לַזְּקֵנִים","to the elders"], ["וְיֵעָשֶׂה","and it shall be done"], ["בַּאֲסֵפָה","in a meeting"], ["וְלֹא","and that not"], ["לִפְנֵי","before"], ["הָעוֹלָם׃","the world"]]},
  { num: "צ", words: [
    ["וְאִם","and if"],
    ["יֶחֱטָא","offend"],
    ["אָחִיךָ","your brother"],
...
var dc43_ch1Verses = [
  ...
  { num: "ד", words: [["אַךְ","but"], ["אָמֵן","verily"], ["אָמֵן","verily"], ["אֲנִי","I"], ["אֹמֵר","say"], ["לָכֶם","unto you"], ["לֹא","not"], ["יְמֻנֶּה","shall be appointed"], ["אַחֵר","none else"], ["לַמַּתָּנָה","unto the gift"], ["הַזֹּאת","this"], ["כִּי־אִם","except"], ["בְיָדוֹ","through him"], ["כִּי","for"], ["אִם","if"], ["תִּלָּקַח","it be taken"], ["מִמֶּנּוּ","from him"], ["לֹא","not"], ["יִהְיֶה־לּוֹ","shall be to him"], ["כֹּחַ","power"], ["כִּי־אִם","except"], ["לְמַנּוֹת","to appoint"], ["אַחֵר","another"], ["תַּחְתָּיו׃","in his stead"]]},
  { num: "ה", words: [
    ["וְזֶה","and this"],
    ["יִהְיֶה","shall be"],
    ["לָכֶם","unto you"],
...
var dc45_ch1Verses = [
  ...
  { num: "ג", words: [["הַקְשִׁיבוּ","listen"], ["לְמֵלִיץ","to him who is the advocate"], ["לִפְנֵי","with"], ["הָאָב","the Father"], ["הָרָב","who pleads"], ["רִיבְכֶם","your cause"], ["לְפָנָיו׃","before him"]]},
  { num: "ד", words: [
    ["לֵאמֹר","saying"],
    ["אָבִי","Father"],
    ["רְאֵה","behold"],
  ...
  { num: "סא", words: [["לָכֵן","wherefore"], ["אֲנִי","I"], ["נֹתֵן","give it"], ["לָכֶם","unto you"], ["עַתָּה","now"], ["לְתַרְגְּמוֹ","that you may translate it"], ["לְמַעַן","that"], ["תֻּכְנוּ","you may be prepared"], ["לַדְּבָרִים","for the things"], ["הַבָּאִים׃","to come"]]},
  { num: "סב", words: [
    ["כִּי","for"],
    ["אָמֵן","verily"],
    ["אֲנִי","I"],
...
var dc46_ch1Verses = [
  ...
  { num: "לג", words: [["וְתַעֲשׂוּ","and you must practice"], ["יֹשֶׁר","virtue"], ["וּקְדֻשָּׁה","and holiness"], ["לְפָנַי","before me"], ["תָּמִיד","continually"], ["כֵּן","even so"], ["יְהִי","be it"], ["אָמֵן׃","Amen"]]}
];
...
var dc49_ch1Verses = [
  ...
  { num: "כח", words: [["הִנֵּה","behold"], ["אֲנִי","I am"], ["יֵשׁוּעַ","Jesus"], ["הַמָּשִׁיחַ","Christ"], ["וּמְהֵרָה","and quickly"], ["אָבוֹא","I come"], ["כֵּן","even so"], ["יְהִי","be it"], ["אָמֵן׃","Amen"]]}
];
...
var dc50_ch1Verses = [
  ...
  { num: "יד", words: [["לִקְרֹא","to preach"], ["בְּשׂוֹרָתִי","my gospel"], ["בָּרוּחַ","by the Spirit"], ["גַּם","even"], ["הַמְּנַחֵם","the Comforter"], ["אֲשֶׁר","which"], ["נִשְׁלַח","was sent forth"], ["לְלַמֵּד","to teach"], ["הָאֱמֶת׃","the truth"]]},
  { num: "טו", words: [
    ["וְאָז","and then"],
  ...
  { num: "טז", words: [["הִנֵּה","behold"], ["אַתֶּם","you"], ["תַּעֲנוּ","shall answer"], ["הַשְּׁאֵלָה","the question"], ["הַזֹּאת","this"], ["בְּנַפְשְׁכֶם","yourselves"], ["אַךְ","nevertheless"], ["אֲרַחֵם","I will be merciful"], ["עֲלֵיכֶם","unto you"], ["הַחַלָּשׁ","he that is weak"], ["בָּכֶם","among you"], ["אַחֲרֵי־כֵן","hereafter"], ["יֶחֱזַק׃","shall be made strong"]]},
  { num: "יז", words: [
    ["אָמֵן","verily"],
    ["אֲנִי","I"],
    ["אֹמֵר","say"],
