...
var dc6_ch1Verses = [
  ...
  { num: "יא", words: [["וְאִם","and if"], ["תִּדְרֹשׁ","you inquire"], ["תֵּדַע","you shall know"], ["סוֹדוֹת","mysteries"], ["גְּדוֹלִים","great"], ["וְנִפְלָאִים","and marvelous"], ["עַל־כֵּן","wherefore"], ["הַפְעֵל","exercise"], ["מַתָּנָתְךָ","your gift"], ["לְמַעַן","that"], ["תִּמְצָא","you find"], ["סוֹדוֹת","mysteries"], ["וְתָבִיא","and bring"], ["רַבִּים","many"], ["לְדַעַת","to knowledge of"], ["הָאֱמֶת","the truth"], ["אָכֵן","yea"], ["לְהוֹכִיחָם","to reprove them"], ["עַל־תָּעוּת","of-the error of"], ["דַּרְכֵיהֶם׃","their ways"]]},
  { num: "יב", words: [
    ["אַל","do not"],
...
var dc10_ch1Verses = [
  ...
  { num: "יט", words: [["עַל־כֵּן","wherefore"], ["נַשְׁמִידֵהוּ","we will destroy him"], ["וְאֶת־הַמְּלָאכָה","and the work"], ["וְנַעֲשֶׂה","and we will do"], ["זֹאת","this"], ["לְמַעַן","that"], ["לֹא","not"], ["נֵבוֹשׁ","we be ashamed"], ["בָּאַחֲרוֹנָה","in the end"], ["וּלְמַעַן","and so that"], ["נִקַּח","we may receive"], ["כָּבוֹד","glory"], ["מִתֵּבֵל׃","from the world"]]},
  { num: "כ", words: [
    ["אָמֵן","verily"],
    ["אָמֵן","verily"],
    ["אֲנִי","I"],
  ...
  { num: "סד", words: [["עַל־כֵּן","therefore"], ["אֲגַלֶּה","I will reveal"], ["לָהֶם","to them"], ["אֶת־הַסּוֹד","the mystery"], ["הַגָּדוֹל","the great"], ["הַזֶּה׃","this"]]},
  { num: "סה", words: [
    ["כִּי","for"],
    ["הִנֵּה","behold"],
