...
var dc6_ch1Verses = [
  ...
  { num: "ל", words: [
    ...
    ["אַתָּה","are you"],
    ["כִּי","for"],
    ["תֵשֵׁב","you shall dwell"],
    ["עִמִּי","with me"],
    ["בְּכָבוֹד׃","in glory"]
  ]},
  { num: "לא", words: [["אַךְ","but"], ["אִם","if"], ["לֹא","not"], ["יִמְאֲסוּ","they reject"], ["בִדְבָרַי","my words"], ["אֲשֶׁר","which"], ["יוּקָמוּ","shall be established"], ["בְּעֵדוּת","by the testimony"], ["הַנִּתֶּנֶת","the one given"], ["בְּרוּכִים","blessed"], ["הֵם","they"], ["וְאָז","and then"], ["תִּשְׂמַח","you shall rejoice"], ["בִּפְרִי","in fruit"], ["עֲמָלְךָ׃","your labors"]]},
  { num: "לב", words: [
    ["אָמֵן","verily"],
    ["אָמֵן","verily"],
    ["אֲנִי","I"],
