...
var dc1_ch1Verses = [
  ...
  { num: "ז", words: [["עַל־כֵּן","therefore"], ["חִרְדוּ","fear"], ["וְרִגְזוּ","and tremble"], ["הָעָם","O people"], ["כִּי","for"], ["אֲשֶׁר","what"], ["גָּזַרְתִּי","I have decreed"], ["אֲנִי","I"], ["יְהוָה","the LORD"], ["בָּהֶם","in them"], ["יָקוּם׃","shall be fulfilled"]]},
  ...
  { num: "לט", words: [["כִּי","for"], ["הִנֵּה","behold"], ["יְהוָה","the LORD"], ["הוּא","he"], ["הָאֱלֹהִים","is God"], ["וְהָרוּחַ","and the Spirit"], ["מֵעִידָה","bears record"], ["וְהָעֵדוּת","and the record"], ["אֱמֶת","is truth"], ["וְהָאֱמֶת","and the truth"], ["עֹמֶדֶת","abides"], ["לְעוֹלָם","forever"], ["וָעֶד","and ever"], ["אָמֵן׃","amen"]]}
];
...
var dc3_ch1Verses = [
  ...
  { num: "ה", words: [["הִנֵּה","behold"], ["הָפְקְדוּ","were entrusted"], ["בְּיָדְךָ","into your hand"], ["הַדְּבָרִים","the things"], ["הָאֵלֶּה","these"], ["אַךְ","but"], ["מַה־קָשׁוֹת","how strict"], ["הָיוּ","were"], ["מִצְוֹתֶיךָ","your commandments"], ["וּזְכֹר","and remember"], ["גַּם","also"], ["אֶת־הַהַבְטָחוֹת","the promises"], ["אֲשֶׁר","which"], ["נִתְּנוּ","were made"], ["לְךָ","to you"], ["אִם","if"], ["לֹא","not"], ["תַעֲבֹר","you transgress"], ["עֲלֵיהֶן׃","against them"]]},
  { num: "ו", words: [
    ["וְהִנֵּה","and behold"],
    ["כַּמָּה","how many"],
    ["פְעָמִים","times"],
  ...
  { num: "יח", words: [["וְהָעֵדוּת","and the testimony"], ["הַזֹּאת","this"], ["תָּבֹא","shall come"], ["לְדַעַת","to knowledge of"], ["הַלָּמָנִים","the Lamanites"], ["וְהַלְּמוּאֵלִים","and the Lemuelites"], ["וְהַיִּשְׁמְעֵאלִים","and the Ishmaelites"], ["אֲשֶׁר","who"], ["דָּעֲכוּ","dwindled"], ["בְּאֵין","in un-"], ["אֱמוּנָה","belief"], ["בַּעֲוֹן","by iniquity of"], ["אֲבוֹתֵיהֶם","their fathers"], ["אֲשֶׁר","whom"], ["יְהוָה","the LORD"], ["הִנִּיחָם","suffered them"], ["לְהַשְׁמִיד","to destroy"], ["אֶת־אֲחֵיהֶם","their brethren"], ["הַנֶּפִיִּים","the Nephites"], ["בַּעֲוֹנֹתֵיהֶם","because of their iniquities"], ["וּבְתוֹעֲבוֹתֵיהֶם׃","and their abominations"]]},
...
var dc5_ch1Verses = [
  ...
  { num: "כב", words: [["וְלֶאֱחֹז","and to hold"], ["בְּחָזְקָה","firmly"], ["בַּמִּצְוֹת","to the commandments"], ["אֲשֶׁר","which"], ["צִוִּיתִיךָ","I commanded you"], ["וְאִם","and if"], ["תַּעֲשֶׂה","you do"], ["כֵן","so"], ["הִנֵּה","behold"], ["אֶתֵּן","I will give"], ["לְךָ","to you"], ["חַיֵּי","life"], ["עוֹלָם","eternal"], ["גַּם","even"], ["אִם","if"], ["תֵּהָרֵג׃","you should be slain"]]},
  { num: "כג", words: [
    ["וְעַתָּה","and now"],
    ["עוֹד","again"],
    ["אֲנִי","I"],
...
var dc8_ch1Verses = [
  ...
  { num: "ד", words: [["עַל־כֵּן","wherefore"], ["זֹאת","this is"], ["מַתָּנָתְךָ","your gift"], ["דְּבַק","apply yourself"], ["בָּהּ","unto it"], ["וּבָרוּךְ","and blessed"], ["אַתָּה","you"], ["כִּי","for"], ["תַצִּילְךָ","it shall deliver you"], ["מִידֵי","out of the hands of"], ["אֹיְבֶיךָ","your enemies"], ["אֲשֶׁר","which"], ["לוּלֵא","if not"], ["כֵן","so"], ["הֲרָגוּךָ","they would slay you"], ["וְהֵבִיאוּ","would bring"], ["נַפְשְׁךָ","your soul"], ["לְאָבְדָן׃","to destruction"]]},
  { num: "ה", words: [
    ["אָנָּא","oh"],
    ["זְכֹר","remember"],
...
var dc10_ch1Verses = [
  ...
  { num: "כא", words: [["וְלִבָּם","and their heart"], ["נִשְׁחָת","is corrupt"], ["וּמָלֵא","and full"], ["רֶשַׁע","wickedness"], ["וְתוֹעֵבוֹת","and abominations"], ["וְאֹהֲבִים","and loving"], ["הֵם","they are"], ["חֹשֶׁךְ","darkness"], ["מֵאוֹר","than light"], ["כִּי","for"], ["רָעִים","evil"], ["מַעֲשֵׂיהֶם","their deeds"], ["עַל־כֵּן","therefore"], ["לֹא","not"], ["יִשְׁאֲלוּ","they ask"], ["מִמֶּנִּי׃","of me"]]},
  { num: "כב", words: [
    ["הַשָּׂטָן","Satan"],
  ...
  { num: "מג", words: [["לֹא","not"], ["אַנִּיחַ","I will allow"], ["לָהֶם","to them"], ["לְהַשְׁמִיד","to destroy"], ["מְלַאכְתִּי","my work"], ["אָכֵן","yea"], ["אַרְאֵם","I will show them"], ["כִּי","that"], ["חׇכְמָתִי","my wisdom"], ["גְדוֹלָה","greater"], ["מֵעָרְמַת","than cunning of"], ["הַשָּׂטָן׃","the devil"]]},
  { num: "מד", words: [
    ["הִנֵּה","behold"],
  ...
  { num: "סד", words: [["עַל־כֵּן","therefore"], ["אֲגַלֶּה","I will unfold"], ["לָהֶם","to them"], ["אֶת־הַסּוֹד","the mystery"], ["הַגָּדוֹל","the great"], ["הַזֶּה׃","this"]]},
  { num: "סה", words: [
    ["כִּי","for"],
    ["הִנֵּה","behold"],
