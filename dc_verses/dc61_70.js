...
var dc61_ch1Verses = [
  ...
  { num: "יב", words: [["עַבְדִּי","let my servant"], ["סִידְנִי","Sidney"], ["גִילְבֶּרְט","Gilbert"], ["יִקַּח","take"], ["עִמּוֹ","with him"], ["אֶת־אֲשֶׁר","that which"], ["אֵינֶנּוּ","is not"], ["נָחוּץ","needful"], ["כַּאֲשֶׁר","as"], ["תִּוָּעֲדוּ׃","you shall agree"]]},
  { num: "יג", words: [
    ["וְעַתָּה","and now"],
    ["הִנֵּה","behold"],
...
var dc63_ch1Verses = [
  ...
  { num: "כו", words: [["אַךְ","nevertheless"], ["אֲנִי","I"], ["יְהוָה","the Lord"], ["נוֹתֵן","render"], ["לְקֵיסָר","unto Caesar"], ["אֲשֶׁר","things which"], ["לְקֵיסָר׃","are Caesar's"]]},
  { num: "כז", words: [
    ["לָכֵן","wherefore"],
    ["אֲנִי","I"],
    ["יְהוָה","the Lord"],
...
var dc64_ch1Verses = [
  ...
  { num: "לט", words: [["וּמְכַזְּבִים","and liars"], ["וַחֲנֵפִים","and hypocrites"], ["יִבָּחֲנוּ","shall be proved"], ["בָהֶם","by them"], ["וַאֲשֶׁר","and those who"], ["אֵינָם","are not"], ["שְׁלוּחִים","apostles"], ["וּנְבִיאִים","and prophets"], ["יִוָּדָעוּ׃","shall be known"]]},
  { num: "מ", words: [
    ["וְגַם","and even"],
...
var dc68_ch1Verses = [
  ...
  { num: "ח", words: [["לְכוּ","go"], ["לְכׇל־הָעוֹלָם","into all the world"], ["קִרְאוּ","preach"], ["הַבְּשׂוֹרָה","the gospel"], ["לְכׇל־בְּרִיָּה","to every creature"], ["בִּפְעָלְכֶם","acting"], ["בַּסַּמְכוּת","in the authority"], ["אֲשֶׁר","which"], ["נָתַתִּי","I have given"], ["לָכֶם","unto you"], ["מַטְבִּילִים","baptizing"], ["בְּשֵׁם","in the name of"], ["הָאָב","the Father"], ["וְהַבֵּן","and the Son"], ["וְרוּחַ","and the Spirit of"], ["הַקֹּדֶשׁ׃","the Holy"]]},
  { num: "ט", words: [
