...
//   window._attestedForms   pointed form → [Strong's, morph, segments, n, alts] (attested_forms.js, generated
//                           by tools/build_attested_forms.js from OSHB + STEPBible TAHOT, CC BY 4.0)
(function () {
  ...
  // THE POINTED KEY. The attested-forms table (attested_forms.js, generated by
  // tools/build_attested_forms.js from the OpenScriptures Hebrew Bible and
  // STEPBible's TAHOT) is keyed by the pointed surface with cantillation,
  // meteg, rafe, paseq and sof pasuq removed, qamats qatan folded to qamats,
  // and the marks after each letter in one fixed order -- the same word is
  // pointed in several mark orders across editions and this text. Vowels,
  // dagesh and the shin/sin dots stay: they are what tells homographs apart.
  // Both the generator and stageAttested key through THIS function.
  function pointedKey(s) {
    s = String(s || '').replace(/[\u0591-\u05AF\u05BD\u05BF\u05C0\u05C3-\u05C6]/g, '').replace(/\//g, '').replace(/\u05C7/g, '\u05B8');
    s = s.replace(/[^\u05B0-\u05BC\u05C1\u05C2\u05D0-\u05EA]/g, '');
    var out = '', i = 0;
    while (i < s.length) {
      var ch = s.charAt(i++), marks = [];
  ...
  // Particles whose maqqef compound resolves to the word they are attached to
  ...
  function stripLayers(w) {
    ...
    if (mi >= 0) {
      ...
      var allParticles = true;
      for (var hi = 0; hi < heads.length; hi++) if (!_isMaqqefParticle(heads[hi])) { allParticles = false; break; }
      if (allParticles) m = w.slice(mi + 1);
    }
    if (m && m !== w) out.push(m);
    var base = m || w;
    var d1 = _stripOneLayer(base);
    if (d1 !== base) {
      out.push(d1);
      var d2 = _stripOneLayer(d1);
  ...
  // 4) or bare family keys. Exported as RootEngine.rootMap.
    ...
    // pronouns into look-alike roots (H1992 lands in המה "tumult", H0859 in
    // אנת). 3fp gets only the demonstratives — bare הֵן/הֵנָּה stay put,
    ...
    'הִיא':'היא','הִוא':'היא','וְהִיא':'היא','וְהִוא':'היא','הַהִיא':'היא','שֶׁהִיא':'היא',
    'הֵם':'הם','הֵמָּה':'הם','וְהֵם':'הם','וְהֵמָּה':'הם','הָהֵם':'הם','הָהֵמָּה':'הם','שֶׁהֵם':'הם',
    'הָהֵן':'הן','הָהֵנָּה':'הן',
    // Ham the patriarch — standalone חָם is the name (the in-law only ever
    // appears suffixed: חָמִיךְ, חָמִיהָ), and קִיּוּם (existence/confirmation)
    // belongs to קום, not to the קיא/קיה vomit family it was falling into.
    'חָם':'חם','וְחָם':'חם',
    'קִיּוּם':'קום','בְּקִיּוּם':'קום','וּבְקִיּוּם':'קום','וְקִיּוּם':'קום','לְקִיּוּם':'קום','הַקִּיּוּם':'קום',
    // Nikkud-keyed split: בֵּין the preposition vs בִּין the verb — the
    // pointing is the ONLY difference, so the preposition's family key IS
    // pointed. Every Strong's H0996 surface form, generated from the lookup;
    // the verb keeps the bare בין family via Strong's→BDB.
    'בְּבֵין':'בֵּין','בֵּֽין':'בֵּין','בֵּֽינְךָ':'בֵּין','בֵּֽינֵיהֶם':'בֵּין',
    'בֵּֽינֵיכֶם':'בֵּין','בֵּֽינֹתֵינוּ':'בֵּין','בֵּֽינֹתָם':'בֵּין','בֵּֽינוֹתֵינוּ':'בֵּין',
    'בֵּין':'בֵּין','בֵּינְךָ':'בֵּין','בֵּינִי':'בֵּין','בֵּינֵיהֶֽם':'בֵּין',
    'בֵּינֵיהֶם':'בֵּין','בֵּינֵיכֶֽם':'בֵּין','בֵּינֵיכֶם':'בֵּין','בֵּינֵינוּ':'בֵּין',
    'בֵּינֵכֶם':'בֵּין','בֵּינֵנוּ':'בֵּין','בֵּינָיו':'בֵּין','בֵּינֹתֵינוּ':'בֵּין',
    'בֵּינֹתָֽם':'בֵּין','בֵּינֹתָם':'בֵּין','בֵּינוֹ':'בֵּין','בֵּינוֹת':'בֵּין',
    'בֵּינוֹתֵינוּ':'בֵּין','בֵֽין':'בֵּין','בֵֽינֵיהֶֽם':'בֵּין','בֵין':'בֵּין',
    'בֵינֵיהֶם':'בֵּין','בֵינֵינוּ':'בֵּין','וּבֵֽין':'בֵּין','וּבֵֽינְךָ':'בֵּין',
    'וּבֵֽינֵיהֶם':'בֵּין','וּבֵֽינֵיכֶם':'בֵּין','וּבֵין':'בֵּין','וּבֵינְךָ':'בֵּין',
    'וּבֵינֵֽךְ':'בֵּין','וּבֵינֵיהֶם':'בֵּין','וּבֵינֵיכֶֽם':'בֵּין','וּבֵינֵיכֶם':'בֵּין',
    'וּבֵינֵךְ':'בֵּין','וּבֵינֶֽיׄךָ':'בֵּין','וּבֵינֶֽךָ':'בֵּין','וּבֵינֶיׄךָ':'בֵּין',
    'וּבֵינֶיךָ':'בֵּין','וּבֵינֶךָ':'בֵּין','וּבֵינָיו':'בֵּין','וּמִבֵּין':'בֵּין',
    'לְבֵין':'בֵּין','מִבֵּין':'בֵּין','מִבֵּינוֹת':'בֵּין',
    // Elohim is defined as a NAME (the user's ruling) — its own family,
    // no longer sharing a bucket with אֵלֶּה "these" where BDB files both.
    // Every Strong's H0430/H0433 surface form, generated from the lookup:
    'אֱֽלֹֽהֵיהֶם':'אלהים','אֱֽלֹהִים':'אלהים','אֱֽלֹהֵיהֶם':'אלהים','אֱֽלֹהֵיכֶם':'אלהים','אֱֽלֹהַי':'אלהים',
    'אֱלֹֽהֵיהֶם':'אלהים','אֱלֹֽהֵיכֶֽם':'אלהים','אֱלֹֽהֵיכֶם':'אלהים','אֱלֹהִֽים':'אלהים','אֱלֹהִים':'אלהים',
    'אֱלֹהֵֽי':'אלהים','אֱלֹהֵֽינוּ':'אלהים','אֱלֹהֵי':'אלהים','אֱלֹהֵיהֶֽם':'אלהים','אֱלֹהֵיהֶֽן':'אלהים',
    'אֱלֹהֵיהֶם':'אלהים','אֱלֹהֵיהֶן':'אלהים','אֱלֹהֵיכֶֽם':'אלהים','אֱלֹהֵיכֶם':'אלהים','אֱלֹהֵימוֹ':'אלהים',
    'אֱלֹהֵינוּ':'אלהים','אֱלֹהֶֽיךָ':'אלהים','אֱלֹהֶיהָ':'אלהים','אֱלֹהֶיךָ':'אלהים','אֱלֹהַ':'אלהים',
    'אֱלֹהַּ':'אלהים','אֱלֹהַי':'אלהים','אֱלֹהַיִךְ':'אלהים','אֱלֹהָֽי':'אלהים','אֱלֹהָֽיִךְ':'אלהים',
    'אֱלֹהָֽיו':'אלהים','אֱלֹהָי':'אלהים','אֱלֹהָיִךְ':'אלהים','אֱלֹהָיו':'אלהים','אֱלֽוֹהַּ':'אלהים',
    'אֱלוֹהֵי':'אלהים','אֱלוֹהַ':'אלהים','אֱלוֹהַּ':'אלהים','אֱלוֹהַי':'אלהים','אֱלוֹהָי':'אלהים',
    'אלֹהִֽים':'אלהים','אלֹהִים':'אלהים','אלֹהֵי':'אלהים','בֵּֽאלֹהִֽים':'אלהים','בֵּֽאלֹהִים':'אלהים',
    'בֵּֽאלֹהֵינוּ':'אלהים','בֵּֽאלֹהֶיהָ':'אלהים','בֵּֽאלֹהַי':'אלהים','בֵּאלֹהִֽים':'אלהים','בֵּאלֹהִים':'אלהים',
    'בֵּאלֹהֵי':'אלהים','בֵּאלֹהֵיכֶֽם':'אלהים','בֵּאלֹהֵיכֶם':'אלהים','בֵּאלֹהֵינוּ':'אלהים','בֵּאלֹהֶיהָ':'אלהים',
    'בֵּאלֹהֶיךָ':'אלהים','בֵּאלֹהַי':'אלהים','בֵּאלֹהָֽיו':'אלהים','בֵּאלֹהָיו':'אלהים','בֵֽאלֹהִים':'אלהים',
    'בֵאלֹהִים':'אלהים','בֵאלֹהֵינוּ':'אלהים','בָאֱלֹהִים':'אלהים','הַאֱלֹהִים':'אלהים','הַאֱלֹהֵי':'אלהים',
    'הָֽאֱלֹהִֽים':'אלהים','הָֽאֱלֹהִים':'אלהים','הָאֱלֹהִֽים':'אלהים','הָאֱלֹהִים':'אלהים','וְהָאֱלֹהִים':'אלהים',
    'וְלֵאלֹֽהֵיהֶם':'אלהים','וְלֵאלֹהֵיהֶם':'אלהים','וְלֶאֱלֹהַּ':'אלהים','וְלֶאֱלוֹהַּ':'אלהים','וֵֽאלֹהִים':'אלהים',
    'וֵֽאלֹהֵי':'אלהים','וֵֽאלֹהֵינוּ':'אלהים','וֵֽאלֹהָֽי':'אלהים','וֵאלֹהִים':'אלהים','וֵאלֹהֵי':'אלהים',
    'וֵאלֹהֵיהֶם':'אלהים','וֵאלֹהֵינוּ':'אלהים','וֵאלֹהַי':'אלהים','וֵאלֹהַיִךְ':'אלהים','וֵאלֹהָֽי':'אלהים',
    'וֵאלֹהָֽיו':'אלהים','וֵאלֹהָי':'אלהים','וֵאלֹהָיו':'אלהים','וֶאֱלוֹהַּ':'אלהים','וּבֵֽאלֹהַי':'אלהים',
    'וּבֵאלֹהֵי':'אלהים','וּבֵאלֹהֵיהֶם':'אלהים','וּבֵאלֹהַי':'אלהים','וּבֵאלֹהָיו':'אלהים','וּמֵֽאֱלֹהִים':'אלהים',
    'וּמֵאֱלֹהִים':'אלהים','וּמֵאֱלֹהַי':'אלהים','כֵּֽאלֹהִֽים':'אלהים','כֵּֽאלֹהִים':'אלהים','כֵּֽאלֹהֵי':'אלהים',
    'כֵּאלֹהִים':'אלהים','כֵּאלֹהֵֽינוּ':'אלהים','כֵּאלֹהֵי':'אלהים','כֵּאלֹהֵינוּ':'אלהים','לֵֽאלֹהִֽים':'אלהים',
    'לֵֽאלֹהִים':'אלהים','לֵֽאלֹהֵי':'אלהים','לֵֽאלֹהֵיהֶֽם':'אלהים','לֵֽאלֹהֵיהֶֽן':'אלהים','לֵֽאלֹהֵיהֶם':'אלהים',
    'לֵֽאלֹהֵיכֶֽם':'אלהים','לֵֽאלֹהֵיכֶם':'אלהים','לֵֽאלֹהֵינוּ':'אלהים','לֵֽאלֹהַי':'אלהים','לֵֽאלֹהָיו':'אלהים',
    'לֵאלֹֽהֵיהֶם':'אלהים','לֵאלֹהִֽים':'אלהים','לֵאלֹהִים':'אלהים','לֵאלֹהֵֽינוּ':'אלהים','לֵאלֹהֵי':'אלהים',
    'לֵאלֹהֵיהֶֽן':'אלהים','לֵאלֹהֵיהֶם':'אלהים','לֵאלֹהֵיהֶן':'אלהים','לֵאלֹהֵיכֶם':'אלהים','לֵאלֹהֵינוּ':'אלהים',
    'לֵאלֹהַי':'אלהים','לֵאלֹהָֽי':'אלהים','לֵאלֹהָֽיו':'אלהים','לֵאלֹהָי':'אלהים','לֵאלֹהָיו':'אלהים',
    'לֵאלֹהֽוֹ':'אלהים','לֵאלֹהוֹ':'אלהים','לֶאֱלוֹהַּ':'אלהים','לָאֱלֹהִים':'אלהים','מֵּאֱלֹהֶיךָ':'אלהים',
    'מֵֽאֱלֹהֶיךָ':'אלהים','מֵֽאֱלֹהָיו':'אלהים','מֵאֱלֹהִֽים':'אלהים','מֵאֱלֹהִים':'אלהים','מֵאֱלֹהֵי':'אלהים',
    'מֵאֱלֹהֵינוּ':'אלהים','מֵאֱלֹהֶֽיךָ':'אלהים','מֵאֱלֹהֶיךָ':'אלהים','מֵאֱלֹהַי':'אלהים','מֵאֱלֹהָֽי':'אלהים',
    'מֵאֱלֹהָי':'אלהים','מֵאֱלֹהָיו':'אלהים','מֵאֱלוֹהַ':'אלהים','מֵהָֽאֱלֹהִים':'אלהים','מֵהָאֱלֹהִים':'אלהים',
    ...
    'אֲשֶּׁר': 'H0834', 'אֲשֶׁר־אָמְרוּ': 'H0559', 'אֲשֶׁר־אָמַר': 'H0559', 'אֲשֶׁר־בָּא': 'H0935', 'אֲשֶׁר־הֵבִיאוּ': 'H0935', 'אֲשֶׁר־יָדַע': 'H3045', 'אֲשֶׁר־מָלַךְ': 'H4427', 'אֲשֶׁר־נִבָּא': 'H5012', 'אֲשֶׁר־נָתַן': 'H5414', 'אֲשֶׁר־עַיִן': 'H5869', 'אֲשֶׁר־עַמִּי': 'עם', 'אֲשֶׁר־עָבַד': 'H5647',
    ...
    'אֶל־בְּנֵי־עַמְּךָ': 'עם', 'אֶל־דְּבַר': 'H1696', 'אֶל־הַכֹּהֵן': 'H3547', 'אֶל־הָאֱלֹהִים': 'H0430', 'אֶל־הָאֱמוּנָה': 'H0530', 'אֶל־הָאָדוֹן': 'H0113', 'אֶל־הָרֹאֶה': 'H7200', 'אֶל־זֶבַח': 'H2076', 'אֶל־חׇפְנֵי': 'H2651', 'אֶל־טְהוֹרֵי': 'H2891', 'אֶל־יְהוָֹה': 'H3068', 'אֶל־יְחִידִי': 'H3173',
    'אֶל־יָדִי': 'H3027', 'אֶל־יֹלְדֵיכֶם': 'H3205', 'אֶל־לֵב': 'H3820', 'אֶל־מֶלֶךְ': 'H4427', 'אֶל־נַחֲלוֹתֵיהֶם': 'H5157', 'אֶל־עִירֵנוּ': 'H5892', 'אֶל־עַמִּי': 'עם', 'אֶל־קִבְרוֹתֵינוּ': 'H6912', 'אֶל־קִבְרוֹתֶיךָ': 'H6912', 'אֶל־קׇדְשֵׁי': 'H6942', 'אֶל־רִשְׁעָתָם': 'H7561', 'אֶל־שׁוֹשַׁנֵּי': 'H7799',
    ...
    'אֶת־אַהֲבַתְכֶם': 'H0157', 'אֶת־אַהֲבָתוֹ': 'H0157', 'אֶת־אַחֻזָּתָם': 'H0270', 'אֶת־אָב': 'H0001', 'אֶת־אָבִיו': 'H0001', 'אֶת־אֹחֲזֵי': 'H0270', 'אֶת־אׇזְנֵי': 'H0238', 'אֶת־אוֹרָהּ': 'H0215', 'אֶת־בְּחוּרוֹתֶיךָ': 'H0977', 'אֶת־בְּכוֹרָהּ': 'H1069', 'אֶת־בְּנֵי־עַמִּי': 'עם', 'אֶת־בְּשָׂרָן': 'H1319',
    ...
    'אֶת־דִּמְעוֹתֶיךָ': 'H1830', 'אֶת־דַּעְתָּם': 'ידע', 'אֶת־דָּבָר': 'H1696', 'אֶת־דָּתֵנוּ': 'H1881', 'אֶת־דְּבָרָיו': 'H1696', 'אֶת־הַבָּא': 'H0935', 'אֶת־הַכֹּהֵן': 'H3547', 'אֶת־הַמִּצְוֺת': 'H6680', 'אֶת־הַפְּרִישׁוּת': 'H5921', 'אֶת־הַקְּדֹשִׂים': 'H6942', 'אֶת־הַתּוֹרָה': 'H8451', 'אֶת־הָאֱלֹהִים': 'H0430',
    ...
    'אֶת־כׇּל־מַשְׁקֵיהֶם': 'H8248', 'אֶת־כׇּל־עַמִּי': 'עם', 'אֶת־כׇּל־צְבָאוֹתָיו': 'H6633', 'אֶת־לֵב': 'H3820', 'אֶת־מֵתֵיהֶם': 'H4191', 'אֶת־מֶלֶךְ': 'H4427', 'אֶת־מַמְלְכוֹתֵיהֶם': 'H4427', 'אֶת־מַעֲמַדְכֶם': 'H5975', 'אֶת־מוֹעַד': 'H4150', 'אֶת־מוּסַדְכֶם': 'H4146', 'אֶת־נְבוּאוֹת': 'נבא', 'אֶת־נִשְׁקְכֶם': 'H5401',
    ...
    'אֶת־עֲוֺנָם': 'H5771', 'אֶת־עֲטָרָתוֹ': 'H5849', 'אֶת־עֲמָלְךָ': 'H5998', 'אֶת־עִירֵנוּ': 'H5892', 'אֶת־עֶבֶד': 'H5647', 'אֶת־עֶדְרֵיהֶם': 'H5737', 'אֶת־עֶדְרֵיכֶם': 'H5737', 'אֶת־עֶדְרָי': 'H5737', 'אֶת־עֶדְרָיו': 'H5737', 'אֶת־עַמְּךָ': 'עם', 'אֶת־עַמִּי': 'עם', 'אֶת־עָרֵינוּ': 'H5892',
    ...
    'אֶת־תְּפִלּוֹת': 'H8605', 'אֶת־תֻּמַּתְכֶם': 'H4191', 'אַבִּיעַ': 'H5042', 'אַהְמָן': 'H0119', 'אַהֲבַתְכֶם': 'H0157', 'אַהֲבָתוֹ': 'H0157', 'אַחָי': 'H0251', 'אַךְ־עַמִּי': 'עם', 'אַלְפַּי': 'H0505', 'אַל־יְעֻנֶּה': 'H6030', 'אַל־יֵדַע': 'H3045', 'אַל־יַשִּׂיא': 'H5377',
    ...
    'בְּחָזוֹן': 'H2377', 'בְּחׇכְמַת': 'H2449', 'בְּחׇכְמָתִי': 'H2449', 'בְּיַד־מֶלֶךְ': 'H4427', 'בְּכׇל־אֱלֹהֵי': 'H0430', 'בְּכׇל־דָּבָר': 'H1696', 'בְּכׇל־חֶלְקֵי': 'H2505', 'בְּכׇל־לֵב': 'H3820', 'בְּכׇל־לֵבָב': 'H3823', 'בְּכׇל־מְאֹדָם': 'H3966', 'בְּכׇל־עַמִּי': 'עם', 'בְּכׇל־קְדֻשָּׁה': 'H6942',
    ...
    'בְחׇכְמָתִי': 'H2449', 'בְחוּרוֹתֶיךָ': 'H0977', 'בְכׇל־דָּבָר': 'H1696', 'בְכׇל־לֵב': 'H3820', 'בְמַסָּה': 'H4531', 'בְמָקוֹם': 'H6965', 'בְנֵי־הָאֱלֹהִים': 'H0430', 'בְנֵי־עַמִּי': 'עם', 'בְרִיתֵנוּ': 'H1285', 'בְשֵׁלִים': 'H1310', 'בְשַׁעַר־עַמִּי': 'עם', 'בְשׂוֹרָתוֹ': 'H1319',
    ...
    'בַּמַּבּוּלִים': 'H3999', 'בַּעְלֵיהֶם': 'H1166', 'בַּעְלֵךְ': 'H1166', 'בַּעֲרָב': 'H6150', 'בַּקְּהִלָּה': 'H6950', 'בַּקְּרָב': 'H7126', 'בַּשׂוֹפָר': 'H8231', 'בַּת־אָבִיו': 'H0001', 'בַּת־עַמִּי': 'עם', 'בַגָּלִיל': 'H1551', 'בַחֲזוֹן': 'H2377', 'בַחֲמָתֵנוּ': 'H2534',
    'בַיִת־נֶאֱמָן': 'H0539', 'בַמַּרְאָה': 'H7200', 'בַעְלֵךְ': 'H1166', 'בַעְלָהּ': 'H1166', 'בַעֲבוּר': 'בעבור', 'בַצָּרָה': 'H6869', 'בַשׂוֹטִים': 'H7751', 'בַתּוֹרָה': 'H8451', 'בַת־אָבִיו': 'H0001', 'בַת־מֶלֶךְ': 'H4427', 'בַת־עַמִּי': 'עם', 'בָּאֵר': 'H0874',
    ...
    'דַּעְתָּם': 'ידע', 'דַבְּרָם': 'H1696', 'דַבְּרוֹ': 'H1696', 'דַעְתָּם': 'ידע', 'דַעְתּוֹ': 'ידע', 'דָּוִיד־אָבִיו': 'H0001', 'דָּנִיאֵל': 'H1841', 'דָּתֵנוּ': 'H1881', 'דָּתָם': 'H1881', 'דָרְכָה': 'H1869', 'דָתָם': 'H1881', 'דֻּבְּרוּ': 'H1696',
    ...
    'וְאֶל־לֵב': 'H3820', 'וְאֶל־מֶלֶךְ': 'H4427', 'וְאֶל־עֲוֺנָם': 'H5771', 'וְאֶל־עַמִּי': 'עם', 'וְאֶל־עַמִּים': 'עם', 'וְאֶל־תַּחַת': 'H8478', 'וְאֶת־אֱלֹהֵי': 'H0430', 'וְאֶת־גׇּדְלוֹ': 'H1431', 'וְאֶת־דְּבַר': 'H1696', 'וְאֶת־דְּרוֹרָם': 'H1865', 'וְאֶת־הַכֹּהֵן': 'H3547', 'וְאֶת־הַתּוֹרָה': 'H8451',
    'וְאֶת־הָאֱלֹהִים': 'H0430', 'וְאֶת־הָאֱמוּנָה': 'H0530', 'וְאֶת־יָדִי': 'H3027', 'וְאֶת־כׇּל־הֲמוֹנֹה': 'H1995', 'וְאֶת־לֵב': 'H3820', 'וְאֶת־מֶלֶךְ': 'H4427', 'וְאֶת־עֲוֺן': 'H5771', 'וְאֶת־עֲמָלְךָ': 'H5998', 'וְאֶת־עֶבֶד': 'H5647', 'וְאֶת־עַיִן': 'H5869', 'וְאֶת־עַמְּךָ': 'עם', 'וְאֶת־עַמִּי': 'עם',
    ...
    'וְכׇל־עֶבֶד': 'H5647', 'וְכׇל־עַמִּי': 'עם', 'וְלִמַּדְתָּם': 'H3925', 'וְלִשְׁכֵנוֹתֶיהָ': 'H7931', 'וְלָאָדָם': 'H0119', 'וְלָעֶבֶד': 'H5647', 'וְלֹא־אֱלֹהֵי': 'H0430', 'וְלֹא־אָמַר': 'H0559', 'וְלֹא־הֵבִיאוּ': 'H0935', 'וְלֹא־זָבַח': 'H2076', 'וְלֹא־יֵדַע': 'H3045', 'וְלֹא־יָדַע': 'H3045',
    ...
    'וְעַל־אֱלֹהֵי': 'H0430', 'וְעַל־בָּמוֹת': 'H4325', 'וְעַל־דְּבַר': 'H1696', 'וְעַל־דְּבָרִים': 'H1696', 'וְעַל־יְדֵי': 'H3027', 'וְעַל־יָדוֹ': 'H3027', 'וְעַל־עַמְּךָ': 'עם', 'וְעַל־עַמִּי': 'עם', 'וְעַל־עַמִּים': 'עם', 'וְעַנְוֵי־לֵב': 'H3820', 'וְעַנְוָתָם': 'H6031', 'וְעָדַרְתִּי': 'H5737',
    ...
    'וּבְאַהֲבָתוֹ': 'H0157', 'וּבְאָמְרוֹ': 'H0559', 'וּבְבַיִת': 'H1004', 'וּבְהִשָּׁעֲנִי': 'H8172', 'וּבְכֹחָם': 'H3581', 'וּבְכׇל־אֱלֹהֵי': 'H0430', 'וּבְכׇל־דָּבָר': 'H1696', 'וּבְכׇל־עַמִּי': 'עם', 'וּבְעַצְּבַת־לֵב': 'H3820', 'וּבְקַלָּעוֹת': 'H7049', 'וּבְקָרְאִי': 'H7121', 'וּבְרִיתוֹת': 'H1285',
    ...
    'זְרָעָם': 'H2232', 'זְרוֹעָם': 'H2232', 'זִמֵּר': 'H2167', 'זִקְנֵי־עַמִּי': 'עם', 'זָכְרִי': 'H2142', 'זָעַקְנוּ': 'H2199', 'זָעֹק': 'H2199', 'זֹכֵר': 'H2142', 'זֹעֲפֵי': 'H2196', 'זֹעֵק': 'H2199', 'חֲבֵרִי': 'H2266', 'חֲבֵרֵינוּ': 'H2266',
    ...
    'חֲסֵרֵי': 'H2637', 'חֲרִיצוּתְכֶם': 'חרץ', 'חֲרִיצוּתוֹ': 'חרץ', 'חֲשֹׁב': 'H2803', 'חֲשֹׂף': 'H2834', 'חִבֵּר': 'H2266', 'חִזְּקָה': 'H2388', 'חִזֵּק': 'H2388', 'חִלֵּק': 'H2505', 'חִלַּלְנוּ': 'H2490', 'חִקְקֵי־לֵב': 'H3820', 'חִקְרֵי־לֵב': 'H3820',
    ...
    'יָרַד־עַמִּי': 'עם', 'יָרֹא': 'H7200', 'יֻכְתַּר': 'H3803', 'יֻעַד': 'H3259', 'יׇשְׁרוֹ': 'H3474', 'יׇשְׁרוּ': 'H3474', 'יוֹם־בָּא': 'H0935', 'יוֹעַל': 'H3276', 'יוּכׇל': 'יכל', 'יוּנִי': 'H3196', 'ישֵּׁב': 'H3427', 'ישֵׁב': 'H3427',
    ...
    'כִּי־נָפְלוּ': 'H5307', 'כִּי־נָתַן': 'H5414', 'כִּי־עֶבֶד': 'H5647', 'כִּי־עַמְּךָ': 'עם', 'כִּי־תַחַת': 'H8478', 'כִּמְשַׁל': 'H4910', 'כִּפְּרָה': 'H3722', 'כִּתְבֵי': 'H3789', 'כִסֵּא־הָאֱלֹהִים': 'H0430', 'כֶלֶא': 'H3607', 'כַּאֲשֶׁר־בָּא': 'H0935', 'כַּדְבָרִים': 'H1696',
    ...
    'כׇּל־עֲבֹדָתְךָ': 'H5647', 'כׇּל־עֲמָלָם': 'H5998', 'כׇּל־עַיִן': 'H5869', 'כׇּל־עַמְּךָ': 'עם', 'כׇּל־עַמִּי': 'עם', 'כׇּל־צְבָאֵנוּ': 'H6633', 'כׇּל־צְבָאָו': 'H6633', 'כׇּל־קְהָלָם': 'H6950', 'כׇּל־קׇדְשֵׁי': 'H6942', 'כׇּתְבֵם': 'H3789', 'כׇל': 'H3605', 'כׇל־דְּבַר': 'H1696',
    ...
    'לְכׇל־הַתּוֹרָה': 'H8451', 'לְכׇל־עַמִּי': 'עם', 'לְלֹא־עַמִּי': 'עם', 'לְמַס־עֹבֵד': 'H5647', 'לְנִמְהֲרֵי־לֵב': 'H3820', 'לְנִשְׁבְּרֵי־לֵב': 'H3820', 'לְעֶבֶד־מֶלֶךְ': 'H4427', 'לְעָבֶד': 'H5647', 'לְעֹשֶׂר': 'H6238', 'לְעוֹלְמֵי־עַד': 'H5703', 'לְפָנֵי': 'H6440', 'לְפשֵׁעַ': 'H6586',
    ...
    'לַכְּהֻנָּה': 'H3547', 'לַעֲבֵרָה': 'H5674', 'לַעֲזֹר': 'H5826', 'לַשֶׁבֶת': 'H3427', 'לָאֹמֵר': 'H0559', 'לָבַשְׁתָּ': 'H3847', 'לָבָיִת': 'H1008', 'לָגֶשֶׂת': 'H5066', 'לָהָר': 'H2022', 'לָילָה': 'H3915', 'לָמָד': 'H3925', 'לָנֶצָח': 'H5329',
    ...
    'לֹא־יָצְרוּ': 'H3334', 'לֹא־יָשַּׁב': 'H3427', 'לֹא־יׇשְׁרָה': 'H3474', 'לֹא־נָפְלוּ': 'H5307', 'לֹא־נָתַן': 'H5414', 'לֹא־עַמִּי': 'עם', 'לֹא־תִשֹּׁב': 'H3427', 'לֹאמַר': 'H0559', 'לֻמַּד': 'H3925', 'לוּ־יָדַע': 'H3045', 'מְגִנַּת־לֵב': 'H3820', 'מְהֵר': 'H4116',
    ...
    'נְגִיד־עַמִּי': 'עם', 'נְחַכֶּה': 'H0518', 'נְכֵי': 'H5223', 'נְקַבְּצֵם': 'H6908', 'נְקַבְּצָה': 'H6908', 'נְשׁוֹתֵיהֶם': 'H0802', 'נְתָנָן': 'H5414', 'נִאֵף': 'H5003', 'נִאֻפִים': 'H5003', 'נִבְזָה': 'H0959', 'נִבְחַרְתֶּם': 'H0977', 'נִבֵּאנוּ': 'H5012',
    ...
    'עֲמׇדְךָ': 'H5975', 'עֲצֵלִים': 'H6101', 'עֲצַמְתֶּם': 'H6105', 'עִוְרֵיהֶם': 'H5786', 'עִם־הָאֱלֹהִים': 'H0430', 'עִם־הָאֱמוּנָה': 'H0530', 'עִם־הָאָדוֹן': 'H0113', 'עִם־לֵב': 'H3820', 'עִם־מֶלֶךְ': 'H4427', 'עִם־עַמִּי': 'עם', 'עִם־עֹבֵד': 'H5647', 'עִם־תְּפִלּוֹת': 'H8605',
    ...
    'עַל־כׇּל־שְׁכֵנֵיהֶם': 'H7931', 'עַל־לֵב': 'H3820', 'עַל־מֵתֵיכֶם': 'H4191', 'עַל־מֶלֶךְ': 'H4427', 'עַל־מַתִּיָּה': 'H4191', 'עַל־מָרִאי': 'H7200', 'עַל־מׇתְנָי': 'H4976', 'עַל־נְבוּאוֹת': 'נבא', 'עַל־עֲוֹנוֹתֵינוּ': 'H5771', 'עַל־עֲוֺנִי': 'H5771', 'עַל־עֲוֺנֵךְ': 'H5771', 'עַל־עֲוֺנָם': 'H5771',
    'עַל־עֵדַת': 'H5712', 'עַל־עֶדְרָם': 'H5737', 'עַל־עַמְּךָ': 'עם', 'עַל־עַמִּי': 'עם', 'עַל־עַמִּים': 'עם', 'עַל־עַצְמָהּ': 'H6105', 'עַל־עׇמְדִי': 'H5975', 'עַל־עׇשְׁרְכֶם': 'H6237', 'עַל־עׇשְׁרֵי': 'H6237', 'עַל־פִּתְחֵיכֶם': 'H6605', 'עַל־צִבְאוֹתֵיהֶם': 'H6633', 'עַל־קְדֻשָּׁה': 'H6942',
    ...
    'תְּצַוּוּ': 'H6680', 'תְּקַוּוּ': 'H6960', 'תְדַבֵּרוּ': 'H1696', 'תְחִיָּתוֹ': 'H2421', 'תְעַנֵּנִי': 'H6030', 'תְפִלּוֹתֶיךָ': 'H8605', 'תִּגָּלוּ': 'H1540', 'תִּהְיֶה־עֶבֶד': 'H5647', 'תִּירַשׁ': 'H3423', 'תִּכָּתֵב': 'H3789', 'תִּמְכֹּר־עַמְּךָ': 'עם', 'תִּקָּרֵא': 'H7121',
    ...
    // The gospel: the ב of בְּשׂוֹרָה is a root letter, not a prefix — peeled,
    // the remainder hit שׁוֹר "ox". Same guard as the מנחה/קרבן block.
    'הַבְּשׂוֹר': 'H1309', 'אֵין־בְּשׂוֹרָה': 'H1309', 'בְּשׂוֹרָה': 'H1309', 'וְאֶל־בְּשׂוֹרָה': 'H1309', 'הַבְּשׂוֹרָה': 'H1309', 'אֶת־בְּשׂוֹרַת': 'H1309', 'אֶת־הַבְּשׂוֹרָה': 'H1309', 'עַל־בְּשׂוֹרַת': 'H1309', 'מִן־הַבְּשׂוֹרָה': 'H1309', 'בְּשׂוֹרַת': 'H1309', 'בַּבְּשׂוֹרָה': 'H1309', 'מִבְּשׂוֹרַת': 'H1309', 'שֶׁל־בְּשׂוֹרַת': 'H1309', 'בַבְּשׂוֹרָה': 'H1309', 'וְהַבְּשׂוֹרָה': 'H1309', 'עַל־הַבְּשׂוֹרָה': 'H1309', 'אֶל־בְּשׂוֹרָה': 'H1309', 'וְאֶת־הַבְּשׂוֹרָה': 'H1309', 'אֶל־הַבְּשׂוֹרָה': 'H1309', 'בְּשׂוֹרָתֵנוּ': 'H1309', 'שֶׁל־הַבְּשׂוֹרָה': 'H1309', 'בְּשׂוֹרוֹת': 'H1309', 'אֶת־הַבְּשׂוֹרוֹת': 'H1309', 'בְּשׂוֹרָתוֹ': 'H1309', 'אֶת־כׇּל־הַבְּשׂוֹרָה': 'H1309', 'בְּשׂוֹרָתִי': 'H1309', 'אֶת־בְּשׂוֹרָתִי': 'H1309', 'עַל־בְּשׂוֹרָתִי': 'H1309', 'לַבְּשׂוֹרָה': 'H1309', 'בְּשׂוֹרַת־עוֹלָם': 'H1309', 'מִבְּשׂוֹרָתִי': 'H1309', 'אֶת־בְּשׂוֹרָתוֹ': 'H1309',
    // Modern lexemes the cascade mangles: רְשׁוּת "authority" fell into
    // רֶשֶׁת "net" via a mater collapse, תרגם "translate" (the ת is a ROOT
    // letter, quadriliteral) fell into רגם "stone", and the Pharisees were
    // filed under פרש "horseman". Each is its own family.
    'רְשׁוּת': 'רשות',    'רָשׁוּת': 'רשות',    'בִּרְשׁוּת': 'רשות',    'בָּרְשׁוּת': 'רשות',    'כָּרְשׁוּת': 'רשות',    'הָרְשׁוּת': 'רשות',    'לָרָשׁוּת': 'רשות',    'הָרָשׁוּת': 'רשות',    'וּרְשׁוּת': 'רשות',    'וּבִרְשׁוּת': 'רשות',    'רְשׁוּתִי': 'רשות',    'רְשׁוּתָהּ': 'רשות',    'בִּרְשׁוּתָהּ': 'רשות',    'בִּרְשׁוּתוֹ': 'רשות',    'וּרְשׁוּתוֹ': 'רשות',    'לִרְשׁוּתוֹ': 'רשות',    'לְהַרְשׁוֹת': 'רשות',
    'תִּרְגֵּם': 'תרגם',    'תִרְגֵּם': 'תרגם',    'תֻּרְגַּם': 'תרגם',    'תַּרְגּוּם': 'תרגם',    'תִּרְגּוּם': 'תרגם',    'הַתִּרְגּוּם': 'תרגם',    'הַתַּרְגּוּם': 'תרגם',    'בְּתִרְגּוּם': 'תרגם',    'בְּתַרְגּוּם': 'תרגם',    'בַּתַּרְגּוּם': 'תרגם',    'לְתִרְגּוּם': 'תרגם',    'לְתַרְגֵּם': 'תרגם',    'וּלְתַרְגֵּם': 'תרגם',    'וְתֻרְגַּם': 'תרגם',    'וַיְתַרְגֵּם': 'תרגם',    'וּמְתַרְגֵּם': 'תרגם',    'וּמְתֻרְגָּם': 'תרגם',    'יְתַרְגֵּם': 'תרגם',    'יְתֻרְגַּם': 'תרגם',    'מְתַרְגֵּם': 'תרגם',    'מְתֻרְגָּם': 'תרגם',    'הַמְתַרְגֵּם': 'תרגם',    'תְּתַרְגֵּם': 'תרגם',    'תְתַרְגֵּם': 'תרגם',    'שֶׁהַתִּרְגּוּם': 'תרגם',    'מִתַּרְגּוּם': 'תרגם',
    // the Pharisees keep פרוש; פֵּרוּשׁ "interpretation" belongs to פֵּרֵשׁ (1 Nephi 17 audit)
    'הַפְּרוּשִׁים': 'פרוש',    'וְהַפְּרוּשִׁים': 'פרוש',    'פְּרוּשִׁים': 'פרוש',    'וּפְרוּשִׁים': 'פרוש',    'וּבַפְּרוּשִׁים': 'פרוש',    'הַפָּרוּשׁ': 'פרוש',    'פָּרוּשׁ': 'פרוש',    'כְּפָרוּשׁ': 'פרוש',    'פֵּרוּשׁ': 'פרשׁ',    'הֲפֵרוּשׁ': 'פרשׁ',    'בְּפֵרוּשׁ': 'פרשׁ',    'פֵּרוּשׁוֹ': 'פרשׁ',    'וּפֵרוּשׁוֹ': 'פרשׁ',    'פֵּרוּשָׁהּ': 'פרשׁ',    'וּפֵרוּשָׁן': 'פרשׁ',
    'כְּנִסְתָּם': 'כנס', 'כְּנֵסֶת': 'כנס', 'כְנִסְתְּכֶם': 'כנס', 'כְנִסְתֵּנוּ': 'כנס', 'כְנִסְתָּם': 'כנס', 'כְנֵסֶת': 'כנס',  // כְּנֶסֶת + suffixes (user ruling 2026-09-01:
    // "synagogue" is כְּנֶסֶת, "church" is עֵדָה/קְהִלָּה). These MUST be pinned:
    // without it כְנִסְתְּכֶם peels its kaf as a prefix and lands on נסה, "to tempt".
    ...
    // Forms the MT never happens to inflect, but whose ROOT is biblical and
    // whose paradigm the corpus already demonstrates. The MT is a 300k-word
    // corpus, not the boundary of Hebrew; without these the peeler files a
    // perfectly regular form under a junk root. (User ruling 2026-09-01.)
    'יִגְאָלֵם': 'גאל', 'פְּרָקִים': 'פרק', 'וְהַשְּׁקִידָה': 'שקד', 'הַשְּׁקִידָה': 'שקד',
    'יְשׁוּעָה': 'ישע', 'יְשׁוּעַת': 'ישע', 'יוֹשִׁיעַ': 'ישע', 'הוֹשִׁיעַ': 'ישע', 'מוֹשִׁיעַ': 'ישע', 'תְּשׁוּעָה': 'ישע', 'הַיְשׁוּעָה': 'ישע', 'נוֹשַׁע': 'ישע', 'יִוָּשַׁע': 'ישע', 'יִוָּשֵׁעוּ': 'ישע', 'הוֹשַׁעְנָא': 'ישע', 'הוֹשִׁיעֵנוּ': 'ישע', 'תֵּשַׁע': 'H8672', 'תֵּשָׁעוּ': 'H8672',
    ...
    'תֻּמִּים': 'H8550', 'הַתֻּמִּים': 'H8550', 'וְהַתֻּמִּים': 'H8550',
    ...
    // the covenant family keys by its Strong's number — the unbound surfaces
    // resolve H1285 through the lookup, and a string key here split the card
    // in two (71 unbound vs 17 bound). כָּרַת is the VERB cut, its own family.
    'בְּרִית': 'H1285', 'בְּרִיתוֹ': 'H1285', 'בְּרִיתִי': 'H1285', 'בְּרִיתְךָ': 'H1285', 'הַבְּרִית': 'H1285', 'בִּרְיתוֹת': 'H1285', 'בְּרִיתוֹת': 'H1285', 'כָּרַת': 'כרת',
    ...
    'עָוֹן': 'H5771', 'עֲוֹנוֹת': 'H5771', 'עֲוֹנָם': 'H5771', 'עֲוֹנוֹתֵיהֶם': 'H5771', 'עֲוֹנוֹתֵינוּ': 'H5771', 'עֲוֹנוֹתַי': 'H5771', 'עֲוֺנָם': 'H5771',
    ...
    'יָשַׁב': 'ישב', 'יוֹשֵׁב': 'ישב', 'יוֹשְׁבִים': 'ישב', 'יוֹשְׁבֵי': 'ישב', 'יָשְׁבוּ': 'ישב', 'יֵשֵׁב': 'ישב', 'יֵשְׁבוּ': 'ישב', 'לָשֶׁבֶת': 'ישב', 'מוֹשָׁב': 'H4186', 'תֵּשֵׁב': 'ישב',
    'שָׁפַט': 'שפט', 'שֹׁפֵט': 'שפט', 'שֹׁפְטִים': 'שפט', 'מִשְׁפָּט': 'שפט', 'מִשְׁפָּטִים': 'שפט', 'יִשְׁפֹּט': 'שפט', 'הַשֹּׁפְטִים': 'שפט', 'הַמִּשְׁפָּט': 'שפט',
    'לָחַם': 'לחם', 'לֹחֵם': 'לחם', 'לֹחֲמִים': 'לחם', 'נִלְחַם': 'לחם', 'נִלְחֲמוּ': 'לחם', 'מִלְחָמָה': 'מלחמה', 'מִלְחֲמוֹת': 'מלחמה', 'הִלָּחֲמוֹ': 'לחם', 'לְהִלָּחֵם': 'לחם',
    ...
    'נָפַל': 'נפל', 'נֹפֵל': 'נפל', 'נָפְלוּ': 'נפל', 'יִפֹּל': 'נפל', 'יִפְּלוּ': 'נפל', 'נְפִילָה': 'נפל', 'נְפִילָתָם': 'נפל', 'מַפָּלָה': 'H4654',
    ...
    // לֵב is the geminate of לבב (the user's ruling) — one heart family,
    // keyed the way the unbound surfaces already resolve through BDB
    'לֵב': 'לבב', 'לֵבָב': 'לבב', 'לִבִּי': 'לבב', 'לִבּוֹ': 'לבב', 'לִבָּם': 'לבב', 'לְבַבְכֶם': 'לבב', 'לִבֵּנוּ': 'לבב', 'הַלֵּב': 'לבב', 'לְבָבוֹ': 'לבב', 'לִבְּכֶם': 'לבב',
    ...
    'פָּנִים': 'H6440', 'פְּנֵי': 'H6440', 'פָּנָיו': 'H6440', 'פָּנַי': 'H6440', 'לִפְנֵי': 'H6440', 'מִפְּנֵי': 'H6440',
    ...
    'שַׂר': 'שרר', 'שָׂרִים': 'שרר', 'שָׂרֵי': 'שרר', 'שַׂר־שָׁלוֹם': 'שרר', 'הַשַּׂר': 'שרר', 'מֹשֵׁל': 'משל', 'מוֹשֵׁל': 'משל',
    'כֹּהֵן': 'כהן', 'כֹּהֲנִים': 'כהן', 'כְּהֻנָּה': 'כהן', 'הַכֹּהֵן': 'כהן', 'כֹּהֲנֵי': 'כהן', 'הַכְּהֻנָּה': 'כהן',
    'נָבִיא': 'נבא', 'נְבִיאִים': 'נבא', 'נְבִיאֵי': 'נבא', 'הַנָּבִיא': 'נבא', 'נִבָּא': 'נבא', 'נְבוּאָה': 'נבא', 'הִתְנַבְּאוּ': 'נבא', 'נְבוּאוֹת': 'נבא',
    ...
    'אָב': 'H0001', 'אָבִי': 'H0001', 'אָבִיו': 'H0001', 'אֲבוֹתָם': 'H0001', 'אֲבוֹתֵיהֶם': 'H0001', 'אֲבוֹתֵינוּ': 'H0001', 'אֲבוֹתַי': 'H0001', 'הָאָב': 'H0001',
    // prayer belongs to פלל (the geminate the ת-form hides) — 'תפל' is the
    // UNTEMPERED family and grouping prayer there was a consonant accident
    'תְּפִלָּה': 'פלל', 'תְּפִלּוֹת': 'פלל', 'הִתְפַּלֵּל': 'פלל', 'יִתְפַּלֵּל': 'פלל', 'מִתְפַּלֵּל': 'פלל', 'לְהִתְפַּלֵּל': 'פלל',
    'זֶבַח': 'זבח', 'זְבָחִים': 'זבח', 'זָבַח': 'זבח', 'זִבְחוּ': 'זבח', 'לִזְבֹּחַ': 'זבח', 'מִזְבֵּחַ': 'מזבח',
    'שֶׁבַח': 'שבח', 'תְּהִלָּה': 'הלל', 'הַלֵּל': 'הלל', 'הַלְלוּ': 'הלל', 'הִלְלוּ': 'הלל',
    'צִוָּה': 'צוה', 'צִוָּהוּ': 'צוה', 'מִצְוָה': 'צוה', 'מִצְוֹת': 'צוה', 'מִצְוֹתָיו': 'צוה', 'הַמִּצְוֹת': 'צוה', 'צַו': 'H6673', 'צִוָּנוּ': 'צוה', 'צִוִּיתִי': 'צוה', 'צִוִּיתִיךָ': 'צוה', 'וַיְצַוֵּהוּ': 'צוה', 'יְצַוֵּהוּ': 'צוה', 'יְצַוֶּה': 'צוה',
    ...
    'תּוֹרָה': 'H8451', 'תּוֹרַת': 'H8451', 'תּוֹרָתוֹ': 'H8451', 'תּוֹרוֹת': 'H8451',
    // אשה family (woman/wife) — feminine construct ה→ת
    'אִשָּׁה': 'H0802', 'אִשְׁתּוֹ': 'H0802', 'אִשְׁתִּי': 'H0802', 'אִשְׁתְּךָ': 'H0802', 'אֵשֶׁת': 'H0802', 'נָשִׁים': 'H0802', 'נְשֵׁי': 'H0802', 'נְשׁוֹת': 'H0802', 'הָאִשָּׁה': 'H0802', 'נְשֵׁיהֶם': 'H0802', 'נְשׁוֹתֵיהֶם': 'H0802', 'לְאִשָּׁה': 'H0802',
  ...
  // which is the point for a name (Lehi must not become "jaw").
    ...
    'בְּהָם': 'בם', 'בָּם': 'בם', 'בָּם': 'בם', 'בָֿם': 'בם', 'בָם': 'בם', 'וּבָהֶם': 'בם', 'וּבָם': 'בם',
    ...
    'רוֹשׁ': 'רוש',
    'אֵת־עִנּוּיֵי': 'ענה', 'בְּעִנּוּיִם': 'ענה', 'בְּעִנּוּיַי': 'ענה', 'בְעִנּוּיִם': 'ענה', 'הָעִנּוּיִים': 'ענה', 'וּבְעִנּוּי': 'ענה', 'וּבָעִנּוּיִם': 'ענה', 'כִּי־עִנּוּיִם': 'ענה', 'לָעִנּוּי': 'ענה', 'עִנּוּיִם': 'ענה', 'עִנּוּיֵיכֶם': 'ענה', 'עִנּוּיֵינוּ': 'ענה', 'עִנּוּיָהּ': 'ענה', 'עִנּוּיָם': 'ענה', 'עַל־עִנּוּיֵי': 'ענה', 'שֶׁעִנּוּיֵי': 'ענה',
    ...
    'הֲכָנוֹת': 'H3559',                                  // "preparations" — same נוה trap
    'לִלְמֹד': 'H3925',                                   // "to learn" peeled to מָדַד "measure"
    'מְעֻנִּים': 'H6031', 'מְעֻנֶּה': 'H6031', 'מְעֻנֵּיהֶם': 'H6031', 'וּמְעֻנִּים': 'H6031', 'וּמְעֻנֶּה': 'H6031',
    'וּמְעֻנֵּיהֶם': 'H6031', 'וְלַמְעֻנִּים': 'H6031', 'וְהַמְעֻנֶּה': 'H6031',   // "afflicted" (pual of ענה) read as לְמַעַן
    'וְנַסּוּ': 'H5254', 'תְּנַסּוּ': 'H5254', 'תְנַסּוּ': 'H5254', 'וַיְנַסּוּ': 'H5254', 'תְּנַסּוּן': 'H5254',   // "try" (piel of נסה), not נוּס "flee"
    'נְדַמֶּה': 'H1819',                                  // "we will compare" — a one-word family with no card
    'חֲזֵכֶם': 'H2373',                                   // "your breasts"
    'לִתְפֹּחַ': 'תפח', 'תּוֹפֵחַ': 'תפח', 'תָפַח': 'תפח', 'יִתְפַּח': 'תפח', 'הַתְּפִיחוֹת': 'תפח',   // "swell" — the lexicon hands תָפַח to תַּפּוּחַ "apple"; the plural sat in פִּיחַ "ashes"
    'תְּטַפְּחוּהוּ': 'טפח', 'לְטִפּוּחוֹ': 'טפח',            // "nourish it" — orphaned suffix forms
    'הֲבְטוּחִים': 'H0982',                               // "are sure" — בָּטוּחַ, not טוּחַ "plaster"
    'בְּקַוּוֹתְכֶם': 'H6960',                             // "looking forward" (קָוָה)
    'בְּחַכּוֹתְכֶם': 'H2442',                             // "waiting" (חָכָה)
    'וּתְעַקְּרוּהוּ': 'H6131',                            // "pluck it up" (עָקַר)
    // strays the concordance showed after the splits above:
    'הַמְעֻנִּים': 'H6031', 'מְעֻנָּה': 'H6031',
    'וּבָטוּחַ': 'H0982', 'וּבְטוּחִים': 'H0982', 'בּוֹטְחִים': 'H0982', 'הַבּוֹטְחִים': 'H0982',   // בטח forms peeled to טוּחַ "plaster"
    'הַבְטָחוֹתָיו': 'H0982', 'הַבְטָחָתָם': 'H0982', 'הַבְטָחוֹתַי': 'H0982', 'וּבְהַבְטָחוֹתָיו': 'H0982',
    ...
    // THE 1 NEPHI 1 CARD AUDIT (2026-09-12):
    'עִנּוּיֵיהֶם': 'H6031', 'עִנּוּיִים': 'H6031', 'עִנּוּיֵי': 'H6031', 'עִנּוּיָיו': 'H6031', 'וְעִנּוּיָיו': 'H6031', 'עִנּוּי': 'H6031',
    'לְעִנּוּי': 'H6031', 'בְּעִנּוּיִים': 'H6031', 'וְעִנּוּי': 'H6031', 'וְעִנּוּיָם': 'H6031', 'בְּעִנּוּיֵי': 'H6031',   // עִנּוּי "affliction" is עָנָה II, not "answer"
    'וְצָרוֹתֵיהֶם': 'צרה', 'צָרוֹתֵיהֶם': 'צרה', 'בְּצָרוֹתֵיהֶם': 'צרה', 'צָרוֹתֵיכֶם': 'צרה', 'צָרוֹתֵינוּ': 'צרה', 'צָרוֹתָם': 'צרה',   // "their troubles" landed on Tyre
    'וַיְבַלְבְּלֵם': 'בלל',                                // "he confounded them" (בִּלְבֵּל, from בָּלַל)
    ...
    // THE 1 NEPHI 10 CARD AUDIT (2026-09-12):
    'הַבַּבְלִים': 'H0894',                                 // the Babylonians, not בָּלָה "wear out"
    'הַמַּטְבִּיל': 'טבל',                                   // the Baptist — a one-word family
    'בְּצִדְקָה': 'צדק',                                    // Hebrew righteousness, not the Aramaic H6665
    'בְּהָחֵלִי': 'חלל',                                    // "in proceeding" (begin), not חָלָה "be sick"
    'יוּשְׁבוּ': 'שוב', 'וְיוּשְׁבוּ': 'שוב',                  // hophal "be restored" — a one-word family under יָשַׁב
    'עֲנָפָיו': 'ענף',                                     // "its branches"
    ...
    'בְּסִפּוּר': 'ספר',                                   // heading "in the account"
    'וַתָּחֵלְנָה': 'חלל',                                  // "they began", not the name Helon
    'תְלוּנוֹת': 'לון', 'תְּלֻנּוֹת': 'לון', 'בִּתְלֻנּוֹתֵיהֶם': 'לון',   // "murmurings" (תְּלֻנָּה), not לָוָה "lend"
    'לְהַבְעִיר': 'בער',                                   // "to blow" (kindle), not עִיר "city"
    'מֵעוֹרוֹת': 'H5785', 'עוֹרוֹת': 'H5785',                 // "skins", not עִוֵּר "blind"
    'לְהַצִּית': 'יצת',                                    // "to kindle"
    'תּוּבְלוּ': 'H2986', 'הוּבְלוּ': 'H2986', 'וּבְהוּבְלָם': 'H2986', 'וְהוּבְלוּ': 'H2986', 'הַמּוּבָל': 'H2986', 'הַמּוּבָלִים': 'H2986', 'וְהַמּוּבָלִים': 'H2986',   // hophal "be led" — Tubal, הֶבֶל and בַּל had them
    'נִתְאוֹנְנוּ': 'אנן',                                  // "did complain", not Onan
    'עֲמוּסִים': 'עמס',                                    // "laden", not Amos
    'יִרְווּ': 'רוה',                                      // "quench" (drink their fill), not יָרָה
    'הִנְחָם': 'נחה',                                     // "led them", not נִחַם "comfort"
    'וְיָקִים': 'קום',                                    // "He raiseth up", not Jakim
    'נְשָׁכָם': 'נשך',                                     // "they were bitten", not שְׁכֶם
    ...
    'וַיַּזְהִירֵנִי': 'זהר', 'בְּאַזְהָרוֹת': 'זהר', 'וַנַּצְלִיחַ': 'צלח', 'בַחֲקוּקַי': 'חקק',   // one-word families
                                      // "I will depart" (סוּר), not אָסַר "bind"
    ...
    // 2 Nephi 9 audit (2026-09-13)
    'עֳנָשִׁים': 'ענש', 'וְעׇנְשָׁם': 'ענש',                   // "punishments", "their torment" (one-word families)
    'מְפֹרָשִׁים': 'פרשׁ',                                    // "detailed" (was horseman)
    'וּמִכְלַת': 'כלא',                                       // "and fold of" (מִכְלָה, not כָּלָה finish)
    'כָּלֹה': 'כלה', 'יִכְלֶה': 'כלה',                         // "must waste away" (infinitive absolute + yiqtol; was כֹּל / prison)
    'לַבּוֹרֵא': 'ברא',                                       // "the Creator" (one-word family)
    'כַפָּרָה': 'כפר',                                        // "an atonement" (was fruit)
    'קִשְׁרֵי': 'קשר',                                        // "combinations of" (one-word family)
    'מֵתָיו': 'מות',                                          // "its dead" (was מְתִים men)
    'לְבוּשִׁים': 'לבש',                                      // "being clothed" (was shame)
    'הַמּוּכָנָה': 'כון',                                     // "prepared" (was כֵּן so)
    'לַהֲבָתוֹ': 'להב',                                       // "flame" (was בַּת daughter)
    'מַצָּבוֹ': 'נצב',                                        // "his state" (was Aramaic צְבוּ will)
    'תוֹעִיל': 'יעל', 'תּוֹעִיל': 'יעל',                       // "it profiteth" (one-word family; the NT form carries the dagesh)
    'לִמּוּדָם': 'למד',                                       // "their learning" (was blood)
    'הִשִּׂיגַנִי': 'נשג',                                    // "hath obtained me" (was שִׂיג)
   ...
   // "traditions" (מָסֹרֶת, not the camp Moserah)
    ...
    // Mosiah 14 audit (2026-09-13)
    'מַכְאֹבֵינוּ': 'כאב',                                      // "our sorrows" (מַכְאוֹב, not אָב father)
    ...
    // Mosiah 26 audit (2026-09-13)
    'מוּדָחִים': 'דחה', 'כּוֹפְרִים': 'כפר', 'וְהַנִּטְבָּלִים': 'טבל', 'הַנִּטְבָּלִים': 'טבל', 'וַיַּאֲשִׁימוּם': 'אשם', 'הֲבִיאוֹנוּם': 'בוא', 'בִּזְהִירוּת': 'זהר', 'יִכּוֹנוּ': 'כון', 'מִצֹּאנִי': 'צאן', 'בְרָאתִים': 'ברא',
    'הִכּוֹנוּ': 'כון', 'דְּחִיתֶם': 'דחה', 'דְּחִיָּתָם': 'דחה',   // "prepare ye" (הִכּוֹן, not נָכָה); the D&C's procrastinated (דָּחָה)
    // expelled (דָּחָה, not דְּחִי), deny (כָּפַר, not פָּרַר), baptized, accused, brought, circumspectly, established (כּוּן, not נָכָה), My sheep (צֹאן, not מָצָא), created (בָּרָא, not רָאָה)
    // Mosiah 27 audit (2026-09-13)
    ...
    // Alma 4 audit (2026-09-13)
    'חוֹדֵר': 'חדר',                                           // "creeps into" (heading; חָדַר)
    'מִתְמַנֶּה': 'מנה',                                        // "is appointed" (heading; not יָמִין)
    'וְהִתְקַדְּמוּת': 'קדם', 'וְהִתְקַדְּמוּתָהּ': 'קדם', 'הַקֹּדְמוֹת': 'קדם',   // "progress", "which went before" (not Kedemoth)
    'מִתְעַכֶּבֶת': 'עכב',                                       // "is delayed"
    'הַנִּשְׁלָחִים': 'שלח',                                     // "were sent"
    'נֵעוֹרוּ': 'עור',                                         // "they were awakened" (not נַעַר youth)
    'וּמִשְׁיָם': 'משי', 'וּלְבוּשֵׁיהֶם': 'לבש',                     // "their silk", "their garments" (not שַׁי gift)
    ...
    // Alma 18 audit (2026-09-13)
    'הַמֶּרְכָּבוֹת': 'רכב', 'מִשְׁאֲלוֹתֵינוּ': 'שאל', 'מִשְׁאֲלוֹתֵיכֶם': 'שאל', 'וּמִשְׁאֲלוֹתַי': 'שאל', 'וּמִשְׁאֲלוֹתֵיכֶם': 'שאל', 'מִשְׁאֲלוֹת': 'שאל', 'סוֹבֵר': 'סבר', 'עֶדְרָיו': 'עדר', 'עֶדְרֶיךָ': 'עדר', 'נֶעֱרַךְ': 'ערך', 'תְּלָאוֹתָם': 'לאה', 'בֵאֵר': 'באר',
    // supposes (heading; סָבַר), flocks (עֵדֶר), appointed (עָרַךְ, not נַעַר youth), chariots (not Beth-marcaboth), desires (מִשְׁאָלָה, not Mishal), travail (תְּלָאָה), expounded (בֵּאֵר, not the Nile)
    // Alma 19 audit (2026-09-13)
    'וּבְהוֹדָיָה': 'ידה', 'וּמָחָה': 'מחה', 'אֶמְחֶה': 'מחה', 'וַיִּמָּחוּ': 'מחה', 'וּמָחִיתִי': 'מחה', 'יִמְחֶה': 'מחה', 'יִמָּחֶה': 'מחה', 'וְנִמְחוּ': 'מחה', 'תִמָּחֶה': 'מחה', 'יִמַּח': 'מחה', 'תִּמָּח': 'מחה', 'יִמָּחוּ': 'מחה', 'מְחֵה': 'מחה', 'תִּמָּחֶה': 'מחה', 'מָחִיתָ': 'מחה', 'וַיִּמַּח': 'מחה', 'רָצָה': 'רוץ', 'לַנֶּפִיִּי': 'הנפיים', 'בְּהָגִנּוֹ': 'גנן', 'הִקְהִילָה': 'קהל', 'הַמְּבֹרָךְ': 'ברך', 'הוּבְנוּ': 'בין',
    ...
    // Alma 28 audit (2026-09-13)
    'וּמִבְטָחָם': 'בטח', 'פְּלָיַת': 'פלה',   // their safety (מִבְטָח, not Betah), the inequality of (הַפְלָיָה, not Peleth)
    // Alma 29 audit (2026-09-13)
    'מַעֲנִיק': 'ענק', 'וְאֶתְהַלֵּל': 'הלל', 'תַאֲוָתוֹ': 'אוה', 'וְאֶתְהַלָּל': 'הלל', 'יַעֲשֵׂנִי': 'עשה',   // bestows (הֶעֱנִיק, not the Anakim), his desire (תַּאֲוָה, not אוֹת sign), I glory, may make me
    // Alma 30 audit (2026-09-13)
    'לוֹעֵג': 'לעג', 'הַתַּאֲוֹת': 'אוה', 'הִתְאַוֹּת': 'אוה', 'וְהַתַּאֲוֹת': 'אוה', 'מַתְאִים': 'תאם', 'וְלֻעַגְנוּ': 'לעג', 'הָעוֹגִין': 'עגן', 'תַּאֲוֹת': 'אוה', 'תַאֲוֹת': 'אוה', 'תַּאֲוֹתָיו': 'אוה', 'תַאֲוֹתֵיהֶם': 'אוה', 'תַאֲוֹתָיו': 'אוה',                                           // "mocks" (heading; לָעַג, not Og)
    'הַנֶּאֱסָרִים': 'אסר', 'תְּחַכּוּ': 'חכה', 'בִּיגִיעַ': 'יגע', 'אִוָּכַח': 'יכח', 'הֲתִתְוַכַּח': 'יכח', 'תַסִּית': 'סות',   // one-word forms home
    'כּוֹבֵשׁ': 'כבשׁ',                                          // "conquered" (כָּבַשׁ, not בּוֹשׁ be ashamed)
    'תַאֲוֹתֵיכֶם': 'אוה',                                       // "your own desires" (תַּאֲוָה, not תָּא chamber)
    'מַאֲשִׁים': 'אשם',                                         // "accusing" (הֶאֱשִׁים, not אֵשׁ fire)
    'וּמְסָרוּהוּ': 'מסר',                                       // "and delivered him" (מָסַר, not סוּר)                                         // "which move" (נָע, not נָעִים pleasant)
    ...
    'פּוֹרְשֵׁי': 'פרשׁ', 'הִכַּרְתֶּם': 'נכר', 'תַּהְכְּרוּ': 'נכר', 'הִכַּרְתִּיו': 'נכר',                                       // "dissenters of" (פּוֹרֵשׁ, one who separates)
    ...
    // Alma 53 audit (2026-09-13)
    'הַבָּחוּרִים': 'בחר',                                 // "the young men" (בָּחוּר), not חֵרוּת liberty
    ...
    // Alma 55 audit (2026-09-13)
    'מְפֻתִּים': 'פתה',                                   // "are decoyed" (פִּתָּה), not מוֹפֵת a wonder
    'לְמָנוֹתֵינוּ': 'מנה', 'מָנוֹתֵינוּ': 'מנה',            // "our rations" (מָנָה), not the preposition מִן
    'בְּחִכָּם': 'H2441', 'חִכָּם': 'H2441',                // "their taste" (חֵךְ the palate), not חָכָם wise
    'לְהִשְׁתַּכֵּר': 'שכר', 'בַּשָּׂכָר': 'שכר',              // hire and reward are the sin שָׂכָר, not drunkenness
    'וּשְׁבוּיֵי': 'שבה', 'וּשְׁבוּיֵיהֶם': 'שבה', 'שְׁבוּיֵיהֶם': 'שבה',
    ...
    // Alma 57 audit (2026-09-13)
    'וּבְרִיחָתָם': 'ברח', 'בְּרִיחָתָם': 'ברח',            // "their flight" (בָּרַח), not רֵיחַ a smell
    'נָמִיר': 'מור',                                      // "we would exchange" (הֵמִיר), not נָמֵר a leopard
    'מִהַרְנוּ': 'מהר',                                    // "we hastened" (מִהֵר), not רִנָּה singing
                                       // "we did sleep" (יָשֵׁן), not the particle יֵשׁ
    ...
    'וַנְּחַכֶּה': 'חכה',                                   // "and we did wait" (חִכָּה), not נָחָה lead
    'וַנַּט': 'נטה', 'וַנַּגִּיעַ': 'נגע', 'בְּהֲגָנַת': 'גנן', 'בַּהֲגָנַת': 'גנן',
    'לְגִד': 'גד',                                        // prefixed Gid had a family of its own
    'טֵאוֹמְנֶר': 'טאומנר', 'וְטֵאוֹמְנֶר': 'טאומנר', 'לְטֵאוֹמְנֶר': 'טאומנר', 'וּטְאוֹמְנֵר': 'טאומנר',
    // Alma 59 audit (2026-09-13)
    'כּוֹחוֹת': 'כחח', 'כּוֹחוֹתָיו': 'כחח', 'כּוֹחוֹתֵיהֶם': 'כחח',   // "forces" — the plene spelling fell into Havvoth-jair
    'כּוֹעֵס': 'כעס', 'כּוֹעֶסֶת': 'כעס',                    // "is angry" — the plene participle of כָּעַס
    'מִפָּהוֹרָן': 'פהורן',
    // Alma 60 audit (2026-09-13)
    'מְאַיֵּם': 'אים', 'מְאַיֶּמֶת': 'אים',                  // "threatens" (אִיֵּם), not the Aramaic particle מָא
    'נִתְאוֹנַנּוּ': 'אנן', 'מִתְאוֹנֵן': 'אנן',              // "complained" (הִתְאוֹנֵן), not Onan
    'וְזָבֵי': 'זוב', 'זָבֵי': 'זוב',                        // "flowing with" (זָב), not Zabbai
    'אֲחֻזָּתֵנוּ': 'אחז', 'אֲחֻזָּתָם': 'אחז',              // "our possessions" (אֲחֻזָּה), not Achuzzath
    'וּמִמֶּמְשַׁלְתְּכֶם': 'משל', 'מֶמְשַׁלְתְּכֶם': 'משל',     // "your authority" (מֶמְשָׁלָה), not שָׁאַל ask
    ...
    // Alma 62 audit (2026-09-13)
    'הוּקַל': 'קלל', 'צוֹעֵד': 'צעד', 'צוֹעֶדֶת': 'צעד',
    // the flee family was a junk drawer: the banner of נֵס and the testing of נִסָּה sat in it
    'נִסּוֹ': 'נסס', 'לְהִתְנוֹסֵס': 'נסס', 'נֹסְסָה': 'נסס',
    'הַמְּנֻסִּים': 'נסה', 'הַמְנַסִּים': 'נסה', 'הַמִּתְנַסִּים': 'נסה', 'וְנַסֹּה': 'נסה',
    'וּתְנַסֶּה': 'נסה', 'יְנַסֶּה': 'נסה', 'יְנֻסֶּה': 'נסה', 'יְנֻסּוּ': 'נסה',
    'מְנַסִּים': 'נסה', 'נִסּוּ': 'נסה', 'נַסּוּ': 'נסה', 'נֻסּוּ': 'נסה',
    'תְּנֻסּוּ': 'נסה', 'תְנַסֶּה': 'נסה',
    ...
    // Helaman 4 audit (2026-09-13)                                   // "the dissenters of" belongs with the other dissenters
    ...
    // Helaman 7 audit (2026-09-13)
    'בְּגַנּוֹ': 'גנן', 'בְגַנּוֹ': 'גנן', 'גִּנָּתוֹ': 'גנן',   // Nephi's garden tower — גַּן, not בַּג food or Ginath
    'וַיִּצְבֶּה': 'צבה',                                  // "was swollen" (צָבָה), not צָבָא an army
    'תִּלָּקַחְנָה': 'לקח',
    ...
    // Helaman 14 audit (2026-09-13)
    'וּזְעָזוּעִים': 'זעזע', 'זְעָזוּעִים': 'זעזע',
    'וְתוּשְׁבוּ': 'שוב',                                  // "and be restored" (הוּשַׁב), not תּוֹשָׁב a sojourner
    'וּשְׁבָרִים': 'שבר', 'בִּשְׁבָרִים': 'שבר',             // "fragments" (שֶׁבֶר), not Shebarim the place
    // the lion family holds the lights of Genesis 1; they belong to אוֹר
    'אוֹרוֹת': 'אור', 'הָאוֹרוֹת': 'אור', 'הַמְּאוֹרוֹת': 'אור', 'מְאוּרוֹת': 'אור',
    // the sea family was a junk drawer: including, being, stars and speaking
    'כּוֹלְלִים': 'כלל', 'הַכּוֹלְלִים': 'כלל', 'וְכוֹלְלִים': 'כלל',
    'הֹוִים': 'הוא', 'הַהֹוִים': 'הוא', 'וְהֹוִים': 'הוא',
    'כֹּכָבִים': 'כבב', 'מְמַלֲלִים': 'מלל',
    // Helaman 15 audit (2026-09-13)
    'תוּכַלְנָה': 'יכל',                                   // "they can" (יָכֹל), not כָּלָה to finish
    'וְרוֹעָם': 'רֹעֶה', 'רוֹעָם': 'רֹעֶה',                 // "their shepherd" (רֹעֶה), not תְּרוּעָה a blast
    'יְרִיעוֹתֶיךָ': 'יריעה',                              // "your curtains" (יְרִיעָה), not the shouting either
    'תִּכְבַּדְנָה': 'כבד', 'וְתֵעָזַבְנָה': 'עזב',
    // Helaman 16 audit (2026-09-13)
    // the villages and Capernaum are כְּפָר, not פַּר a bullock
    'כְּפַר': 'כפר', 'כְּפָר': 'כפר', 'וּכְפָר': 'כפר', 'וּכְפָרִים': 'כפר', 'בִּכְפָרִים': 'כפר',
    'הַכְּפָר': 'כפר', 'בַּכְּפָר': 'כפר', 'לִכְפָר': 'כפר', 'לַכְּפָר': 'כפר', 'מִכְּפָר': 'כפר',
    'הַכּוֹפְרִים': 'כפר',                                 // "who do deny" (כָּפַר), not פַּר a bullock
    'הוּגְּדוּ': 'נגד',                                    // "had been made known" (הֻגַּד), not גְּדוּד a troop
    // the bullock family also held the atonement, the villages and the fruit
    'בְּכַפָּרָתוֹ': 'כפר', 'כִּפֶּר': 'כפר',
    'פִרְיָהּ': 'H6529', 'פֶּרְיְכֶם': 'H6529', 'פֹרִיָּה': 'פרה', 'לִפְרוֹת': 'פרה',
    // the troop family held the fables and one river bank
    'הַגָּדוֹת': 'גדה', 'הַהַגָּדוֹת': 'גדה', 'לְהַגָּדוֹת': 'גדה', 'מֵהַגָּדוֹת': 'גדה', 'גְּדוֹת': 'גדה',
    // the judging family held the teaching of לָמַד and two forms of כָּבוֹד
    'לְלַמְּדֵנוּ': 'למד', 'לַמְּדֵנוּ': 'למד', 'וּבְלַמְּדֵנוּ': 'למד', 'לָמַדְנוּ': 'למד',
    'כְּבוֹדֵנוּ': 'כבד', 'לִכְבוֹדֵנוּ': 'כבד',
    // 3 Nephi 1 audit (2026-09-13)
    'שְׁאֵת': 'נשא',                                       // "majesty" (שְׂאֵת, the lifting up), a family of one
    'בַּמָּסוֹרוֹת': 'מסר', 'מָסוֹרוֹת': 'מסר', 'וּמָסוֹרֶת': 'מסר', 'מָסוֹרֶת': 'מסר',
    // the traditions of the fathers are spelled 9 ways; every one was in סוּר "turn aside"
    'בְּמָסֹרֶת': 'מסר', 'בְּמָסֹרוֹת': 'מסר', 'בְּמָסֹרוֹתֵיהֶם': 'מסר', 'וּמָסֹרְתָם': 'מסר',
    'מִמָּסֹרוֹת': 'מסר', 'מָסֹרְתָם': 'מסר', 'מָסֹרֶת': 'מסר', 'מָסֹרוֹת': 'מסר',
    'מָסׇרְתְּכֶם': 'מסר',
    // 3 Nephi 2 audit (2026-09-13)
    'מַלְבִּינִים': 'לבן',                                 // "make white" (הִלְבִּין), not Janum the town in Judah
    'בּוֹדִים': 'בדא',                                     // "they imagine" (בָּדָא), not דַּי enough
    // 3 Nephi 3 audit (2026-09-13)
    // הוֹרָאָה "instruction" was in רָאָה "see", and הוֹרָם in רוּם "be high"
    'בְּהוֹרָאָה': 'מוֹרֶה', 'בְּהוֹרָאָתוֹ': 'מוֹרֶה', 'בְּהוֹרָאוֹתַי': 'מוֹרֶה',
    'בְהוֹרָאָה': 'מוֹרֶה', 'בַּהוֹרָאָה': 'מוֹרֶה', 'הַהוֹרָאָה': 'מוֹרֶה',
    'הַהוֹרָאוֹת': 'מוֹרֶה', 'הוֹרָאָה': 'מוֹרֶה', 'הוֹרָאוֹת': 'מוֹרֶה',
    'הוֹרָאוֹתַי': 'מוֹרֶה', 'הוֹרָם': 'מוֹרֶה', 'וְהוֹרָאָה': 'מוֹרֶה',
    'וְהוֹרָאוֹת': 'מוֹרֶה', 'וְלַהוֹרָאָה': 'מוֹרֶה', 'וּבַהוֹרָאָה': 'מוֹרֶה',
    'לְהוֹרָאוֹת': 'מוֹרֶה',
    'מִלָּכוֹנֵאוּס': 'לכונאוס', 'וּמֵהַנֶּפִיִּים': 'הנפיים', 'מְמַנֶּה': 'מנה',
    // the wrongs of עַוְלָה were in עָלָה "go up", and the teachings of הוֹרָאָה in רוּם "be high"
    'עַוְלָתָם': 'עול', 'בָּעַוְלָה': 'עול', 'עַוְלוֹתֵינוּ': 'עול',
    'בְּעַוְלָה': 'עול', 'עַוְלוֹת': 'עול', 'הָעַוְלוֹת': 'עול',
    'עַוְלָה': 'עול', 'בְּעַוְלוֹ': 'עול', 'עַוְלָתָה': 'עול',
    'וּבְעַוְלוֹ': 'עול', 'וְעַוְלָה': 'עול', 
    'בְּעַוְלָתָה': 'עול', 'הָעַוְלָה': 'עול', 'וְעַוְלָתָם': 'עול',
    'לָעַוְלָה': 'עול', 'עַוְלָתֵנוּ': 'עול', 'בְּעַוְלָתֵנוּ': 'עול',
    // 3 Nephi 4 audit (2026-09-13)
    'קְרוּחִים': 'קרח',                                    // "shaven" (קָרֵחַ), not a Korchite
    'וַיּוּמָת': 'מות', 'וַיּוּמְתוּ': 'מות',                // "and was slain" (הוּמַת), not יוֹם a day
    'נִצְחוֹנוֹתֵיהֶם': 'נצח', 'וְקִשְׁרֵי': 'קשר', 'הוּפַל': 'נפל',
    // 3 Nephi 6 audit (2026-09-13)
    'וְהִבְדָּלוֹת': 'בדל', 'הִבְדָּלוֹת': 'בדל',            // "distinctions" (הִבְדִּיל), not דַּל poor
    'תְּקֻנּוּ': 'תקן',                                    // "were repaired" (תִּקֵּן), not קָנָה to buy
    'בּוֹעֲרִים': 'בער',                                   // "ignorant" (בַּעַר brutish), not עִיר a city
    'מֻשְׁרֵי': 'שרה', 'מֻשְׁרוֹת': 'שרה',                   // "inspired by" (מֻשְׁרֶה), not Sharai
    'וְיִסּוּרָיו': 'יסר',                                 // "his sufferings" (יִסּוּרִים), not סוּר turn aside
    'בְּרֻבָּם': 'רבב',                                    // "chiefly" (רֹב the most), not רִיב strife
    'מֵהַמְּעִידִים': 'העיד', 'הַמְּעִידִים': 'העיד', 'מְעִידִים': 'העיד',
    // 3 Nephi 7 audit (2026-09-13)
    ...
    // 3 Nephi 21 audit (2026-09-13) — the אמם junk drawer: it held every מַאֲמִין and אֲמִתִּי
    'לַמַּאֲמִינִים': 'אמן', 'וְהַמַּאֲמִינִים': 'אמן', 'וּמַאֲמִינִים': 'אמן', 'הֶאֱמַנּוּ': 'אמן', 'בְּהַאֲמִינְךָ': 'אמן', 'בְּהַאֲמִינִי': 'אמן', 'בַּאֲמִינְכֶם': 'אמן', 'בְּהַאֲמִינָם': 'אמן', 'בְּהַאֲמִינְכֶם': 'אמן', 'מִמַּאֲמִינֵי': 'אמן', 'מֵהַאֲמִין': 'אמן',
    ...
    // 3 Nephi 28 audit (2026-09-13)
    'חוֹפְצִים': 'חפץ', 'יַקְשִׁיב': 'קשב', 'נֶעֱלָב': 'עלב', 'חֲיוֹתֵנוּ': 'חיה',
    // מְעוֹן the dwelling was filed with עָוֹן iniquity — only the מֵ- prefixed forms are "from their iniquity"
    'מְעוֹן': 'מעון', 'לִמְעוֹן': 'מעון', 'בִּמְעוֹן': 'מעון', 'מְעוֹנֶךָ': 'מעון', 'בִּמְעוֹנוֹת': 'מעון', 'מְעוֹנוֹ': 'מעון', 'מְעֹנָהֿ': 'מעון', 'בִּמְעוֹנוֹתֵינוּ': 'מעון', 'וּבִמְעוֹנֹתֶיהָ': 'מעון', 'וּמְעֹנֹתָיו': 'מעון', 'וּמְעוֹנָתוֹ': 'מעון', 'מְעוֹנֹתָם': 'מעון', 'מְעוֹנָהּ': 'מעון', 'מְעוֹנָתֵנוּ': 'מעון', 'מְעוֹנָם': 'מעון', 'לִמְעוֹנַת': 'מעון', 'מְעוֹנוֹת': 'מעון',
    // the טלה family held the lamb and every בָּטֵל "idle, void, done away"
    'בְּטֵלָה': 'בטל', 'בְטֵלָה': 'בטל', 'בָּטְלָה': 'בטל', 'בָּטֵלָה': 'בטל', 'בִּטְּלָה': 'בטל',
    // 3 Nephi 29 audit (2026-09-13)
    ...
    // Mormon 5 audit (2026-09-13)
    'וְכַפְרֵיהֶם': 'כפר',   // "their villages" (כְּפָר) was H6529 פְּרִי, fruit
    ...
    // Mormon 9 audit (2026-09-13)
    'הַנִּסִּים': 'נסס',   // "the miracles" was נוּס, to flee
    'בָּשֶׁבֶת': 'ישב', 'מִלָּשֶׁבֶת': 'ישב',   // "to dwell" was שָׁבַת, to cease
    ...
    // Moroni 7 audit (2026-09-13)
    'מְאַפְשֶׁרֶת': 'אפשר', 'מְשַׁדֵּל': 'שדל', 'קְרִיאָתוֹ': 'קרא',
    'תַרְשִׁיעוּהוּ': 'רשע', 'לִתְבֹּעַ': 'תבע', 'תְּקוּמָתוֹ': 'קום',
    'שׇׁרְתָם': 'שרת',   // "their ministry" was שַׂר, a prince
    ...
    // Pearl of Great Price front matter audit (2026-09-13)
    'פֻּרְסְמוּ': 'פרסם', 'שֶׁפֻּרְסְמוּ': 'פרסם', 'שֶׁפֻּרְסְמָה': 'פרסם',
    'זָכְתָה': 'זכה', 'שֶׁדָּרְשׁוּ': 'דרש', 'קוֹדְמִים': 'קדם', 'שֶׁלְּפָנֵינוּ': 'H6440',
    'בַּמַּהֲדוּרָה': 'מהדורה', 'וּבַמַּהֲדוּרָה': 'מהדורה', 'וְלִפְסוּקִים': 'פסוק',
    'וְהִיסְטוֹרְיָתוֹ': 'היסטוריה', 'מַטְרָתוֹ': 'מטרה', 'הַבְּרִיטִית': 'בריטי',
    'קֶטַע': 'קטע', 'קְטָעִים': 'קטע', 'בְּמֶרְץ': 'מרץ', 'מִצְרִיּוֹת': 'מצרי',
    // Joseph Smith—Matthew audit (2026-09-13)
    'וּמָסְרוּ': 'מסר', 'לְמָסְרוֹ': 'מסר', 'מָסְרוּ': 'מסר', 'וּמָסַרְתִּי': 'מסר', 'וּמֹסְרִים': 'מסר', 'מְסַרְתֶּם': 'מסר', 'מְסָרוֹ': 'מסר', 'מְסָרוּם': 'מסר', 'מָסַרְתָּם': 'מסר',   // "deliver up, betray" (מָסַר) was סוּר, to turn aside
    // Joseph Smith—History audit (2026-09-13) — the שֶׁ- and prefixed forms that fell out of their families
    'שֶׁרִגְשׁוֹתֵיהֶם': 'רגש', 'שֶׁרִגְשׁוֹתַי': 'רגש', 'הַהִתְרַגְּשׁוּת': 'רגש', 'שֶׁהִרְגַּשְׁתִּי': 'רגש',
    'שֶׁסִּפּוּרִי': 'ספר', 'שֶׁסִּפֵּר': 'ספר', 'הַסִּפּוּר': 'ספר', 'הַנִּזְכֶּרֶת': 'זכר',
    'הַנִּזְכָּר': 'זכר', 'שֶׁזּוֹכֵר': 'זכר', 'וּפָסוּק': 'פסוק', 'מִפָּסוּק': 'פסוק',
    'פְּסוּקֵי': 'פסוק', 'פְּסוּקִים': 'פסוק', 'פְּסוּקֵיהֶם': 'פסוק', 'שֶׁקָּרְאוּ': 'קרא',
    'שֶׁנִּכְנַס': 'כנס', 'שֶּׁהָיְתָה': 'היה', 'שֶׁנִּסִּיתִי': 'נסה', 'שֶׁמֵּעוֹלָם': 'עלם',
    'שֶׁנָּפַל': 'נפל', 'שֶׁנּוֹעַדְתִּי': 'יעד', 'שֶׁקָּמוּ': 'קום', 'שֶׁצָּרִיךְ': 'צרך',
    'שֶׁאֲצֻוֶּה': 'צוה', 'שֶׁחַדְרִי': 'חדר', 'שֶׁבָּרְחָה': 'ברח', 'שֶׁשִּׂיחוֹתֵינוּ': 'שיח',
    'שֶׁחֶלְקָהּ': 'חלק', 'שֶׁהַזְּמַן': 'זמן', 'שֶׁנְּסִיבוֹת': 'סבב', 'שֶׁיָּכֹלְנוּ': 'יכל',
    'שֶׁנּוֹדַע': 'ידע', 'שֶׁלְּאַחֲרָיו': 'אחר', 'שֶׁמָּצָא': 'מצא', 'שֶׁמַּלְאַךְ': 'לאך',
    'שֶׁבְּלַמְּדוֹ': 'למד', 'שֶׁשָּׁלְחוּ': 'שלח', 'שֶׁבִּקֵּר': 'בקר', 'שֶׁלֵּאלֹהִים': 'אלהים',
    'שֶׁתֻּרְגְּמוּ': 'תרגם', 'שֶׁשָּׁכְבוּ': 'שכב', 'מִמִּשְׁכָּבִי': 'שכב', 'הַהִתְנַגְּדוּת': 'נגד',
    'מְשֻׁתָּף': 'שתף', 'יִנָּזֵף': 'נזף', 'מֵהַנָּחַת': 'נוח', 'בַּהֲפָצַת': 'פוץ',
    'וְהִצַּגְתִּי': 'יצג', 'בְּהֶשֵּׂגָיו': 'נשג', 'בַחֲזָרָה': 'חזר', 'מְחַזֵּר': 'חזר',
    'לְצַטֵּט': 'צטט', 'וְצִטֵּט': 'צטט', 'הַדִּבּוּר': 'דבר', 'יַטְבִּיל': 'טבל',
    'אֱלֹהִית': 'אלהים', 'פּוֹגְעִים': 'פגע', 'בְּיֵאוּשׁ': 'יאש', 'שֶׁאֵרְעוּ': 'ארע',
    'שֶׁיִּרְצוּ': 'רצה', 'טוֹעִים': 'תעה', 'אֵיזוֹ': 'אי', 'לְאֵיזוֹ': 'אי',
    'וּלְאֵיזוֹ': 'אי', 'נְשִׁימָתוֹ': 'נשם', 'פּוֹעֲלָיו': 'פעל', 'חֲשִׁיבוּת': 'חשב',
    'שִׁנּוּי': 'שנה', 'קְפֵדָנִיּוֹת': 'קפד', 'גְּלִימָתוֹ': 'גלם', 'וְהַמִּתְגַּיְּרִים': 'גיר',
    'שֶׁנִּגְרַם': 'גרם', 'לְגָרוֹם': 'גרם', 'דָּתִי': 'דת', 'דָּתִית': 'דת',
    'הַדָּתִית': 'דת', 'דָתִיִּים': 'דת', 'שְׁטוּתִיּוֹת': 'שטה', 'וּשְׁטֻיּוֹתַי': 'שטה',
    'וּלְהִתְיַחֵס': 'יחס', 'הִתְיַחֵס': 'יחס', 'לְהִרְהוּר': 'הרהר', 'הִרְהוּרַי': 'הרהר',
    'לְמַסְקָנָה': 'מסקנה', 'לִמְסַקָּנָה': 'מסקנה', 'לַקְּהִילָּה': 'קהילה', 'וּבְוִכּוּחַ': 'וכוח',
    'לְהִתְאַכְסֵן': 'אכסן', 'מַתְמֶדֶת': 'תמד', 'הַתַּרְנְגוֹל': 'תרנגול', 'הַמֶּתוֹדִיסְטִים': 'מתודיסט',
    'וְהַמֶּתוֹדִיסְטִים': 'מתודיסט', 'לַמֶּתוֹדִיסְטִים': 'מתודיסט', 'וְלַמֶּתוֹדִיסְטִים': 'מתודיסט', 'הַפְּרֶסְבִּיטֶרְיָנִים': 'פרסביטרין',
    'לַפְּרֶסְבִּיטֶרְיָנִים': 'פרסביטרין', 'הַבַּפְּטִיסְטִים': 'בפטיסט', 'לַבַּפְּטִיסְטִים': 'בפטיסט', 'לְדֵצֶמְבֶּר': 'דצמבר',
    'דֵּצֶמְבֶּר': 'דצמבר', 'לְנוֹבֶמְבֶּר': 'נובמבר', 'לְסֶפְּטֶמְבֶּר': 'ספטמבר', 'לְיָנוּאָר': 'ינואר',
    'לַדּוֹקְטוֹר': 'דוקטור',
    // Pearl of Great Price tidy-up (2026-09-13)
    'שִׁנּוּיִים': 'שנה', 'הַפָּסוּק': 'פסוק', 'וְהַפָּסוּק': 'פסוק', 'בְּאֶמְצַע': 'אמצע',
    ...
    // Doctrine and Covenants 71–80 audit (2026-09-13)
    'הַמְּגֻדָּלִים': 'גדל',   // "being brought up" was מִגְדָּל, a tower
    'תְּלוּנוֹת': 'לון',   // "the murmurings of" was לָוָה, to join or lend
    'לְתַכֵּן': 'תכן',   // "in regulating" was לֶתֶךְ, a dry measure
    ...
    // Doctrine and Covenants 91–100 audit (2026-09-13)
    'חַפִּים': 'חפף',   // "innocent" (חַף) was H2650 Huppim, a son of Benjamin
    'וְהָכָנַת': 'כון',   // "and preparing" was H3674, the Aramaic colleague
    'לְהִוָּסֵר': 'יסר',   // "be chastened" was סוּר, to turn aside
    ...
    'פָּרַשׁ': 'פרשׁ',
    // New Testament audit, Matthew (2026-09-13) — families the forms never reached
    'וְתִמְחֲלוּ': 'מחל', 'מָחַל': 'מחל', 'תִּמְחֲלוּ': 'מחל',
    'שֶׁמָּחַל': 'מחל', 'וּמְחַל': 'מחל', 'מֹחְלִים': 'מחל',
    'מְחֹל': 'מחל', 'וּמָחַלְתָּ': 'מחל', 'תִמְחֲלוּ': 'מחל',
    'מָחַלְנוּ': 'מחל', 'יִמְחַל': 'מחל', 'וּמָחַלְתִּי': 'מחל',
    'וַיִּמְחֹל': 'מחל', 'מָחַלְתִּי': 'מחל', 'מִסַּנְהֶדְרִין': 'סנהדרין',
    'סַנְהֶדְרִין': 'סנהדרין', 'בְּסַנְהֶדְרִין': 'סנהדרין', 'הַסַּנְהֶדְרִין': 'סנהדרין',
    'בַּסַּנְהֶדְרִין': 'סנהדרין', 'וְסַנְהֶדְרִין': 'סנהדרין', 'לְסַנְהֶדְרִיּוֹת': 'סנהדרין',
    'לְסַנְהֶדְרִין': 'סנהדרין', 'וּלְסַנְהֶדְרִין': 'סנהדרין', 'סַנְהֶדְרִיּוֹת': 'סנהדרין',
    'הַסַּנְהֶדְרִיּוֹת': 'סנהדרין', 'וּמֵהַסַּנְהֶדְרִין': 'סנהדרין', 'הֲדוֹם': 'הדם',
    'וְאֵבָרָיו': 'אבר', 'מֵאֵבָרֶיךָ': 'אבר', 'תָּרִיעַ': 'רוע',
    'הַמְּפַטְפֵּט': 'פטפט', 'תְּפַטְפְּטוּ': 'פטפט', 'דְּגָנוֹ': 'דגן',
    'הַמִּכְמֹרוֹת': 'כמר', 'וְהֵתֵלּוּ': 'התל', 'הֵתֵלּוּ': 'התל',
    'הַנֶּאֱמָר': 'אמר', 'הַנֶּאֱמָרָה': 'אמר', 'וְנָח': 'נוח',
    'נָח': 'נוח', 'וּכְבוֹדָן': 'כבד', 'יְקֻיַּם': 'קום',
    'יִתְקַיְּמוּ': 'קום', 'יִתְקַיְּמוּ': 'קום', 'קִיַּמְתִּי': 'קום',
    'קִיַּמְתִּי': 'קום', 'וּכְאֵבוֹ': 'כאב', 'שְׁבֻעוֹתֶיךָ': 'שבע',
    'הַפְּרוּטָה': 'פרוטה', 'אֲשַׁלְּחֶנָּה': 'שלח', 'גְּלוֹתָם': 'גלה',
    'הַנּוֹצָר': 'יצר', 
    'הַשֵּׁנָה': 'ישן', 'מִשְׁנָתוֹ': 'ישן',
    
    /* New Testament audit (2026-09-13) — prefixed strays: forms that made a
       family of one because the prefix hid the root. The generator proposes,
       a gloss-overlap gate cuts two thirds of its guesses, and what is left
       was read by hand (three more were wrong even after the gate). */
    'וְשֶׁלָּנוּ': 'שלנו', 'מְשֻׁחֲרָר': 'שחרר', 'לְהִפָּטֵר': 'פטר',
    'מֻכְרָח': 'כרח', 'וּכְשֶׁמֵּת': 'מות', 'שֶׁנִּקְצֹר': 'קצר',
    'הַנִּצָּחוֹן': 'נצח', 'שֶׂחֵלֶק': 'חלק', 'הֲנָעֵז': 'עזז',
    'שֶׁזְּכַרְתֶּם': 'זכר', 'שֶׁבָּכֶם': 'בכם', 'נְחֻיַּב': 'חוב',
    'מִלְּדַבֵּר': 'דבר', 'וְיִדּוֹן': 'דין', 'מֵהִקָּרֵא': 'קרא',
    'וּכְשֶׁתִּזְרַע': 'זרע', 'שֶׁיְּלַמֵּד': 'למד', 'בַּהֲקָמַת': 'קום',
    'בַּמַּאֲמָר': 'אמר', 'שֶׁיִּוָּשֵׁעוּ': 'ישע', 'שֶׁיַּשִׂיג': 'נשג',
    'וְהֶגְמוֹן': 'הגמון', 'אַעֲצִיבְכֶם': 'עצב', 'שֶׁשִּׂמְחָתִי': 'שמח',
    'נְצַפֶּה': 'צפה', 'בִּשְׁקִידוֹת': 'שקד', 'שֶׁהַקְּהִלּוֹת': 'קהל',
    'כִּמְאַיֵּם': 'אים', 'שֶׁיֵּשׁוּעַ': 'H3442', 'שֶׁנֵּרָאֶה': 'ראה',
    'וַהֲטִיבֹתֶם': 'טוב', 'יְגַדְּפוּם': 'גדף', 'שֶׁלְּפָנִים': 'H6440',
    'וְהִתְמֹגֲגוּ': 'מוג', 'שֶׁצְּרִיכִים': 'צרך', 'בְּהוֹפָעָתוֹ': 'יפע',
    'וְעֵילָמִים': 'H5867', 'הַנָּצְרִי': 'נצרי', 'הַנִּמְסָר': 'מסר',
    'שֶׁיְּקַבְּלוּ': 'קבל', 'וּלְמוֹשִׁיעַ': 'ישע', 'אֶתְמֹל': 'H8543',
    'בְּהוֹכִיחוֹ': 'יכח', 'בְּהוֹקִיעָם': 'יקע', 'וּלְפוֹלוֹס': 'פולוס',
    'הַנֶּחֱנָק': 'חנק', 'שֶׁבַּיְּהוּדִים': 'H3064', 'שֶׁפּוֹלוֹס': 'פולוס',
    'שֶׁיִּחְיֶה': 'חיה', 'הַהֶגְמוֹן': 'הגמון', 'שֶׁתִּשְׁמָעֵנוּ': 'שמע',
    'הַנָּצְרִים': 'נצר', 'שֶׁתִּמָּלְאוּ': 'מלא', 'וְלִלְבּשׁ': 'לבש',
    'וּבְעֹז': 'עזז', 'שֶׁיּוֹדְעִים': 'ידע', 'שֶׁבְּכֹחָהּ': 'כחח',
    'הַמְיֻעָד': 'יעד', 'שֶׁחַיָּב': 'חוב', 'נִצְלָב': 'צלב',
    'שֶׁנַּחֲזִיק': 'חזק', 'שֶׁיִּטָּהֲרוּ': 'טהר', 'שֶׁיַּאֲמִין': 'אמן',
    'מֵחֲמַת': 'חֵמָה', 'שֶׁיְּבַקֵּשׁ': 'בקש', 'הַמַּגְאֶלֶת': 'גאל',
    'מִנְּצָרֶת': 'נצר', 'הַיּוֹנִים': 'H3123', 'נָעִיד': 'עיד',
    'אֶטְעֹן': 'טען', 'הֲהִרְשִׁיעָךְ': 'רשע', 'בְּשַׂעֲרוֹתֶיהָ': 'שׂער',
    'שֶׁיִּפֹאַר': 'פאר', 'אֶצְלֹב': 'צלב', 'לׇאֳנִיָּה': 'אניה',
    'וַיהוָֹה': 'יהוה', 'וְהוֹרָיו': 'הרה', 'לְמֵטִיבֵיכֶם': 'יטב',
    'תְחֻיָּבוּ': 'חוב', 'וְהַמְעֻנָּגִים': 'ענג', 'וְהַמְאַבֵּד': 'אבד',
    'שֶׁיִּקְנֶה': 'קנה', 'וּלְמשֶׁה': 'H4872', 'הַפּוֹעֵל': 'פעל',
    'נְנַעֲרֵהוּ': 'נער', 'הַנֶּחֱלָקָה': 'חלק', 'בִשְׁלוֹמְכֶם': 'שלם',
    'בַּעֲנָפָיו': 'ענף', 'הַתַּרְנְגֹלֶת': 'תרנגלת', 'וְהַמַּשְׁפִּיל': 'שפל',
    'לְקָרֵר': 'קרר', 'שֶׁיָּשׁוּב': 'שוב', 'תּוֹאֲנָה': 'אנה',
    'וְהַתַּרְנְגוֹל': 'תרנגול', 'מִלִּכְרֹעַ': 'כרע', 'מִנְּצֶרֶת': 'נצר',
    'לְגֵיהִנֹּם': 'גיהנם', 'הֲנֹאמַר': 'אמר', 'שֶׁאַתִּיר': 'נתר',
    'לִצְלֹב': 'צלב', 'וַיָּגָל': 'יגל', 'וּלְפֶטְרוֹס': 'פטרוס',
    'וְלַגּוֹיִם': 'H1471', 'בְּגֵיהִנֹּם': 'גיהנם', 'הַנֶּחֱלָקִים': 'חלק',
    'תְּחֻיָּב': 'חוב', 'שֶׁיֹּאבַד': 'אבד', 'שֶׁיּוּכַל': 'יכל',
    'הַנִּשְׂכָּרִים': 'שכר', 'וַעֲבֹד': 'עבד', 'כַּתַּרְנְגֹלֶת': 'תרנגלת',
    'לַהֶגְמוֹן': 'הגמון', 'סִכְרוּהוּ': 'כרה', 'מְחַלֶּה': 'חלה',
    'בַּמַּאֲסָר': 'אסר', 'שֶׁיְּשָׁרֲתֵנִי': 'שרת', 'שֶׁיֻּכְרַז': 'כרז',
    'שֶׁהִשַׂגְתִּי': 'נשג', 'שֶׁיָּגְעוּ': 'יגע', 'יִנָּזֵק': 'נזק',
    'אַאֲכִילֶנּוּ': 'אכל', 'מַלְשִׁין': 'שין', 'שֶׁגָּמְלָה': 'גמל',
    'הַמְקֻשֶּׁטֶת': 'קשט', 'לְהִטַּמֵּא': 'טמא', 'וְלַלּעֲזִים': 'לעז',
    'תְּחַיֵּב': 'חוב', 'וְהַמִּילָה': 'מילה', 'הַיְבַטֵּל': 'בטל',
    'שֶׁיִּסָּכֵר': 'סכר', 'שֶׁנִּוָּשַׁע': 'ישע', 'שֻׁחֲרַרְתֶּם': 'חרר',
    'שֶׁנֶּחֱלַשׁ': 'חלש', 'שֶׁיֻּרְכְּבוּ': 'רכב', 'בִּשְׁקִידָה': 'שקידה',
    'מַמְרֶה': 'מרה', 'הַמַּאֲמָר': 'אמר', 'לָרֵע': 'רע',
    'וְהֶחָלוּשׁ': 'חלש', 'וְכִקְרִיאַת': 'קרא', 'תַּזְהִיר': 'זהיר',
    'וְיִתְרַצּוּ': 'רצה',
    /* NT audit, Matthew 15-28 (2026-09-13) — SUFFIXED strays. prefix.js peels a
       prefix and structurally cannot see these: תַּלְמִידֶיךָ "your disciples" is
       תַּלְמִיד plus a possessive ending, not a prefix, and it made a family of one. */
    'תַּלְמִידֶיךָ': 'למד', 'וְתַלְמִידֶיךָ': 'למד', 'מִתַּלְמִידֶיךָ': 'למד',
    'בְּתַלְמִידֶיךָ': 'למד', 'לְתַלְמִידֶיךָ': 'למד', 'חַרְדָּל': 'חרדל',
    'הַחַרְדָּל': 'חרדל', 'חֲבִיבִים': 'חביבי', 'חֲבִיבֵינוּ': 'חביבי',
    'קַבָּלַתְכֶם': 'קבל', 'הַפְּרוּטָה': 'פרוטה', 'פְרוּטוֹת': 'פרוטה',
    'שִׂיחַתְכֶם': 'שיח', 'נַקּוּ': 'נקה', 'מַדְרִיכִים': 'דרך',
    'הֵצַל': 'צלל', 'הַנִּכְנָס': 'כנס', 'רְצִיחוֹת': 'רצח',
    'צָלְבוּ': 'צלב', 'וִכּוּחֵי': 'וכוח', 'רוֹמִיִּים': 'רומי',
    'שֹׁמְעֶיהָ': 'שמע', 'שְׁלשִׁים': 'שלש', 'חָשְׁקוּ': 'חשק',
    'שְׁעַתְכֶם': 'שעה', 'טֹעִים': 'טעה', 'קִטְּעִים': 'קטע',
    'הֲמֹן': 'המה',
    /* NT audit (2026-09-13) — the generator's leftovers, retargeted by hand.
       prefix.js proposed a family for each of these and the gloss-overlap gate
       threw the proposal out; the FORM was still a defect (a family of one with
       nothing to say), so each got the family it actually belongs to. */
    'וַיְתָו': 'תוה', 'הַסְכֵּת': 'סוך', 'הַלָּזֶה': 'זה',
    'עָגְמָה': 'עגם', 'רוּחַנִיּים': 'רוח', 'שֶׁזְּנוּת': 'זנה',
    'שֶׁתָּרִיבוּ': 'ריב', 'לָהוּט': 'להט', 'שֶׁמִּתּוֹכָהּ': 'תוך',
    'סְעוּדָתוֹ': 'סעד', 'הַנִּבְצָע': 'בצע', 'נִוָּסֵר': 'יסר',
    'נַלְבִּישׁ': 'לבש', 'וּכְשֶׁיָּשׁוּבוּ': 'שוב', 'עָקְצְךָ': 'עקץ',
    'הַשָּׁבוּעוֹת': 'שבע', 'פְּשִׁיעָה': 'פשע', 'שֶׁלָּזֹאת': 'זאת',
    'יְגִיעָתֵנוּ': 'יגע', 'שָׁקוּד': 'שקד', 'וַחֲשָׁד': 'חשד',
    'הַנִּלְחָצִים': 'לחץ', 'נֶחָמָתֵנוּ': 'נחם', 'נֶחָמַתְכֶם': 'נחם',
    'שֶׁיְּדַעְתֶּם': 'ידע', 'שֶׁמּשְׁלִים': 'משל', 'לְכָךְ': 'כך',
    'שֶׁמּוֹשָׁבֵנוּ': 'ישב', 'הָעֹלֵב': 'עלב', 'זֵרַזְנוּ': 'זרז',
    'כַּשְּׁקִידָה': 'שקד', 'לְבַקָּשָׁתֵנוּ': 'בקש', 'סִפּוּקְכֶם': 'ספק',
    'יַחֲזֹר': 'חזר', 'מִדִּבּוּר': 'דבר', 'שֶּׁיִּרְאֶה': 'ראה',
    'וְאֶתְאַבֵּל': 'אבל', 'בִדּוּי': 'בדה', 'עֲגוּמָה': 'עגם',
    'יְצוֹדֵדוּ': 'צוד', 'שֶׁיּוּסַר': 'סור', 'זְקֵנָתְךָ': 'זקן',
    'לַעֲסֹק': 'עסק', 'צָדָם': 'צוד', 'כִּשְׂפַת': 'שפה',
    'נוֹעַצְתֶּם': 'יעץ', 'בִּכְשָׁפָיו': 'כשף', 'הַצָּע': 'יצע',
    'שֶׁיְּעֻנֶּה': 'ענה', 'בִּמְשׁוֹרֲרֵיכֶם': 'שיר', 'וָאֶתְהוֹלֲלָה': 'הלל',
    'עוֹגִינִים': 'עגן', 'חִכִּיתֶם': 'חכה', 'רוּחָנִית': 'רוח',
    'הָאֱלָהוּת': 'אלהים', 'קִבַּלְתָּהּ': 'קבל', 'נִבּוּל': 'נבל',
    'לַקְּדשִׁים': 'קדש', 'וּפוֹרֵשׁ': 'פרשׁ', 'תַּכְרִיחַ': 'כרח',
    'שֶׁהָרְגְּלוּ': 'רגל', 'הֶפְסֵק': 'פסק', 'שֶׁתִּוָּדַע': 'ידע',
    'בְּהִטָּהֲרָם': 'טהר', 'וּמוֹסִיף': 'יסף', 'שֶׁהוּעֲדָה': 'עוד',
    'נֻסְּרוּ': 'נסר', 'יִסְּרוּנוּ': 'יסר', 'שֶּׁבַּגּוֹלָה': 'גלה',
    'בְּנִסְיֹנוֹת': 'נסה', 'לְרַמּוֹת': 'רמה', 'חֲלוּקֵי': 'חלק',
    'שְׁתוֹתָם': 'שתה', 'שֻׁלְחֲנֹתֵיהֶם': 'שולחן', 'תְּקִימֶנּוּ': 'קום',
    'הַמּוֹסֵר': 'מסר', 'תִמְצָאֻנְנִי': 'מצא', 'תִּבְזוּנִי': 'בזה',
    'יְאַבְּדֶנָּה': 'אבד', 'יִבְזֵנִי': 'בזה', 'שַׁעְתּוֹ': 'שעה',
    'יִמְסְרֵיהוּ': 'מסר', 'בַּעֲשֹׁוֹתְכֶם': 'עשה', 'שֶׁתִּצְּרֵם': 'נצר',
    'לִרְמֹז': 'רמז', 'סְפוֹג': 'ספג', 'מוּסָרָה': 'סור',
    'שֶׁיִּשָּׁאֵר': 'שאר', 'סַכְתָּ': 'סוך', 'לְחַשְׁתֶּם': 'לחש',
    'מֵהַחֲרוּבִים': 'חרב', 'מִמְּרִיבִי': 'ריב', 'שֶׁיִּגְּעוּ': 'נגע',
    'וְהַשֵּׁד': 'שד', 'יַזְהִירֵם': 'זהר', 'יִמְצָאֶנָּה': 'מצא',
    'וְחֻמּוֹ': 'חמם', 'לַהֲנִיעָם': 'נוע', 'הִסִּיתוּ': 'סות',
    'שֶׁיָּכֹל': 'יכל', 'פּוֹשֵׁר': 'פשר', 'חוֹתָמָיו': 'חתם',
    'יַתְווּ': 'תוה', 'סַבְלָנוּתָם': 'סבל', 'לְיַשֵּׁר': 'ישר',
    'שֶׁמִּמַּעֲשֵׂי': 'עשה', 'עֲמִידָה': 'עמד', 'תָבִישׁ': 'בוש',
    'שֶׁיִּשָׂאֵהוּ': 'נשא', 'דְּבוּקִים': 'דבק', 'חִדּוּשׁ': 'חדש',
    'שֶׁיֵּרָאֶה': 'ראה', 'שֶׁמַּחֲשֶׁבֶת': 'חשב', 'יַאֲשִׁימֵם': 'אשם',
    ...
    'בְּהִכָּנְעָן': 'כנע',
    /* FRONT MATTER AND HEADINGS (2026-09-13). 43 word cards rendered EMPTY —
       most of them in the Book of Mormon's own front matter, where the page
       describing this reader used modern Hebrew that no family owned: הַכַּרְטִיס
       "the card", הַסַּרְגֵּל "the bar", תַּעְתִּיק "Transliterate". Found by rendering
       every candidate card headlessly rather than trusting the structural scan. */
    'הָאַזְהָרוֹת': 'זהר', 'מוֹדֶרְנִי': 'מודרני', 'הַנֶּחֱרָץ': 'חרץ',
    'שֶׁנּוּסְדָה': 'יסד', 'כְּגוֹן': 'כגון', 'הֶכְרַח': 'כרח',
    'עַצְמָאִי': 'עצם', 'לַטֶּקְסְט': 'טקסט', 'לִמּוּדִית': 'למד',
    'שֶׁנֶּעֶשְׂתָה': 'עשה', 'הַשְׁתַּדְּלוּת': 'שדל', 'אֶפְשָׁרִיּוֹת': 'אפשר',
    'הַטֶּקְסְט': 'טקסט', 'הָאַנְגְּלִי': 'אנגלית', 'מְדֻקְדָּק': 'דקדק',
    'וְהִתְעַסְּקוּת': 'עסק', 'בַּטֶּקְסְט': 'טקסט', 'וְלַגּוֹי': 'גוי',
    'מְבָאֵר': 'באר', 'וַנַּבִּיט': 'נבט', 'מִלְּתָאֵר': 'תאר',
    'צְמוּדוֹת': 'צמד', 'תְּמִיהָתִי': 'תמה', 'לְפַתּוֹתֵנִי': 'פתה',
    'וַיַּחְזֹר': 'חזר', 'וַיּוֹדִיעֵנִי': 'ידע', 'הַמַּהֲדוּרָה': 'מהדורה',
    'דִּקְדּוּקוֹ': 'דקדק', 'וְהָאַנְגְּלִית': 'אנגלית', 'הַתַּצּוּגָה': 'תצוגה',
    'כַּרְטִיסֵי': 'כרטיס', 'וְהַקּוֹנְקוֹרְדַּנְצְיָה': 'קונקורדנציה', 'כַּרְטִיס': 'כרטיס',
    'הַכַּרְטִיס': 'כרטיס', 'הַסַּרְגֵּל': 'סרגל', 'תַּעְתִּיק': 'תעתיק',
    'הַדְגֵּשׁ': 'דגש',
    /* The last of the thin cards (2026-09-13). Note מֵהַפִּסְגָּה "from the top"
       is here but הַפִּסְגָּה "Pisgah" is NOT: a name family is wrong only for the
       forms that gloss as a common word, and pinning the whole family would have
       moved Pisgah itself — 16 tokens — to "consider". */
    'לְמוֹ': 'למו', 'וּפֵרוּשָׁן': 'פרשׁ', 'שִׂמְחָתְךָ': 'שמח',
    'לִרְבּוֹת': 'רבה', 'אֲדוֹנְכֶם': 'אדן', 'טַקְסֵי': 'טקס',
    'מֵהַפִּסְגָּה': 'פסג', 'אַנִּיחֵם': 'נוח', 'נָדִיר': 'נדיר',
    'רְשִׁימַת': 'רשם', 'שַׁיָּכוֹת': 'שיך', 'נִקּוּד': 'נקוד',
    ...
    /* THE MIRROR OF THE PLENE CLASS (2026-09-13): a DEFECTIVA spelling the
       lexicon carries only plene. Expand one mater and the form lands where it
       belongs — הִבַּטְנוּ "we have looked upon" was בֶּטֶן "belly", הִכַּרְנוּ
       "we know" was רָנַן "to sing", וַתְּשָׁרֲתֵם "and ministered" was שִׁיר
       "to sing", שַׁלְּחֵנוּ "Send us" was שֻׁלְחָן "table" again. */
    'הַיָּשָׁן': 'ישן', 'לְמַעֲנֵנוּ': 'מען', 'הִבַּטְנוּ': 'נבט',
    'הִכַּרְנוּ': 'נכר', 'וּפָנֵינוּ': 'H6440', 'הַמֵּעִיר': 'עור',
    'מִכַּת': 'כת', 'וּלְצַוֹּתָם': 'צוה', 'לִבְרֹא': 'ברא',
    'וְהַיָּכֹל': 'יכל', 'הַיָּשֵׁן': 'ישן', 'יִשְּׁרוּ': 'ישר',
    'יִשֵּׁן': 'ישן', 'הִבָּנוּ': 'בנה', 'בַּכְּבָלִים': 'כבל',
    'בִּכְבָלִים': 'כבל', 'שַׁלְּחֵנוּ': 'שלח', 'אֲדַמֵּהוּ': 'דמה',
    'וַתְּשָׁרֲתֵם': 'שרת', 'מְלֹאָם': 'מלא', 'וּפֵרוֹת': 'פרה',
    'חֲסֵרָה': 'חסר',
    'לְהִלָּוֹת': 'לוה',   // to join himself — was reading as יָלַד
    /* THE MATER CLASSES IN THE OTHER VOLUMES (2026-09-13). The same plene and
       defectiva spellings the lexicon does not carry, in the Book of Mormon,
       the D&C, the Pearl of Great Price and the JST — all of which had already
       had a chapter-by-chapter audit, because this class survives one: the card
       is well-formed and confident and about a different word.
         כַּדּוּרִים   "balls" (the Liahona)  read as דּוֹר  "generation"
         וּבֶהָלָה    "and terror"           read as לֹא   "not"
         בְרֵכוֹת     "pools"                read as רָכַךְ "to be soft"
         הַלְּקוּחוֹת "taken"                read as פָּקַח "to open the eyes"
         מֵרֵעֵינוּ   "from our friends"     read as רָעַע "to be evil"
         וּגְוִיָּתִי  "and my body"          read as גּוֹי  "a nation" */
    'מֹצֵאת': 'יצא', 'בְּרָכוֹת': 'ברך',
    'בִּרְכוֹת': 'ברך', 'בְרָכוֹת': 'ברך',
    'רְצוּיִם': 'רצה', 'יִרְאֵנִי': 'ראה', 'הֻכָּרוּ': 'נכר',
    'נוֹכְחִים': 'נכח', 'בְּרָכוֹת': 'ברך', 'וְהֻפְּרוּ': 'פרר',
    'וַהֲכִינוּ': 'כון', 'וְתַקְּנוּ': 'תקן', 'נוֹכֵחַ': 'נכח',
    'נוֹכָחוֹת': 'נכח', 'וּבְזַרְעֵנוּ': 'זרע', 'מֻמְלָצִים': 'מלץ',
    'תִּקָּרֵא': 'קרא', 'הַשֵּׁמוֹת': 'H8034', 'וְהַמְּעִידִים': 'עוד',
    'תִּקְרָאֵהוּ': 'קרא', 'וּמִלְּאָה': 'מלא', 'וּבְעֵדוּתִי': 'עדות',
    'וּמְנָעוּם': 'מנע', 'הַמְּלָאכוֹת': 'מלאכה', 'וְלוֹחֵץ': 'לחץ',
    'וְאוֹסֵר': 'אסר', 'וְהָאֲסִירָה': 'אסר', 'הֵפֵרָה': 'פרר',
    'בְרֵכוֹת': 'ברך', 'בְּחֻקּוֹתֵיהֶן': 'חקק', 'וּבֶהָלָה': 'בהל',
    'כַּדּוּרִים': 'כדור', 'כַּדּוּרִים': 'כדור', 'בְּהַכְנִיעוֹ': 'כנע',
    'בְּרָאֹתִי': 'ראה', 'בְּעֵדֻיּוֹת': 'עדות', 'וְהִכּוֹנוּ': 'כון',
    'יְזֻן': 'זון', 'תָּרִים': 'רום', 'בִּבְרֹק': 'ברק',
    'וּבְהֻתְּרוֹ': 'נתר', 'וְיִרְאוּהוּ': 'ראה', 'רְאוֹתָם': 'ראה',
    'הָאוֹסֵר': 'אסר', 'וְהָאוֹסֵר': 'אסר', 'וַאֲצַוֵּם': 'צוה',
    'וּמִרְדָּם': 'מרד', 'וְיִטָּעֵם': 'נטע', 'לְעֵדוֹת': 'עדה',
    'אֲצַוֵּם': 'צוה', 'כִּכָּרוֹ': 'H3603', 'הַמְמֻנָּה': 'מנה',
    'בְּחֻקּוֹתֶיהָ': 'חקק', 'הַנּוֹכְחִים': 'נכח', 'כְּרֵעַי': 'H7453',
    'וּבֵיתָם': 'בית', 'לִכְסוּת': 'כסה', 'לִישֹׁן': 'ישן',
    'תַּקְּנוּ': 'תקן', 'הִנְהִיגָה': 'נהג', 'שְׁלֵמוּתוֹ': 'שלם',
    'הָאוֹסְרִים': 'אסר', 'לְהַנְהִיגָהּ': 'נהג', 'וְכִלּוּא': 'כלא',
    'וְצוּרֵנוּ': 'צור', 'הַנְּשָׁמוֹת': 'נשם', 'וּנְעָרְכֵם': 'ערך',
    'הַכִּתָּתִי': 'כתת', 'בְּבִקּוּרוֹ': 'בקר', 'הַבִּקּוּר': 'בקר',
    'הִמְשַׁכְנוּ': 'משך', 'וָאֹסֶף': 'יסף', 'בּוֹרְאִי': 'ברא',
    'מֵעֵדוּתוֹ': 'עדות', 'הַמִּתְחַתֵּן': 'חתן', 'וְהַכּוֹכָבִיּוֹת': 'כבב',
    'מִצֵּאת': 'יצא', 'שׁוֹבִים': 'שבה', 'מֵרֵעֵינוּ': 'H7453',
    'וַיּוּסַר': 'סור', 'הַלְּקוּחוֹת': 'לקח', 'מַדְרִיךְ': 'דרך',
    ...
    /* Modern Hebrew that had been reaching its family THROUGH an Aramaic
       Strong's number: הִשְׁתַּמֵּשׁ "to use" travelled via Aramaic שְׁמַשׁ
       H8120 into שֶׁמֶשׁ, and הִצְבִּיעַ "to point" via Aramaic צְבַע H6647
       into צֶבַע. Splitting the Aramaic cut the path, so these are pinned
       to the Hebrew families directly. */
    ...
    'כַּאֲשֶׁר': 'כאשר', 'וְכַאֲשֶׁר': 'כאשר', 'כַאֲשֶׁר': 'כאשר',
    'לָכֵן': 'לכן', 'וְלָכֵן': 'לכן',
    'כְּפִי': 'כפי', 'וּכְפִי': 'כפי',
    'לְפִי': 'לפי', 'וּלְפִי': 'לפי',
    'מֵהֶם': 'הם',
    'אֲבָל': 'אֲבָל',
    'בָּהֶן': 'בָּהֶן', 'בָּהֵן': 'בָּהֶן', 'בָהֶן': 'בָּהֶן', 'בָהֵן': 'בָּהֶן',
    'נַבָּא': 'ברנבא', 'חׇנֵּנִי': 'חנן', 'הַמִּילָה': 'מילה', 'מִילָה': 'מילה',
    'הֵנָּה': 'הֵנָּה', 'אַלְקוּם': 'אַל', 'וְהֵנָּה': 'הֵנָּה', 'וָהֵנָּה': 'הֵנָּה',
    'מַבְטִיחַ': 'בטח', 'שׁוֹאֵל': 'שאל', 'הַבִּיאָה': 'בוא', 'בַּבִּיאָה': 'בוא', 'לַבִּיאָה': 'בוא', 'בִּיאַת': 'בוא', 'לְבִיאַת': 'בוא',
    'מִתְחַתֵּן': 'חתן', 'לְאֵלֵי': 'H0410', 'לִזְכּוֹת': 'זכך', 'שֶׁלּוֹ': 'של', 'חֻרְבַּן': 'חרב',
    'הַמִּילֶנְיוּם': 'מילניום', 'מִילֶנְיוּם': 'מילניום', 'הַמִּלֶנְיוּם': 'מילניום',
    'כֵּיצַד': 'כיצד', 'בְּאֶמְצָעוּת': 'אמצע', 'מַסְבִּיר': 'סבר', 'שֶׁשָּׂמְחָה': 'שמח', 'בִּמְיֻחָד': 'יחד', 'שֶׁצֶּאֱצָאָיו': 'H6631',
    'הִבְטִיחַ': 'בטח', 'הַמַּבְטִיחַ': 'בטח', 'הִבְטִיחָנוּ': 'בטח', 'הִבְטִיחָהּ': 'בטח', 'מַבְטִיחִים': 'בטח', 'הָאָבְדָּן': 'אבד', 'נֶאֱבָקִים': 'אבק',
    'אֶדְוַארְד': 'אדוארד', 'תַּאַוְתָנִיִּים': 'אוה', 'אוֹנְדִּי': 'אונדי', 'שֶׁהוּאֲרוּ': 'אור', 'לְהִתְאַחֵד': 'אחד', 'שֶׁבְּאַחְרָיוּתָם': 'אחראי',
    'לָאִינְטֶרֶסִים': 'אינטרס', 'מְאֻכְלֶסֶת': 'אכלס', 'אֱלֹהוּתוֹ': 'אלוהות', 'אֱלֹהִיּוּתָהּ': 'אלוהות', 'אַלְמְנַת': 'אלמן', 'לְאַלְמְנַת': 'אלמן',
    'שֶׁאֻמְּצוּ': 'אמץ', 'בְּאַנְטִיּוֹכְיָה': 'אנטיוכיה', 'שֶׁאֲפִלּוּ': 'אפילו', 'אַפְרִיקָאִי': 'אפריקאי', 'אֶפְשָׁרוּת': 'אפשר',
    'הַמִּתְאַפְשֶׁרֶת': 'אפשר', 'מְאַפְשְׁרִים': 'אפשר', 'לְאַרְגֵּן': 'ארגן', 'מְאֻרְגָּנִים': 'ארגן', 'אַרְמָגֶדּוֹן': 'ארמגדון',
    'מְאֻשָּׁשׁוֹת': 'אשש', 'מְאַתְגֵּר': 'אתגר', 'הָאֶתְיוֹפִּים': 'אתיופי', 'אֶתְיוֹפִּי': 'אתיופי', 'הָאֶתְיוֹפִּי': 'אתיופי', 'מְבֹאָר': 'באר',
    'שֶׁבָּבֶל': 'בבל', 'בּוֹגְדָנִית': 'בגד', 'כְּשֶׁהַבִּיאָה': 'בוא', 'מְבִיסִים': 'בוס', 'מֵבִיס': 'בוס', 'וּמֵבִיס': 'בוס', 'יָבִיס': 'בוס',
    'לְהָבִיס': 'בוס', 'תִּתְבַּיֵּשׁ': 'בוש', 'לְבַזְבֵּז': 'בזבז', 'מְבַזִּים': 'בזה', 'נִבְחָנִים': 'בחן', 'שֶׁנִּבְחֲנָה': 'בחן', 'לְהַבְחָנָה': 'בחן',
    'בּוֹחֵר': 'בחר', 'שֶׁיִּבְחֲרוּ': 'בחר', 'הַבִּישׁוֹפוּת': 'בישוף', 'בִּישׁוֹף': 'בישוף', 'הַבִּישׁוֹף': 'בישוף', 'הַבִּישׁוֹפִים': 'בישוף',
    'מְבַלְבֵּל': 'בלל', 'לְבַלְבֵּל': 'בלל', 'וּמְבַלְבֵּל': 'בלל', 'יִתְבַּלְבְּלוּ': 'בלל', 'כִּבְנוֹ': 'בן', 'הַבְּנִיָּה': 'בנה',
    'מִתְבַּסֶּסֶת': 'בסס', 'יִתְבַּסְּסוּ': 'בסס', 'הִתְבַּסְּסָה': 'בסס', 'וַאֲבַעְבּוּעוֹת': 'בעבע', 'בֹּצִי': 'בץ', 'לְבִצּוּעַ': 'בצע',
    'בִּצּוּעַ': 'בצע', 'בּוֹרֵחַ': 'ברח', 'מַבְשִׁיל': 'בשל', 'גּוֹבֶה': 'גבה', 'גּוֹבֵר': 'גבר', 'שֶׁמִּתְגַּבֵּר': 'גבר',
    'שֶׁיִּתְגַּבְּרוּ': 'גבר', 'שֶׁמִּתְגַּבְּרִים': 'גבר', 'שֶׁתְּגַדֵּל': 'גדל', 'וְגָדְלָם': 'גדל', 'גּוֹנְסוֹן': 'גונסון', 'שֶׁנִּגְזַר': 'גזר',
    'הַגֵּיהִנּוֹם': 'גיהנום', 'גיימְס': 'גיימס', 'שֶׁבְּהִתְגַּלּוּת': 'גלה', 'שֶׁבְּהִתְגַּלֻּיּוֹתָיו': 'גלה', 'גַּלְגַּלִּים': 'גלל',
    'הַגַּלְגַּלִּים': 'גלל', 'בַּהֲגָנָה': 'גנן', 'וַהֲגָנָה': 'גנן', 'לַהֲגָנָה': 'גנן', 'כַּהֲגָנָה': 'גנן', 'לַהֲגַנַּת': 'גנן', 'גֶקְסוֹן': 'גקסון',
    'גּוֹרֶמֶת': 'גרם', 'גֵּרוּשִׁין': 'גרש', 'וְגֵרוּשִׁין': 'גרש', 'בְּגֵרוּשׁ': 'גרש', 'גֹּרָשִׁים': 'גרש', 'שֶׁדּוֹגְלִים': 'דגל',
    'הַדֻּגְמָאוֹת': 'דוגמה', 'דֻּגְמָה': 'דוגמה', 'נִדְחֶה': 'דחה', 'שֶׁדָּחֲתָה': 'דחה', 'דִּיאָנָה': 'דיאנה', 'דֵּיוִיד': 'דיויד', 'דֵּיוִיס': 'דיויס',
    'שֶׁמְּדַכְּאִים': 'דכא', 'הַנִּדְכָּא': 'דכא', 'מַדְפִּיס': 'דפס', 'דְּפוּס': 'דפס', 'בְּהַדְרָגָה': 'דרג', 'דְּרָגוֹת': 'דרג', 'מַדְרִיכָה': 'דרך',
    'שֶׁיַּדְרִיכוּ': 'דרך', 'הַדְרָכָה': 'דרך', 'הָארִיס': 'האריס', 'לַהֶגְמוֹנִים': 'הגמון', 'הַהֶגְמוֹנִים': 'הגמון', 'הַיְירָם': 'היירם',
    'וְהַיְירָם': 'היירם', 'הִיל': 'היל', 'הַהִיסְטוֹרְיָה': 'היסטוריה', 'הִיסְטוֹרִי': 'היסטוריה', 'וְתֵהָנֶה': 'הנאה', 'שֶׁהוֹרָיו': 'הרה',
    'וְהַהַשְׁרָאָה': 'השראה', 'וַדָּאוּת': 'ודאי', 'בְּוַדַּאי': 'ודאי', 'וִילְיָאם': 'ויליאם', 'וִילְיַאמְס': 'ויליאמס', 'זֶהוּ': 'זה', 'הַזּוֹ': 'זה',
    'מְזַהִים': 'זהה', 'וְזִהֲמוּ': 'זהם', 'מְזֹהָם': 'זהם', 'מוּזְהָרִים': 'זהר', 'שֶׁהֻזְהַר': 'זהר', 'יַזְהִיר': 'זהר', 'וְזֵיבָה': 'זיבה',
    'זוֹכֶה': 'זכך', 'זוֹכִים': 'זכך', 'וְזוֹכֶה': 'זכך', 'שֶׁזּוֹכֶה': 'זכך', 'שֶׁיִּזְכּוּ': 'זכך', 'זַכָּאִית': 'זכך', 'זוֹמְמִים': 'זמם',
    ...
    'הַחֲשׁוּדוֹת': 'חשד', 'חוֹשֵׂף': 'חשף', 'חוֹשֶׂפֶת': 'חשף', 'הַחֲשׂוּפוֹת': 'חשף', 'וּמַטְבִּיל': 'טבל', 'טַבָּק': 'טבק', 'טְבֶרְיָה': 'טבריה',
    'טִהוּר': 'טהר', 'טֶלֶסְטִיאָלִי': 'טלסטיאלי', 'הַטֶּלֶסְטִיאָלִי': 'טלסטיאלי', 'טִפּוּס': 'טפוס', 'טְקָסִים': 'טקס', 'טִקְסֵי': 'טקס', 'טֶקֶס': 'טקס',
    'לַטְּקָסִים': 'טקס', 'בִּטְקָסִים': 'טקס', 'וְהַטְּקָסִים': 'טקס', 'טֶרֶסְטְרִיאָלִי': 'טרסטריאלי', 'הַטֶּרֶסְטְרִיאָלִית': 'טרסטריאלי',
    'הַטֶּרֶסְטְרִיאָלִי': 'טרסטריאלי', 'נִטְרָפִים': 'טרף', 'יַאנְג': 'יאנג', 'מוֹבִיל': 'יבל', 'מוֹבִילִים': 'יבל', 'הַמּוֹבִילִים': 'יבל',
    'שֶׁמּוֹבִיל': 'יבל', 'שֶׁמּוֹבִילִים': 'יבל', 'וְהוֹבִיל': 'יבל', 'וְוִדּוּי': 'ידה', 'הַמּוֹדִיעָה': 'ידע', 'שֶׁיְּהוּדָה': 'יהודה',
    'שֶׁיְּהוֹשֻׁעַ': 'יהושע', 'שֶׁיּוֹאָשׁ': 'יואש', 'בְּיוּלִי': 'יולי', 'הַיּוּחֲסִין': 'יחש', 'יוּחֲסִין': 'יחש', 'יְיַחֵס': 'יחש', 'מִתְיַחֵס': 'יחש',
    'לְהִתְיַחֵס': 'יחש', 'שֶׁנּוֹלְדוּ': 'ילד', 'כִּילָדָיו': 'ילד', 'מוֹסִיף': 'יסף', 'יִסּוּרָיו': 'יסר', 'יִסּוּרִים': 'יסר', 'הַיִּעוּד': 'יעד',
    'מֻצָּגִים': 'יצג', 'מֻצָּג': 'יצג', 'מֻצָּגוֹת': 'יצג', 'שֶׁהֻצְּגוּ': 'יצג', 'יְצוּרִים': 'יצר', 'יֶשְׁנָם': 'יש', 'מִתְיַשְּׁבִים': 'ישב',
    'יָשְׁרָם': 'ישר', 'שֶׁנּוֹתַר': 'יתר', 'שֶׁנּוֹתְרָה': 'יתר', 'נִכְבָּשִׁים': 'כבש', 'בְּהַכְוָנַת': 'כון', 'נְכוֹנֶנֶת': 'כון', 'כְּלוּאִים': 'כלא',
    'כְּלָלִיִּים': 'כלל', 'וּכְלָלִיִּים': 'כלל', 'כָּלְשֶׁהִי': 'כלשהו', 'לְהַכְנָסַת': 'כנס', 'וּמַכְעִיס': 'כעס', 'וְכָפוּף': 'כפף',
    'וּמַכְרִיז': 'כרז', 'מַכְרִיזוֹת': 'כרז', 'שֶׁנִּכְרְתָה': 'כרת', 'שֶׁבְּכִתְבֵי': 'כתב', 'מְלַוּוֹת': 'לוה', 'וּלְלַוּוֹת': 'לוה',
    'מִתְלוֹנֶנֶת': 'לון', 'מִתְלוֹנֵן': 'לון', 'לוּצִיפֶר': 'לוציפר', 'מְלַחֲכִים': 'לחך', 'לוֹמֵד': 'למד', 'הַנִּלְמֶדֶת': 'למד', 'שֶׁלָּעֲגוּ': 'לעג',
    'שֶׁנִּלְקְחוּ': 'לקח', 'שֶׁנִּלְקְחָה': 'לקח', 'הַלְּקָטִים': 'לקט', 'שֶׁלְּשׁוֹנוֹת': 'לשן', 'שֶׁמָּאֲסוּ': 'מאס', 'מַגְדָּלֶנָה': 'מגדלנה',
    'מִתְמוֹדֵד': 'מדד', 'לְהִתְמוֹדֵד': 'מדד', 'יַמְתִּין': 'מהה', 'שֶׁנִּמּוֹלוּ': 'מול', 'הַמּוֹנִיטִין': 'מוניטין', 'נִמְחָלִים': 'מחל',
    'מִיסְיוֹנֶרִי': 'מיסיונרי', 'מֻמְלָךְ': 'מלך', 'שֶׁבְּמִסְגַּרְתָּהּ': 'מסגרת', 'נִמְסָרִים': 'מסר', 'שֶׁמּוֹסֶרֶת': 'מסר', 'שֶׁנִּמְצֵאת': 'מצא',
    'שֶׁמִּצְרַיִם': 'מצרים', 'מַרְדָן': 'מרד', 'מַמְשִׁיכִים': 'משך', 'וּמַמְשִׁיכָיו': 'משך', 'נְאוֹתִים': 'נאה', 'מְנַבְּאִים': 'נבא',
    ...
    'לְסַיֵּעַ': 'סיע', 'שֶׁיְּסַיְּעוּ': 'סיע', 'הַמְסַיְּעִים': 'סיע', 'סַךְ': 'סך', 'מְסַכֵּם': 'סכם', 'מְסֻכָּמִים': 'סכם',
    'סֶלֶסְטִיאָלִי': 'סלסטיאלי', 'הַסֶּלֶסְטִיאָלִי': 'סלסטיאלי', 'הַסֶּלֶסְטִיאָלִית': 'סלסטיאלי', 'הַסֶּלֶסְטִיאָלִיִּים': 'סלסטיאלי',
    'סֶלֶסְטִיאָלִית': 'סלסטיאלי', 'וְהַסֶּלֶסְטִיאָלִי': 'סלסטיאלי', 'מִסְתַּלֵּק': 'סלק', 'תִּסְתַּלֵּק': 'סלק', 'מִסְתָּעֲרִים': 'סער',
    'סְפִינָתוֹ': 'ספן', 'סְפְּרִינְג': 'ספרינג', 'נִסְקָרִים': 'סקר', 'סוֹקֵר': 'סקר', 'הַסַּקְרָמֶנְט': 'סקרמנט', 'בַּסַּקְרָמֶנְט': 'סקרמנט',
    'עֲבוּרָהּ': 'עבר', 'שֶׁהֶעֱדִיף': 'עדף', 'לְהַעֲווֹת': 'עות', 'עֶזְרָתוֹ': 'עזר', 'מְעַכֵּב': 'עכב', 'מְעַכְּבִים': 'עכב', 'מַעֲלִיבִים': 'עלב',
    'מִתְעַלְּלִים': 'עלל', 'בְּמַעֲמָדָהּ': 'עמד', 'נַעֲנֵית': 'ענה', 'עִנְיָנָם': 'עני', 'וּמַעֲנִיק': 'ענק', 'יַעֲנִיקוּ': 'ענק', 'נֶעֱנָשִׁים': 'ענש',
    'מַעֲסִיק': 'עסק', 'לְהַעֲסִיק': 'עסק', 'עוֹסֵק': 'עסק', 'וְעָצְמָתוֹ': 'עצם', 'הָעַצְמִית': 'עצם', 'עַצְמָאִית': 'עצם', 'עוֹצֵר': 'עצר',
    'מֵעֲקִיצַת': 'עקץ', 'בְּעִקָּרָם': 'עקר', 'עַקְשָׁנִים': 'עקש', 'נֶעֱרָף': 'ערף', 'פַּאטֶן': 'פאטן', 'הַפּוֹגְעִים': 'פגע', 'שֶׁפּוֹגְעִים': 'פגע',
    'הַפָּגוּעַ': 'פגע', 'נִפְגָּשִׁים': 'פגש', 'תִּתְפּוֹגֵג': 'פוג', 'פַּטְרִיאַרְך': 'פטריארך', 'הַפַּטְרִיאַרְכָלִי': 'פטריארך', 'פֵּייג': 'פייג',
    'פִּיּוּס': 'פיס', 'הַפִּיּוּס': 'פיס', 'וּמִתְפַּיְּסִים': 'פיס', 'מִתְפַּיְּסִים': 'פיס', 'יִתְפַּיְּסוּ': 'פיס', 'לְפַיֵּס': 'פיס',
    'מְפַיֶּסֶת': 'פיס', 'פִּצּוּי': 'פיצוי', 'פִּצּוּיִים': 'פיצוי', 'הַמֻּפְלָג': 'פלג', 'לְפִלּוּג': 'פלג', 'וְהַפָּמוֹט': 'פמוט', 'הַפָּמוֹט': 'פמוט',
    'נִפְסָק': 'פסק', 'נִפְסֶקֶת': 'פסק', 'וּמַפְסִיק': 'פסק', 'פּוֹקֵחַ': 'פקח', 'שֶׁיְּפַקְפְּקוּ': 'פקפק', 'פְּרַאט': 'פראט', 'תַּפְרִיד': 'פרד',
    'וּפוֹרֵחַ': 'פרח', 'פֵּרוּט': 'פרט', 'לְפַרְנָסָתָם': 'פרנס', 'בְּפֻרְעָנוּת': 'פרע', 'הַפֻּרְעָנוּת': 'פרע', 'בַּהֲפָרַת': 'פרר',
    'מִתְפַּשְּׁטִים': 'פשט', 'מַצְבִּיעַ': 'צבע', 'וּמְצֻוִּים': 'צוה', 'מְצַיֶּנֶת': 'ציין', 'מִצְטַיֵּן': 'ציין',
    'מְצַיֶּתֶת': 'צית', 'מְצַיֵּת': 'צית', 'וּלְצַיֵּת': 'צית', 'לְצַיֵּת': 'צית', 'צַיְּתָנוּת': 'צית', 'הַצַּיְּתָנוּת': 'צית', 'הַצַּיְּתָנִים': 'צית',
    'צַיְּתָנִים': 'צית', 'וְהַצַּיְּתָנִים': 'צית', 'צַלְבָּם': 'צלב', 'צוֹלְבִים': 'צלב', 'מִצְטַמְצֵם': 'צמצם', 'יִצְטַעֲרוּ': 'צער',
    'מִצְטַעֵר': 'צער', 'מִצְטָרַעַת': 'צרע', 'מִצְטָרֵף': 'צרף', 'יִצְטָרְפוּ': 'צרף', 'מִצְטָרְפִים': 'צרף', 'מִתְקַבְּלִים': 'קבל',
    'שֶׁקִּבַּלְנוּ': 'קבל', 'שֶׁנִּקְבַּע': 'קבע', 'מִתְקַדְּמִים': 'קדם', 'שֶׁיִּקְדְּמוּ': 'קדם', 'שֶׁיִּקְדַּם': 'קדם', 'הַמֻּקְדָּמִים': 'קדם',
    'הַקּוֹלוֹסִים': 'קולוסים', 'שֶׁקָּם': 'קום', 'תְּקַיֵּם': 'קום', 'שֶׁמְּקַיֵּם': 'קום', 'מִתְקַיְּמִים': 'קום', 'הַמְקַיְּמִים': 'קום',
    'קוֹרְנֵלִיּוֹס': 'קורנליוס', 'מְקֻטְלָגִים': 'קטלג', 'מְקַטְלֵג': 'קטלג', 'בִּקְטַנָּיו': 'קטן', 'קָצוּב': 'קצב', 'שֶׁנִּקְרְאוּ': 'קרא',
    'לְהַקְרָבַת': 'קרב', 'קַרְתְאַג': 'קרתאג', 'מַרְאִים': 'ראה', 'רִבִּית': 'רבה', 'רְגִילִים': 'רגל', 'שֶׁמַּרְגִּישׁ': 'רגש', 'מֵרִוְחֵיהֶם': 'רווח',
    'רוֹמָא': 'רומא', 'בְּרוֹמָא': 'רומא', 'נִרְחָצִים': 'רחץ', 'לְהַרְחִיק': 'רחק', 'מִתְרוֹקְנִים': 'ריק', 'הִתְרַכְּזָה': 'רכז', 'רוֹכֵשׁ': 'רכש',
    'הַנִּרְכָּשׁ': 'רכש', 'וְהָרַמָּאִים': 'רמה', 'הַמִּתְרוֹעֲעִים': 'רעע', 'מִתְרַצֶּה': 'רצה', 'רַשַּׁאי': 'רשות', 'רַשָּׁאִים': 'רשות',
    'הָרַשָּׁאִים': 'רשות', 'רְשִׁימוֹת': 'רשם', 'רוֹשְׁמִים': 'רשם', 'וְנִרְשָׁמִים': 'רשם', 'שֶׁתֵּרָשֵׁם': 'רשם', 'לִשְׁבָחִים': 'שבח',
    'בִּשְׁבָחִים': 'שבח', 'בְּהַשְׁבָּעָה': 'שבע', 'הַשְׁגָּחָתוֹ': 'שגח', 'שֶׁשִּׂגְשֵׂג': 'שגשג', 'מְשַׂגְשְׂגִים': 'שגשג', 'וּמְשַׂגְשֵׂג': 'שגשג',
    'תְּשַׂגְשֵׂג': 'שגשג', 'וּבְשִׂגְשׂוּג': 'שגשג', 'בְּשִׂגְשׂוּגוֹ': 'שגשג', 'וְהַשִּׂגְשׂוּג': 'שגשג', 'שִׂגְשׂוּג': 'שגשג',
    'הַהִשְׁתַּדְּלוּת': 'שדל', 'בְּהִשְׁתַּדְּלוּת': 'שדל', 'שׁוֹטֶה': 'שוטה', 'הַשּׁוֹטֶה': 'שוטה', 'מְשֻׁחְזָרוֹת': 'שחזר',
    'וִישַׁחְרֵר': 'שחרר', 'יְשַׁחְרֵר': 'שחרר', 'מִשְׁתַּחְרֵר': 'שחרר', 'לְשַׁחְרֵר': 'שחרר', 'לְשַׁחְרְרוֹ': 'שחרר', 'שַׁיָּכִים': 'שיך',
    'וְשִׁיּוּכֵיהֶם': 'שיך', 'לְהִסְתַּכֵּל': 'שכל', 'יְשֻׁכְלְלוּ': 'שכלל', 'לְשַׁכְלֵל': 'שכלל', 'מִשְׁתַּכְנֵעַ': 'שכנע', 'שׂוֹכֵר': 'שכר',
    'שֶׁנִּשְׁלְחוּ': 'שלח', 'שְׁלִיחוּתָהּ': 'שלח', 'לִשְׁלִיחוּתוֹ': 'שלח', 'שׁוֹלֵט': 'שלט', 'שֶׁיִּשְׁלֹט': 'שלט', 'נִשְׁלָטִים': 'שלט',
    'הַנִּשְׁלָטוֹת': 'שלט', 'לְהִשְׁתַּלֵּט': 'שלט', 'נִשְׁלָטוֹת': 'שלט', 'נִשְׁלָלִים': 'שלל', 'מֻשְׁמָדִים': 'שמד', 'מַשְׁמִידָה': 'שמד',
    'הַמַּשְׁמִידִים': 'שמד', 'וּמֻשְׁמָדִים': 'שמד', 'וּמַשְׁמִידִים': 'שמד', 'מוּשְׁמֶדֶת': 'שמד', 'שֶׁיַּשְׁמִיד': 'שמד', 'וּלְהַשְׁמָדַת': 'שמד',
    'שְׁמָדוֹת': 'שמד', 'מַשְׁמִיד': 'שמד', 'וְהַמַּשְׁמָעֻיּוֹת': 'שמע', 'מֻשְׁמָצִים': 'שמץ', 'שְׁמִירַת': 'שמר', 'שֶׁנִּשְׁמֶרֶת': 'שמר',
    'שֹׁמְרֶיהָ': 'שמר', 'שׁוֹמְרֶיהָ': 'שמר', 'שׁוֹמְרוֹנִים': 'שמרון', 'מִשְׁתַּמֵּשׁ': 'שמש', 'וּמִשְׁתַּמֵּשׁ': 'שמש', 'יְשַׁמֵּשׁ': 'שמש',
    'תְּשַׁמֵּשׁ': 'שמש', 'שֶׁתְּשַׁמֵּשׁ': 'שמש', 'כִּשְׁנַת': 'שנה', 'בְּשִׁעְבּוּד': 'שעבד', 'שִׁעְבּוּד': 'שעבד', 'יְשַׁעְבְּדוּ': 'שעבד',
    'מְשַׁעְבֶּדֶת': 'שעבד', 'הַמִּשְׁפַּחְתִּיִּים': 'שפח', 'כְּשׁוֹפְטִים': 'שפט', 'שֶׁנִּשְׁפְּכוּ': 'שפך', 'שֶׁיִּשָּׁפְכוּ': 'שפך',
    'מַשְׁקָאוֹת': 'שקה', 'וּמַשְׁקָאוֹת': 'שקה', 'שֶׁלְּשָׂרָה': 'שרה', 'שֶׁרְמַן': 'שרמן', 'שׂוֹרְפִים': 'שרף', 'וְשׂוֹרְפִים': 'שרף',
    'הַמְשָׁרֶתֶת': 'שרת', 'יִשְׁתַּתְּפוּ': 'שתף', 'מִשְׁתַּתְּפִים': 'שתף', 'הִשְׁתַּתְּפָה': 'שתף', 'מְשֻׁתָּפִים': 'שתף', 'מְשֻׁתֶּפֶת': 'שתף',
    'הַמְּשֻׁתֶּפֶת': 'שתף', 'לְהַשְׁתִּיק': 'שתק', 'בְּהַתְאָמָה': 'תאם', 'לְתֵאוּר': 'תאר', 'לְתַבְרוּאָה': 'תברואה', 'וּמְתַכְנְנִים': 'תכנן',
    'מְתַכְנְנִים': 'תכנן', 'תַּכְשִׁיטִים': 'תכשיט', 'נִתְמָכִים': 'תמך', 'תְּנָאֶיהָ': 'תנאי', 'הַתַּנַ״ךְ': 'תנך', 'כְּתַנַ״ךְ': 'תנך',  'הַתַּנַ״ךְ': 'תנך', 'כְּתַנַ״ךְ': 'תנך', 
  ...
  // name coined from a verb (Nadab, Og, Machir) is not that verb.
    var FAMILY_SPLIT = { 'H4325': 'מים', 'H0127': 'אדמה', 'H4057': 'מדבר',
                   ...
                   'H1682': 'דבורה',  // דְּבוֹרָה the bee — BDB files it under דבר speak (Isa 7:18, Deut 1:44)
                    ...
                    'H3898': 'H3898',
                    /* עוֹר "skin" (H5785) and עָרוֹם "naked" (H6174/H6172) are not עוּר "awake,
                       arouse": the card on "arouse your faculties" (Alma 32:27) showed a
                    ...
                    'H7943': 'שׁכר',
                    'H8589': 'H6031',
                    /* ARAMAIC KEEPS ITS OWN FAMILIES (2026-09-13, at the user's
                       direction). The Tanakh contains 2,792 Aramaic tokens — Daniel 2-7,
                       Ezra 4-7, Jeremiah 10:11 — and OSHB numbers their lexemes apart from
                       the Hebrew (H4430 king ARAMAIC beside H4428 king HEBREW). They were
                       merging only because _strongsRoots[H4430].r points at the Hebrew
                       cognate and familyOf follows it, so מַלְכָּא counted itself among
                       1,784 Hebrew מֶלֶךְ and אֱלָהּ read as the divine name Elohim.
                       The 13 Aramaic PROPER NOUNS are deliberately NOT here: Nebuchadnezzar
                       is the same man in both languages and does not want two cards. */
                    'H1768': 'H1768', 'H4430': 'H4430', 'H0426': 'H0426', 'H0116': 'H0116', 'H1934': 'H1934', 'H1836': 'H1836',
                    'H3809': 'H3809', 'H4437': 'H4437', 'H0560': 'H0560', 'H1841': 'H1841', 'H6032': 'H6032', 'H3046': 'H3046',
                    'H8065': 'H8065', 'H2370': 'H2370', 'H6966': 'H6966', 'H6591': 'H6591', 'H5922': 'H5922', 'H5648': 'H5648',
                    'H2942': 'H2942', 'H3052': 'H3052', 'H3390': 'H3390', 'H1400': 'H1400', 'H1124': 'H1124', 'H4406': 'H4406',
                    'H5957': 'H5957', 'H2493': 'H2493', 'H8133': 'H8133', 'H6755': 'H6755', 'H1722': 'H1722', 'H4481': 'H4481',
                    'H6523': 'H6523', 'H7690': 'H7690', 'H0576': 'H0576', 'H7217': 'H7217', 'H0479': 'H0479', 'H0383': 'H0383',
                    'H6925': 'H6925', 'H2423': 'H2423', 'H1791': 'H1791', 'H1005': 'H1005', 'H2445': 'H2445', 'H3705': 'H3705',
                    'H1994': 'H1994', 'H0858': 'H0858', 'H5135': 'H5135', 'H0606': 'H0606', 'H2376': 'H2376', 'H3702': 'H3702',
                    'H8532': 'H8532', 'H7912': 'H7912', 'H2324': 'H2324', 'H3861': 'H3861', 'H1882': 'H1882', 'H5312': 'H5312',
                    'H5457': 'H5457', 'H4083': 'H4083', 'H7123': 'H7123', 'H7162': 'H7162', 'H7412': 'H7412', 'H6922': 'H6922',
                    'H3792': 'H3792', 'H7328': 'H7328', 'H2298': 'H2298', 'H5308': 'H5308', 'H0524': 'H0524', 'H7127': 'H7127',
                    'H7149': 'H7149', 'H5732': 'H5732', 'H1541': 'H1541', 'H0002': 'H0002', 'H3493': 'H3493', 'H2635': 'H2635',
                    'H3028': 'H3028', 'H1855': 'H1855', 'H3345': 'H3345', 'H3062': 'H3062', 'H0772': 'H0772', 'H3969': 'H3969',
                    'H5613': 'H5613', 'H8036': 'H8036', 'H2166': 'H2166', 'H5709': 'H5709', 'H0927': 'H0927', 'H3118': 'H3118',
                    'H7260': 'H7260', 'H3961': 'H3961', 'H6399': 'H6399', 'H6600': 'H6600', 'H8450': 'H8450', 'H3984': 'H3984',
                    'H3675': 'H3675', 'H5675': 'H5675', 'H5103': 'H5103', 'H3549': 'H3549', 'H2418': 'H2418', 'H7761': 'H7761',
                    'H7990': 'H7990', 'H7593': 'H7593', 'H0826': 'H0826', 'H6992': 'H6992', 'H8271': 'H8271', 'H1505': 'H1505',
                    'H5174': 'H5174', 'H3790': 'H3790', 'H7972': 'H7972', 'H3635': 'H3635', 'H0007': 'H0007', 'H8421': 'H8421',
                    'H0236': 'H0236', 'H5954': 'H5954', 'H3202': 'H3202', 'H1297': 'H1297', 'H5559': 'H5559', 'H3825': 'H3825',
                    'H0431': 'H0431', 'H1763': 'H1763', 'H0870': 'H0870', 'H3330': 'H3330', 'H0324': 'H0324', 'H6347': 'H6347',
                    'H5972': 'H5972', 'H7032': 'H7032', 'H8086': 'H8086', 'H1459': 'H1459', 'H7261': 'H7261', 'H2562': 'H2562',
                    'H8355': 'H8355', 'H1965': 'H1965', 'H6634': 'H6634', 'H0718': 'H0718', 'H3488': 'H3488', 'H3660': 'H3660',
                    'H0989': 'H0989', 'H2006': 'H2006', 'H5649': 'H5649', 'H1156': 'H1156', 'H7476': 'H7476', 'H8624': 'H8624',
                    'H6151': 'H6151', 'H2255': 'H2255', 'H7662': 'H7662', 'H5673': 'H5673', 'H0521': 'H0521', 'H8361': 'H8361',
                    'H5460': 'H5460', 'H2597': 'H2597', 'H4953': 'H4953', 'H5443': 'H5443', 'H6460': 'H6460', 'H2178': 'H2178',
                    'H2170': 'H2170', 'H7804': 'H7804', 'H0861': 'H0861', 'H3729': 'H3729', 'H1655': 'H1655', 'H6744': 'H6744',
                    'H6647': 'H6647', 'H0636': 'H0636', 'H6236': 'H6236', 'H4449': 'H4449', 'H5609': 'H5609', 'H5946': 'H5946',
                    'H8124': 'H8124', 'H6573': 'H6573', 'H1240': 'H1240', 'H7960': 'H7960', 'H1946': 'H1946', 'H3879': 'H3879',
                    'H5122': 'H5122', 'H4978': 'H4978', 'H7844': 'H7844', 'H3779': 'H3779', 'H2269': 'H2269', 'H1289': 'H1289',
                    'H7624': 'H7624', 'H1547': 'H1547', 'H1797': 'H1797', 'H7271': 'H7271', 'H5376': 'H5376', 'H7308': 'H7308',
                    'H0069': 'H0069', 'H3367': 'H3367', 'H7981': 'H7981', 'H0677': 'H0677', 'H0581': 'H0581', 'H3673': 'H3673',
                    'H0399': 'H0399', 'H0586': 'H0586', 'H0228': 'H0228', 'H0703': 'H0703', 'H7680': 'H7680', 'H7695': 'H7695',
                    'H3904': 'H3904', 'H7001': 'H7001', 'H1668': 'H1668', 'H0711': 'H0711', 'H1247': 'H1247', 'H4484': 'H4484',
                    'H6537': 'H6537', 'H8000': 'H8000', 'H4076': 'H4076', 'H3916': 'H3916', 'H7229': 'H7229', 'H6433': 'H6433',
                    'H5870': 'H5870', 'H6268': 'H6268', 'H1780': 'H1780', 'H0104': 'H0104', 'H0783': 'H0783', 'H0671': 'H0671',
                    'H3706': 'H3706', 'H0787': 'H0787', 'H1983': 'H1983', 'H5415': 'H5415', 'H5142': 'H5142', 'H5407': 'H5407',
                    'H1093': 'H1093', 'H7868': 'H7868', 'H2987': 'H2987', 'H8536': 'H8536', 'H1798': 'H1798', 'H0563': 'H0563',
                    'H4416': 'H4416', 'H5069': 'H5069', 'H0230': 'H0230', 'H1917': 'H1917', 'H5023': 'H5023', 'H6902': 'H6902',
                    'H3358': 'H3358', 'H2685': 'H2685', 'H1370': 'H1370', 'H4486': 'H4486', 'H5642': 'H5642', 'H5974': 'H5974',
                    'H4483': 'H4483', 'H3546': 'H3546', 'H2749': 'H2749', 'H2122': 'H2122', 'H7299': 'H7299', 'H2869': 'H2869',
                    'H4223': 'H4223', 'H2906': 'H2906', 'H3606': 'H3606', 'H2917': 'H2917', 'H5208': 'H5208', 'H8651': 'H8651',
                    'H7314': 'H7314', 'H6613': 'H6613', 'H0148': 'H0148', 'H1411': 'H1411', 'H1884': 'H1884', 'H8614': 'H8614',
                    'H7984': 'H7984', 'H2429': 'H2429', 'H3831': 'H3831', 'H1907': 'H1907', 'H1981': 'H1981', 'H2257': 'H2257',
                    'H1821': 'H1821', 'H8177': 'H8177', 'H4398': 'H4398', 'H2417': 'H2417', 'H6211': 'H6211', 'H2957': 'H2957',
                    'H0506': 'H0506', 'H2939': 'H2939', 'H6447': 'H6447', 'H4433': 'H4433', 'H5094': 'H5094', 'H6590': 'H6590',
                    'H8531': 'H8531', 'H7238': 'H7238', 'H7313': 'H7313', 'H8214': 'H8214', 'H7560': 'H7560', 'H8625': 'H8625',
                    'H8140': 'H8140', 'H0459': 'H0459', 'H2941': 'H2941', 'H6933': 'H6933', 'H1611': 'H1611', 'H5191': 'H5191',
                    'H7606': 'H7606', 'H7512': 'H7512', 'H4291': 'H4291', 'H2631': 'H2631', 'H7244': 'H7244', 'H6655': 'H6655',
                    'H7605': 'H7605', 'H4779': 'H4779', 'H7792': 'H7792', 'H0849': 'H0849', 'H8001': 'H8001', 'H0846': 'H0846',
                    'H1560': 'H1560', 'H1596': 'H1596', 'H5182': 'H5182', 'H5073': 'H5073', 'H5313': 'H5313', 'H5232': 'H5232',
                    'H4061': 'H4061', 'H4887': 'H4887', 'H1123': 'H1123', 'H3272': 'H3272', 'H8579': 'H8579', 'H0608': 'H0608',
                    'H2084': 'H2084', 'H3538': 'H3538', 'H4070': 'H4070', 'H1149': 'H1149', 'H7108': 'H7108', 'H5843': 'H5843',
                    'H7359': 'H7359', 'H5994': 'H5994', 'H2816': 'H2816', 'H3029': 'H3029', 'H2306': 'H2306', 'H1872': 'H1872',
                    'H4577': 'H4577', 'H3410': 'H3410', 'H8243': 'H8243', 'H5784': 'H5784', 'H2632': 'H2632', 'H2827': 'H2827',
                    'H7490': 'H7490', 'H6386': 'H6386', 'H8406': 'H8406', 'H2234': 'H2234', 'H1693': 'H1693', 'H5487': 'H5487',
                    'H0540': 'H0540', 'H5260': 'H5260', 'H4756': 'H4756', 'H7236': 'H7236', 'H8353': 'H8353', 'H3744': 'H3744',
                    'H7170': 'H7170', 'H3487': 'H3487', 'H7266': 'H7266', 'H6656': 'H6656', 'H6263': 'H6263', 'H5481': 'H5481',
                    'H4391': 'H4391', 'H2528': 'H2528', 'H0600': 'H0600', 'H5622': 'H5622', 'H3737': 'H3737', 'H5267': 'H5267',
                    'H7631': 'H7631', 'H8429': 'H8429', 'H2761': 'H2761', 'H7365': 'H7365', 'H7739': 'H7739', 'H5338': 'H5338',
                    'H7187': 'H7187', 'H3900': 'H3900', 'H5043': 'H5043', 'H2783': 'H2783', 'H0755': 'H0755', 'H5368': 'H5368',
                    'H8523': 'H8523', 'H7672': 'H7672', 'H4961': 'H4961', 'H0280': 'H0280', 'H8631': 'H8631', 'H2103': 'H2103',
                    'H1922': 'H1922', 'H3977': 'H3977', 'H2627': 'H2627', 'H3745': 'H3745', 'H1519': 'H1519', 'H3221': 'H3221',
                    'H0744': 'H0744', 'H8578': 'H8578', 'H1678': 'H1678', 'H5967': 'H5967', 'H5245': 'H5245', 'H0574': 'H0574',
                    'H8128': 'H8128', 'H7920': 'H7920', 'H2192': 'H2192', 'H8517': 'H8517', 'H2358': 'H2358', 'H6015': 'H6015',
                    'H5343': 'H5343', 'H1535': 'H1535', 'H1815': 'H1815', 'H5047': 'H5047', 'H8120': 'H8120', 'H7240': 'H7240',
                    'H6606': 'H6606', 'H3346': 'H3346', 'H0785': 'H0785', 'H0754': 'H0754', 'H3735': 'H3735', 'H5085': 'H5085',
                    'H3321': 'H3321', 'H1759': 'H1759', 'H1080': 'H1080', 'H5452': 'H5452', 'H6387': 'H6387', 'H8046': 'H8046',
                    'H8460': 'H8460', 'H5491': 'H5491', 'H1784': 'H1784', 'H2967': 'H2967', 'H0670': 'H0670', 'H0896': 'H0896',
                    'H7801': 'H7801', 'H5962': 'H5962', 'H2338': 'H2338', 'H0674': 'H0674', 'H4415': 'H4415', 'H6173': 'H6173',
                    'H2508': 'H2508', 'H6568': 'H6568', 'H4776': 'H4776', 'H2095': 'H2095', 'H4101': 'H4101', 'H0924': 'H0924',
                    'H0153': 'H0153', 'H8648': 'H8648', 'H5013': 'H5013', 'H5583': 'H5583', 'H1147': 'H1147', 'H3797': 'H3797',
                    'H6928': 'H6928', 'H7265': 'H7265', 'H0307': 'H0307', 'H1001': 'H1001', 'H1685': 'H1685', 'H5446': 'H5446',
                    'H2323': 'H2323', 'H7352': 'H7352', 'H3964': 'H3964', 'H2818': 'H2818', 'H5928': 'H5928', 'H2591': 'H2591',
                    'H3983': 'H3983', 'H6739': 'H6739', 'H5256': 'H5256', 'H2211': 'H2211', 'H7932': 'H7932', 'H4049': 'H4049',
                    'H5017': 'H5017', 'H3319': 'H3319', 'H3393': 'H3393', 'H2305': 'H2305', 'H5796': 'H5796', 'H4510': 'H4510',
                    'H6392': 'H6392', 'H4255': 'H4255', 'H1585': 'H1585', 'H4907': 'H4907', 'H7066': 'H7066', 'H4504': 'H4504',
                    'H5261': 'H5261', 'H7470': 'H7470', 'H2819': 'H2819', 'H1490': 'H1490', 'H3604': 'H3604', 'H1325': 'H1325',
                    'H3791': 'H3791', 'H0149': 'H0149', 'H7109': 'H7109', 'H2171': 'H2171', 'H8652': 'H8652', 'H5412': 'H5412',
                    'H0607': 'H0607', 'H8200': 'H8200', 'H1782': 'H1782', 'H4193': 'H4193', 'H0778': 'H0778', 'H4479': 'H4479',
                    ...
                    'H6575': 'פרשׁ',  'H6569': 'פרשׁ', 'H5378': 'נשׁה',
                    ...
                    /* אֱלֹהִים is not אֵלֶּה and not אָלָה. BDB files H0430 under
                       ...
                       Strong's number — the lexicon on אֶת־הָאֱלֹהִים and אֱלֹהִים׃,
                       the compound stage on אֱלֹהִים־אֲחֵרִים and אֱלֹהֵי־יִשְׂרָאֵל,
                       and 49 harvested SURFACE_MAP entries — landed the name of God
                       in a family whose 1,714 other tokens are "these". The hand
                       pins on the bare forms (הָאֱלֹהִים -> 'אלהים') were the only
                       escape, and they cover the standalone word only. */
                    'H0430': 'אלהים',
                    /* and the Aramaic אֱלָהּ / אֱלָהָא of Daniel and Ezra — H0426 is
                       the same word and glosses "God", "the God of", "house of
                       God"; it was sitting in the same אלה card as "these". */
                    ...
                    'H1146': 'בנה',    // בִּנְיָן building → build
                        // מִנְיָן quorum, reckoning → count
                    ...
                    'H1768': 'דִּי', 'H3863': 'לוּ', 'H5787': 'עִוֵּר', 'H5786': 'עִוֵּר', 'H5788': 'עִוֵּר', 'H6311': 'פֹּה',
  ...
  // (הַנָּחָשׁ) still matches. (2026-09-12)
    var HOMOGRAPHS = {
      ...
      /* לָבָן white (H3836) and Laban (H3837, Nephi's and Jacob's) are one spelling;
         OSHB hands the bare form to the name, so "white above all" (Alma 32:42)
         showed Laban. בְּעֵין "with an eye of" is not En-dor (1 Sam 28:7). */
      'לָבָן':     { name: 'H3837', word: 'H3836', en: /Laban/ },
      'וְלָבָן':    { name: 'H3837', word: 'H3836', en: /Laban/ },
      'לְלָבָן':    { name: 'H3837', word: 'H3836', en: /Laban/ },
      'וּלְלָבָן':   { name: 'H3837', word: 'H3836', en: /Laban/ },
      'בְּלָבָן':    { name: 'H3837', word: 'H3836', en: /Laban/ },
      'בְּעֵין':    { name: 'H5874', word: 'H5869', en: /En-?dor/i },
      /* 1 Nephi 1: the lexicon hands these forms to a name that shares their letters. */
      'וְקוֹרֵא':   { name: 'H6981', word: 'H7121', en: /Kore/ },          // and reads · Kore
      'וְקוֹרְאִים': { name: 'H6981', word: 'H7121', en: /Kore/ },
      ...
      'אֵלִים': { name: 'איל', word: 'אלים־רבים', en: /ram|terebinth|oak|post/i },
      'אֶל־יָם': { name: 'איל', word: 'אלים־רבים', en: /ram|terebinth|oak|post/i },
      ...
      'וְנָעִים': { name: 'נוע', word: 'נעם', en: /move|moving/i },
      'וּמַה־נָּעִים': { name: 'נוע', word: 'נעם', en: /move|moving/i },
      'וּנְעִים': { name: 'נוע', word: 'נעם', en: /move|moving/i },
      'כִּי־נָעִים': { name: 'נוע', word: 'נעם', en: /move|moving/i },
      'לְכׇל־הַמּוֹנְעִים': { name: 'נוע', word: 'נעם', en: /move|moving/i },
      /* One literal, two senses — refused as a pin by apply_forms and given
         to the gloss instead: נָעִים is "they move" and "pleasant";
         וַיִּטְעַם is "let him plant" and "had tasted"; מִבְחָר is Mibhar
         the man and "choice"; יֻקַּם is "be established" and "be avenged". */
      'נָּעִים': { name: 'נוע', word: 'נעם', en: /move|moving/i },
      'נָעִים': { name: 'נוע', word: 'נעם', en: /move|moving/i },
      'וְיִטָּעֵם': { name: 'נטע', word: 'טעם', en: /plant/i },
      'וַיִּטְעַם': { name: 'נטע', word: 'טעם', en: /plant/i },
      'מִבְחַר': { name: 'H4006', word: 'בחר', en: /Mibhar/i },
      'מִבְחָר': { name: 'H4006', word: 'בחר', en: /Mibhar/i },
      'יִקֹּם': { name: 'קום', word: 'נקם', en: /establish/i },
      'יָקֵם': { name: 'קום', word: 'נקם', en: /establish/i },
      'יָקָם': { name: 'קום', word: 'נקם', en: /establish/i },
      'יָקֻם': { name: 'קום', word: 'נקם', en: /establish/i },
      'יֻקַּם': { name: 'קום', word: 'נקם', en: /establish/i },
      'יֻקָּם': { name: 'קום', word: 'נקם', en: /establish/i },
      ...
      /* דִּינָה is Dinah 7 times and "Avenge"/"the judgment" 6. A homograph
         ...
         province forms are named explicitly FIRST so they are matched before
         the peel ever reaches דִינָה. */
      'מְדִינָה': { name: 'מדינה', word: 'מדינה', en: /province/i },
      'דִּינָה': { name: 'H1783', word: 'דין', en: /Dinah/ },
      'דִינָה': { name: 'H1783', word: 'דין', en: /Dinah/ },
      ...
      /* שְׁנַת is the construct of BOTH שָׁנָה "year" (126 tokens) and
         ...
         on it read "the seventh year" as "to sleep"; only the gloss can
         tell them apart. */
      'שְׁנַת': { name: 'ישן', word: 'שנה', en: /sleep|slumber|slept/i },
      'מִשְּׁנַת': { name: 'ישן', word: 'שנה', en: /sleep|slumber|slept/i },
      'יְשֻׁנּוּ': { name: 'ישן', word: 'שנה', en: /sleep|slumber|slept/i },
      'יִשְׁנוּ': { name: 'ישן', word: 'שנה', en: /sleep|slumber|slept/i },
      'יֶשְׁנוֹ': { name: 'ישן', word: 'H3426', en: /sleep|slumber|slept/i },
      'יָשְׁנוּ': { name: 'ישן', word: 'שנה', en: /sleep|slumber|slept/i },
      'יָשֵׁנוּ': { name: 'ישן', word: 'שנה', en: /sleep|slumber|slept/i },
      'יָשַׁנּוּ': { name: 'ישן', word: 'שנה', en: /sleep|slumber|slept/i },
  ...
  function familyOf(sNum) {
    ...
    // A NAME IS ITS OWN FAMILY (the user's ruling, 2026-09-01, for the Book of
    // Mormon names; the same for the Bible's): BDB files Moses under משה "draw
    // out", Sarah under שרר "rule", Saul under שאל "ask", and the card then
    // counted the verb's uses as the person's. A proper-name lemma (Strong's
    // writes its transliteration with a capital) keeps its own number.
    if (_isNameEntry(sNum)) return sNum;
    if (typeof window !== 'undefined' && window._bdbRoots && window._bdbRoots[sNum] && window._bdbOk) {
      var _b = window._bdbOk(sNum);
      if (_b) return _b;
      // THE WEAK FIRST RADICAL (the user's rule, 2026-09-06: the root has to
      // survive I-Yod / I-Vav / I-Nun / I-He). BDB files יָלַךְ (H3212) under
      // הלך, and the transparency gate refused it because the lemma has no ה.
      // A BDB root that differs from the lemma's skeleton only in a weak first
      // letter is the same root showing its other first radical.
    ...
    if (!_baseOf) {
      ...
      if (SR) {
        ...
        var derives = function (src, base) {
          ...
          // THE DROPPED WEAK FIRST RADICAL (the user's rule, 2026-09-06): a
          // noun may lose the root's initial י / ו / נ / ה and add a feminine
          // or abstract ending -- דַּעַת from ידע, שֵׁנָה from ישן, לֶדֶת from
          // ילד. The remaining two radicals in order, plus at most two letters
          // of ending, is that root's derivation.
          if (base.length === 3 && 'יונה'.indexOf(base.charAt(0)) >= 0 && src.indexOf(base.slice(1)) === 0 && src.length <= 4) return true;
    ...
    // way any lemma is, once (a base is its own base, so this cannot loop).
    if (fam !== sNum && /^H\d/.test(fam) && !_famGuard[fam]) {
      _famGuard[fam] = 1;
      var deep = familyOf(fam);
      delete _famGuard[fam];
      return deep;
    }
    if (fam === sNum) {
      // A LEMMA THAT IS ITSELF A ROOT IS ITS FAMILY. בַּיִת (H1004) has no BDB
      // root the gate accepts and no derivation chain, and came out as its bare
      // number. A triliteral VERB lemma is a root by definition (לָבַן H3835);
      // a triliteral noun is one when Brauner's inventory or BDB says so (בית).
      // Names keep their number; so does anything shorter or longer.
      var _e = _roots() && _roots()[sNum];
      if (_e && _e.w && !/^[A-Z]/.test(String(_e.x || '').trim())) {
        var _sk = normFinals(stripNikkud(String(_e.w))).replace(/[^א-ת]/g, '');
        var _bd = typeof window !== 'undefined' && window._bdbRoots && window._bdbRoots[sNum];
        var _bds = _bd ? normFinals(stripNikkud(String(_bd))).replace(/[^א-ת]/g, '') : '';
        if (_sk.length === 3 && (_e.p !== undefined || isShoresh(_sk) || _bds === _sk)) return _sk;
      }
    }
    return fam;
  }
  var _famGuard = {};
  function _weakFirstBdb(sNum) {
    var root = window._bdbRoots && window._bdbRoots[sNum];
    var e = _roots() && _roots()[sNum];
    if (!root || !e || !e.w) return '';
    var lem = normFinals(stripNikkud(String(e.w))).replace(/[^א-ת]/g, '');
    var r = normFinals(stripNikkud(String(root))).replace(/[^א-ת]/g, '');
    if (r.length !== 3) return '';
    var weak = 'יונה';
    // I-weak: יָלַךְ / הלך -- same last two radicals, weak first letters
    if (lem.length === 3 && lem.slice(1) === r.slice(1) && weak.indexOf(lem.charAt(0)) >= 0 && weak.indexOf(r.charAt(0)) >= 0) return root;
    // hollow (II-Vav/Yod): יָנַח / נוח, מוּצָק's יצק / צוק -- the middle vowel
    // letter gone and a weak letter in front
    if (/[וי]/.test(r.charAt(1)) && lem.length === 3 && weak.indexOf(lem.charAt(0)) >= 0 && lem.charAt(1) === r.charAt(0) && lem.charAt(2) === r.charAt(2)) return root;
    // (no III-He tolerance for a two-letter lemma: BDB files the prepositions
    // and primitive nouns under speculative III-He roots -- עַל under עלה,
    // אָב under אבה -- and the card would count the verb as the particle)
    return '';
  }
  ...
  // Stage 3a — ATTESTED. The Masoretic Text's own analysis of this exact
  // pointed form (attested_forms.js: every word of the Leningrad text as
  // parsed by the OpenScriptures Hebrew Bible and STEPBible's TAHOT, with the
  // lemma counted over every occurrence). Where the one-value Strong's lookup
  // below chose the rarer homograph -- אָוֶן filed under the place-name H1007
  // against 66 occurrences of "iniquity" H205 -- the majority here decides.
  // Nothing is inferred: a form is here only if the Tanakh has it. The user's
  // rule (2026-09-06): attestation before pattern. Skipped when the table is
  // not loaded, so the engine still works without it.
  function _attestedTable() {
    return (typeof window !== 'undefined' && window._attestedForms) || null;
  }
  function attestedEntry(w) {
    var A = _attestedTable();
    if (!A) return null;
    var e = A[pointedKey(w)];
    return e || null;
  }
  function stageAttested(ctx) {
    // one word only: a maqqef compound is resolved piece by piece in getRoots,
    // and its joined key can collide with a real form (כִּי־מוֹת read as
    // כִּימוֹת "like the days of")
    if (ctx.pieces.length !== 1) return '';
    var e = attestedEntry(ctx.w);
    if (!e) return '';
    var sNum = e[0];
    if (!sNum || !_roots() || !_roots()[sNum]) return '';
    return familyOf(sNum);
  }
  // The parse of an attested form, for the card: [strongs, morph, segmented
  // surface, count, alternatives] -> {strongs, morph, segments, n, alts}
  function parse(hw) {
    var w = _clean(hw);
    if (_pieces(w).length !== 1) return null;
    var e = attestedEntry(w);
    if (!e) return null;
    return { strongs: e[0], morph: e[1] || '', segments: e[2] || '', n: e[3] || 0, alts: e[4] || '' };
  }
