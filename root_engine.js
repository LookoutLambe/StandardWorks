...
(function () {
  ...
  // which is the point for a name (Lehi must not become "jaw").
    ...
    'בִּצּוּעַ': 'בצע', 'בּוֹרֵחַ': 'ברח', 'מַבְשִׁיל': 'בשל', 'גַּבּוֹ': 'גב', 'גּוֹבֶה': 'גבה', 'גּוֹבֵר': 'גבר', 'שֶׁמִּתְגַּבֵּר': 'גבר',
    ...
    'מְתַכְנְנִים': 'תכנן', 'תַּכְשִׁיטִים': 'תכשיט', 'נִתְמָכִים': 'תמך', 'תְּנָאֶיהָ': 'תנאי', 'הַתַּנַךְ': 'תנך', 'הַתַּנַ"ךְ': 'תנך',
