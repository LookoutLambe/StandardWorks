...
// ============================================================
// Aleph Trail - Journey 3: Out of Egypt
// Curriculum DOCX generator (sourced from curriculum/journey3.json)
//
// Run:
//   npm run journey3:docx
// Output:
//   ./out/Aleph_Trail_Journey_3_Out_of_Egypt.docx
// ============================================================
...
function loadJourney3() {
  const pth = path.resolve(__dirname, "..", "curriculum", "journey3.json");
  if (!fs.existsSync(pth)) {
    throw new Error("Missing curriculum/journey3.json. Run: npm run journey:import-text -- curriculum/journey3_v1.txt journey3");
  }
    ...
    sections: [
      {
        ...
        children: [
          h1("Aleph Trail"),
          p("Journey 3: Out of Egypt (Exodus + selected Numbers)"),
          mixed([
            { text: "Exit skill: ", bold: true },
            { text: "Read Exodus 14:13–31 and Deuteronomy 6:4–9 aloud unassisted (with niqqud fading in effect)." },
          ]),
          p(""),
...
async function main() {
  ...
  const outPath = path.join(outDir, "Aleph_Trail_Journey_3_Out_of_Egypt.docx");
