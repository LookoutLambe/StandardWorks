...
// ============================================================
// Aleph Trail - Journey 5: Land and Kings
// Curriculum DOCX generator (sourced from curriculum/journey5.json)
//
// Run:
//   npm run journey5:docx
// Output:
//   ./out/Aleph_Trail_Journey_5_Land_and_Kings.docx
// ============================================================
...
function loadJourney5() {
  const pth = path.resolve(__dirname, "..", "curriculum", "journey5.json");
  if (!fs.existsSync(pth)) {
    throw new Error("Missing curriculum/journey5.json. Run: npm run journey:import-text -- curriculum/journey5_v1.txt journey5");
  }
    ...
    sections: [
      {
        ...
        children: [
          h1("Aleph Trail"),
          p("Journey 5: Land and Kings (Joshua–Kings + Psalms + Jeremiah bridge)"),
          mixed([
            { text: "Exit skill: ", bold: true },
            { text: "Read Psalm 23 in full and 2 Samuel 7:12–16 aloud (Davidic covenant)." },
          ]),
          p(""),
...
async function main() {
  ...
  const outPath = path.join(outDir, "Aleph_Trail_Journey_5_Land_and_Kings.docx");
