...
var frontIntro = [
  ...
  { num:"א", words:[
    ...
    ["הָעִבְרִי","the Hebrew"], ["הַזֶּה","this"],
    ["שֶׁל","of"],
    ["סֵפֶר","book of"],
    ["מוֹרְמוֹן","Mormon"],
    ["נַעֲשָׂה","was made"],
  ...
  ], english:"This Hebrew translation of the Book of Mormon is an independent work undertaken for linguistic, educational, and devotional purposes It is not an official publication of The Church of Jesus Christ of Latter-day Saints, nor is it endorsed by that institution."},
  { num:"ב", words:[
    ["אֵין","there is no"],
    ["הוּא","he"],
    ...
    ["נִתְמָךְ","supported"],
    ["עַל־יָדָהּ","by it"],
  ], english:"The aim of this translation is to present the text of the Book of Mormon in a form that reflects the style, vocabulary, and register of Biblical Hebrew, drawing especially upon the language of the Hebrew Bible The translator has sought to balance clarity with fidelity, favoring a formal and scriptural tone rather than a modern idiom, while remaining readable to students and readers of Biblical Hebrew."},
  { num:"ג", words:[
...
var frontIntroduction = [
  ...
  { num:"ט", words:[
    ...
    ["לִמְצֹא","to find"],
    ["שָׁלוֹם","peace"],
    ["בַּחַיִּים","in the life"], ["הָאֵלֶּה","these"],
  ...
  { num:"יג", words:[
    ...
    ["חַי","the living"],
    ["וְכִי","and that"],
    ["כׇּל־הַבָּאִים","all the who come"],
    ["אֵלָיו","unto Him"],
  ...
  { num:"יד", words:[
    ...
    ["סְמִית","Smith"],
    ["הַנָּבִיא","the prophet"],
    ["עַל־הַסֵּפֶר","upon the book"], ["הַזֶּה","this"],
  ...
  { num:"טו", words:[
    ...
    ["הוּא","is"],
    ["הַסֵּפֶר","the book"],
    ["הַנָּכוֹן","that the is expedient"],
    ["מִכׇּל־סְפָרֵי","of all the books of"],
    ["הָאָרֶץ","the earth"],
  ...
  { num:"יט", words:[
    ["וְכׇל־הַהֹלְכִים","and all the ones walking"],
    ["בַּדֶּרֶךְ","in the way"], ["הַזֹּאת","this"],
  ...
  { num:"כ", words:[
    ["וְכׇל־הַזּוֹכִים","and all the who receive"],
    ["לְעֵדוּת","the testimony of"],
    ["אֱלֹהִים","God"], ["הַזֹּאת","this"],
    ["יֵדְעוּ","they shall know"],
    ["גַם־בַּכֹּחַ","also by the power"], ["הַהוּא","that"],
    ["כִּי","that"],
    ["יֵשׁוּעַ","Jesus"],
    ["הַמָּשִׁיחַ","the Messiah"],
    ["הוּא","is"],
    ...
    ["הָאַחֲרוֹנִים","the latter"], ["הָאֵלֶּה","these"],
    ["וְכִי","and that"],
    ["עֲדַת","church of"],
    ["יֵשׁוּעַ","Jesus"],
    ["הַמָּשִׁיחַ","the Messiah"],
...
var frontThreeWit = [
  ...
  { num:"א", words:[
    ...
    ["אֲלֵיהֶם","unto them"],
    ["הַמַּעֲשֶׂה","the work"], ["הַזֶּה","this"],
  ...
  { num:"ב", words:[
    ...
    ["אֲשֶׁר","which"],
    ["בָּם","in them is"],
    ["הַזִּכָּרוֹן","the record"], ["הַזֶּה","this"],
    ["וְהוּא","and it is"],
    ["דִּבְרֵי","the record of"],
    ["יְמֵי","the days of"],
    ["עַם־נֶפִי","the people of Nephi"],
...
var frontEightWit = [
  ...
  { num:"ב", words:[
    ...
    ["אֶת־הַמַּעֲשֶׂה","the work"], ["הַזֶּה","this"],
    ["הֶרְאָה","He showed"],
    ["לָנוּ","unto us"],
    ["אֶת־הַלּוּחוֹת","the plates"],
    ["אֲשֶׁר","which"],
...
var frontJST = [
  ...
  { num:"ו", words:[
    ...
    ["בֶּגֶד","clothing"],
    ["זוּלַת","except"],
    ["הַמְּעִיל","the robe"], ["הַזֶּה","this"],
    ["כִּי","for"],
    ["פָתוּחַ","open"],
    ["הָיָה","it was"],
    ["וָאֵרֶא","and I saw"],
    ["אֶת־חָזֵהוּ","his bosom"],
  ...
  { num:"יג", words:[
    ...
    ["כֶּסֶף","silver"],
    ["וְהָאֲבָנִים","and the stones"], ["הָאֵלֶּה","these"],
    ["צְמוּדוֹת","fastened"],
    ["לְחֹשֶׁן","to a breastplate"],
    ["וְהֵם","and they"],
    ["הַנִּקְרָאִים","the are called"],
    ["אוּרִים","Urim"],
  ...
  { num:"יד", words:[
    ...
    ["אָחַז","possessed"],
    ["בָּאֲבָנִים","the stones"], ["הָאֵלֶּה","these"],
  ...
  { num:"כ", words:[
    ...
    ["הַנִּפְלָא","the wondrous"], ["הַזֶּה","this"],
  ...
  { num:"כג", words:[
    ...
    ["הַכְּבֵדִים","the grievous"], ["הָאֵלֶּה","these"],
    ["יָבוֹאוּ","would come"],
    ["בַּדּוֹר","in the generation"], ["הַזֶּה","this"],
  ...
  { num:"כה", words:[
    ["וּבָעֵת","and at that time"], ["הַהִיא","that"],
    ["כֹּה","so"],
    ["עָמְקוּ","deep were"],
  ...
  { num:"כו", words:[
    ...
    ["שֵׁנִית","again"],
    ["אֶת־הַמַּלְאָךְ","the same angel"], ["הַהוּא","that"],
    ["לְיַד־מִטָּתִי","beside my bed"],
  ...
  { num:"ל", words:[
    ...
    ["כׇּל־הַלַּיְלָה","all the night"], ["הַהוּא","that"],
  ...
  { num:"לא", words:[
    ...
    ["לַעֲבֹד","to till"],
    ["כִּבְכׇל־יוֹם","as at other the day of"],
  ...
  { num:"מא", words:[
    ...
    ["אַרְבַּע","four"],
    ["שָׁנִים","years"],
    ["מֵהַיּוֹם","from the that day"], ["הַזֶּה","this"],
  ...
  { num:"מב", words:[
    ...
    ["אֵלַי","me"],
    ["לָבוֹא","to come"],
    ["אֶל־הַמָּקוֹם","to the place"], ["הַזֶּה","this"],
  ...
  { num:"מג", words:[
    ...
    ["כׇּל־שָׁנָה","all years"],
    ["וּבְכׇל־פַּעַם","and in all once"],
    ["מָצָאתִי","I found"],
    ["שָׁם","there"],
    ["אֶת־אוֹתוֹ","the same"],
    ["הַמַּלְאָךְ","the angel"],
    ...
    ["בְּכׇל־פְּגִישׁוֹתֵינוּ","with all of our interviews"],
  ...
  { num:"מו", words:[
    ...
    ["לַחְשֹׁב","devised"],
    ["הוּשְׂמָה","was used"],
    ["לַמַּטָּרָה","for the purpose"], ["הַזֹּאת","this"],
  ...
  { num:"מח", words:[
    ...
    ["עַד־הַיּוֹם","the until day"], ["הַזֶּה","this"],
    ["שְׁנֵי","two"],
    ["יָמִים","the days"],
    ["לַחֹדֶשׁ","of the month"],
  ...
  { num:"נ", words:[
    ["וְהַסֵּפֶר","and the book"],
    ["הָעַתִּיק","the ancient"], ["הַזֶּה","this"],
    ["אֲשֶׁר","which"],
    ["הוּצָא","bring out"],
...
var frontBrief = [
  ...
  { num:"ו", words:[
    ...
    ["מוֹרוֹנִי","Moroni"],
    ["קִצֵּר","abridged"],
    ["אֶת־הַדְּבָרִים","the records"], ["הָאֵלֶּה","these"],
    ["וַיּוֹסֶף","and Joseph"],
    ["מִשֶּׁלּוֹ","of his own"],
    ["וַיִּקְרָא","and called"],
    ["לָהֶם","them"],
