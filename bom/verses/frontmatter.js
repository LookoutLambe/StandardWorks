...
var frontIntroduction = [
  ...
  { num:"ט", words:[
    ...
    ["לִמְצֹא","to find"],
    ["שָׁלוֹם","peace"],
    ["בַּחַיִּים הָאֵלֶּה","in these life"],
  ...
  { num:"יד", words:[
    ...
    ["סְמִית","Smith"],
    ["הַנָּבִיא","the prophet"],
    ["עַל־הַסֵּפֶר הַזֶּה","upon this book"],
  ...
  { num:"יט", words:[
    ...
    ["בַּדֶּרֶךְ הַזֹּאת","in this way"],
  ...
  { num:"כ", words:[
    ...
    ["אֱלֹהִים הַזֹּאת","this God"],
    ["יֵדְעוּ","they shall know"],
    ["גַם־בַּכֹּחַ הַהוּא","also that by the power"],
    ["כִּי","that"],
    ["יֵשׁוּעַ","Jesus"],
    ["הַמָּשִׁיחַ","the Messiah"],
    ["הוּא","is"],
    ...
    ["הָאַחֲרוֹנִים הָאֵלֶּה","these latter"],
    ["וְכִי","and that"],
    ["עֲדַת","church of"],
    ["יֵשׁוּעַ","Jesus"],
    ["הַמָּשִׁיחַ","the Messiah"],
...
var frontThreeWit = [
  ...
  { num:"ב", words:[
    ...
    ["אֲשֶׁר","which"],
    ["בָּם","in them is"],
    ["הַזִּכָּרוֹן הַזֶּה","this record"],
    ["וְהוּא","and it is"],
    ["דִּבְרֵי","the record of"],
    ["יְמֵי","the days of"],
    ["עַם־נֶפִי","the people of Nephi"],
...
var frontEightWit = [
  ...
  { num:"ב", words:[
    ...
    ["אֶת־הַמַּעֲשֶׂה הַזֶּה","this work"],
    ["הֶרְאָה","He showed"],
    ["לָנוּ","unto us"],
    ["אֶת־הַלּוּחוֹת","the plates"],
    ["אֲשֶׁר","which"],
...
var frontJST = [
  ...
  { num:"יג", words:[
    ...
    ["כֶּסֶף","silver"],
    ["וְהָאֲבָנִים הָאֵלֶּה","and these stones"],
    ["צְמוּדוֹת","fastened"],
  ...
  { num:"יד", words:[
    ...
    ["אָחַז","possessed"],
    ["בָּאֲבָנִים הָאֵלֶּה","these stones"],
  ...
  { num:"כ", words:[
    ...
    ["הַנִּפְלָא הַזֶּה","this wondrous"],
  ...
  { num:"כג", words:[
    ...
    ["הַכְּבֵדִים הָאֵלֶּה","these grievous"],
    ["יָבוֹאוּ","would come"],
    ["בַּדּוֹר הַזֶּה","in this generation"],
  ...
  { num:"כה", words:[
    ["וּבָעֵת הַהִיא","and that at that time"],
    ["כֹּה","so"],
    ["עָמְקוּ","deep were"],
  ...
  { num:"כו", words:[
    ...
    ["שֵׁנִית","again"],
    ["אֶת־הַמַּלְאָךְ הַהוּא","that same angel"],
    ["לְיַד־מִטָּתִי","beside my bed"],
  ...
  { num:"ל", words:[
    ...
    ["כׇּל־הַלַּיְלָה הַהוּא","all that night"],
  ...
  { num:"מא", words:[
    ...
    ["אַרְבַּע","four"],
    ["שָׁנִים","years"],
    ["מֵהַיּוֹם הַזֶּה","from this that day"],
  ...
  { num:"מב", words:[
    ...
    ["אֵלַי","me"],
    ["לָבוֹא","to come"],
    ["אֶל־הַמָּקוֹם הַזֶּה","to this place"],
  ...
  { num:"מו", words:[
    ...
    ["לַחְשֹׁב","devised"],
    ["הוּשְׂמָה","was used"],
    ["לַמַּטָּרָה הַזֹּאת","for this purpose"],
  ...
  { num:"מח", words:[
    ...
    ["עַד־הַיּוֹם הַזֶּה","until this day"],
    ["שְׁנֵי","two"],
    ["יָמִים","the days"],
    ["לַחֹדֶשׁ","of the month"],
...
var frontBrief = [
  ...
  { num:"ו", words:[
    ...
    ["מוֹרוֹנִי","Moroni"],
    ["קִצֵּר","abridged"],
    ["אֶת־הַדְּבָרִים הָאֵלֶּה","these records"],
    ["וַיּוֹסֶף","and Joseph"],
    ["מִשֶּׁלּוֹ","of his own"],
    ["וַיִּקְרָא","and called"],
    ["לָהֶם","them"],
