...
var ms_ch1Verses = [
  ...
  { num: "ה", words: [
    ["עַל־כֵּן","Wherefore,"],["לֹא","no"],["יוּכַל","can"],["אִישׁ","man"],["לִרְאוֹת","behold"],["אֶת־כָּל־מַעֲשַׂי","all my works,"],["אִם־לֹא","except"],["יִרְאֶה","he behold"],["אֶת־כָּל־כְּבוֹדִי","all my glory;"],["וְאִישׁ","and no man"],["בַּבָּשָׂר","in the flesh"],["לֹא","not"],["יִרְאֶנִּי","can behold me,"],["וָחָי","and live."],["׃",""]
  ]},
  { num: "ו", words: [
    ["וְיֵשׁ־לִי","And I have"],["מְלָאכָה","a work"],["בְּךָ","for thee,"],["מֹשֶׁה","Moses,"],["בְּנִי","my son;"],["וְאַתָּה","and thou art"],["בִּדְמוּת","in the similitude of"],["יְחִידִי","mine Only Begotten;"],["וִיחִידִי","and mine Only Begotten"],["הוּא","he"],["הַמּוֹשִׁיעַ","is and shall be the Savior,"],["מָלֵא","for he is full of"],["חֶסֶד","grace"],["וֶאֱמֶת","and truth;"],["אֵין","but there is no"],["אֱלֹהִים","God"],["זוּלָתִי","beside me,"],["וְכָל־הַדְּבָרִים","and all things"],["לְפָנַי","are present with me,"],["כִּי","for"],["יְדַעְתִּים","I know them all."],["׃",""]
  ]},
  { num: "ז", words: [
  ...
  { num: "ח", words: [
    ["וַיַּבֵּט","And looked"],["מֹשֶׁה","Moses,"],["וַיַּרְא","and beheld"],["אֶת־הָעוֹלָם","the world"],["וְאֶת־קְצוֹתָיו","and the ends thereof,"],["וְאֵת","and"],["כָּל־בְּנֵי","all the children of"],["הָאָדָם","men"],["אֲשֶׁר","which"],["הֵם","are,"],["וַאֲשֶׁר","and which"],["הָיוּ","were"],["וְגַם","also,"],["אֲשֶׁר","which"],["יִבָּרְאוּ","were created;"],["וַיִּתְמַהּ","and he greatly marvelled"],["וַיִּפְלָא","and wondered."],["׃",""]
  ]},
  { num: "ט", words: [
  ...
  { num: "כט", words: [
    ["וַיַּרְא","And he beheld"],["אֲרָצוֹת","lands"],["רַבּוֹת","many;"],["וְכָל־אֶרֶץ","and every land"],["קָרְאָה","was called"],["בְּשֵׁם","by the name of"],["יֹשְׁבֶיהָ","its inhabitants;"],["וְהָיוּ","and they were"],["יֹשְׁבִים","inhabitants"],["עַל־פָּנֶיהָ","upon the face thereof."],["׃",""]
  ]},
  { num: "ל", words: [
  ...
  { num: "לא", words: [
    ["וּכְבוֹד","And the glory of"],["יְהוָה","the Lord"],["הָיָה","was"],["עַל־מֹשֶׁה","upon Moses,"],["וַיַּעֲמֹד","so that he stood"],["לִפְנֵי","in the presence of"],["אֱלֹהִים","God,"],["וַיְדַבֵּר","and talked"],["עִמּוֹ","with him"],["פָּנִים","face"],["אֶל־פָּנִים","to face."],["וַיֹּאמֶר","And said"],["יְהוָה","the Lord"],["אֶל־מֹשֶׁה","unto Moses:"],["לְמַעֲנִי","For mine own purpose"],["עָשִׂיתִי","have I made"],["אֶת־הַדְּבָרִים","things"],["הָאֵלֶּה","these."],["וְהִנֵּה","Here is"],["חָכְמָתִי","my wisdom,"],["נִצְּבָה","and it remaineth in me."],["׃",""]
  ]},
  { num: "לב", words: [
...
var ms_ch2Verses = [
  ...
  { num: "כא", words: [
    ["וַאֲנִי","And I,"],["אֱלֹהִים","God,"],["בָּרָאתִי","created"],["אֶת־הַתַּנִּינִם","whales"],["הַגְּדֹלִים","great,"],["וְאֵת","and"],["כָּל־נֶפֶשׁ","every creature"],["הַחַיָּה","living"],["הָרֹמֶשֶׂת","that moveth,"],["אֲשֶׁר","which"],["שָׁרְצוּ","brought forth abundantly"],["הַמַּיִם","the waters,"],["לְמִינֵהֶם","after their kind,"],["וְאֵת","and"],["כָּל־עוֹף","every fowl"],["כָּנָף","winged"],["לְמִינֵהוּ","after his kind;"],["וַאֲנִי","and I,"],["אֱלֹהִים","God,"],["רָאִיתִי","saw"],["כִּי־טוֹב","that all things which I had created were good."],["׃",""]
  ]},
  { num: "כב", words: [
  ...
  { num: "כה", words: [
    ["וַאֲנִי","And I,"],["אֱלֹהִים","God,"],["עָשִׂיתִי","made"],["אֶת־חַיַּת","the beasts of"],["הָאָרֶץ","the earth"],["לְמִינָהּ","after their kind,"],["וְאֶת־הַבְּהֵמָה","and cattle"],["לְמִינָהּ","after their kind,"],["וְאֵת","and"],["כָּל־רֶמֶשׂ","everything which creepeth upon"],["הָאֲדָמָה","the earth"],["לְמִינֵהוּ","after his kind;"],["וַאֲנִי","and I,"],["אֱלֹהִים","God,"],["רָאִיתִי","saw"],["כִּי־טוֹב","that all these things were good."],["׃",""]
  ]},
  { num: "כו", words: [
  ...
  { num: "כט", words: [
    ["וָאֹמַר","And I,"],["אֲנִי","I,"],["אֱלֹהִים","God,"],["הִנֵּה","Behold,"],["נָתַתִּי","I have given"],["לָכֶם","you"],["אֶת־כָּל־עֵשֶׂב","every herb"],["זֹרֵעַ","bearing"],["זֶרַע","seed"],["אֲשֶׁר","which is"],["עַל־פְּנֵי","upon the face of"],["כָל־הָאָרֶץ","all the earth,"],["וְאֶת־כָּל־הָעֵץ","and every tree"],["אֲשֶׁר־בּוֹ","in the which"],["פְרִי־עֵץ","shall be the fruit of a tree"],["זֹרֵעַ","yielding"],["זָרַע","seed;"],["לָכֶם","to you"],["יִהְיֶה","it shall be"],["לְאָכְלָה","for meat."],["׃",""]
  ]},
  { num: "ל", words: [
    ["וּלְכָל־חַיַּת","And to every beast of"],["הָאָרֶץ","the earth,"],["וּלְכָל־עוֹף","and to every fowl of"],["הַשָּׁמַיִם","the air,"],["וּלְכֹל","and to every thing"],["רוֹמֵשׂ","that creepeth"],["עַל־הָאָרֶץ","upon the earth,"],["אֲשֶׁר־בּוֹ","wherein"],["נֶפֶשׁ","I,"],["חַיָּה","God, have given life,"],["אֶת־כָּל־יֶרֶק","every clean"],["עֵשֶׂב","herb"],["לְאָכְלָה","for meat;"],["וַיְהִי־כֵן","and it was so"],["כַּאֲשֶׁר","even as"],["דִּבַּרְתִּי","I spake."],["׃",""]
  ]},
  { num: "לא", words: [
    ["וָאֵרֶא","And I,"],["אֲנִי","I,"],["אֱלֹהִים","God,"],["אֶת־כָּל־אֲשֶׁר","saw every thing that"],["עָשִׂיתִי","I had made,"],["וְהִנֵּה","and behold,"],["טוֹב","good"],["מְאֹד","all things were very;"],["וַיְהִי־עֶרֶב","and the evening"],["וַיְהִי־בֹקֶר","and the morning were"],["יוֹם","day"],["הַשִּׁשִּׁי","the sixth."],["׃",""]
  ]}
];
renderVerseSet(ms_ch2Verses, 'ms-ch2-verses');
var ms_ch3Verses = [
  { num: "א", words: [
    ["וַיְכֻלּוּ","Thus were finished"],["הַשָּׁמַיִם","the heavens"],["וְהָאָרֶץ","and the earth,"],["וְכָל־צְבָאָם","and all the host of them."],["׃",""]
  ]},
  { num: "ב", words: [
    ["וַאֲנִי","And I,"],["אֱלֹהִים","God,"],["כִּלֵּיתִי","ended"],["בַּיּוֹם","by the day"],["הַשְּׁבִיעִי","the seventh"],["מְלַאכְתִּי","my work,"],["אֲשֶׁר","which"],["עָשִׂיתִי","I had made;"],["וָאֶשְׁבֹּת","and I rested"],["בַּיּוֹם","on the day"],["הַשְּׁבִיעִי","the seventh"],["מִכָּל־מְלַאכְתִּי","from all my work,"],["אֲשֶׁר","which"],["עָשִׂיתִי","I had made;"],["וַאֲנִי","and I,"],["אֱלֹהִים","God,"],["רָאִיתִי","saw"],["כֹּל","every thing"],["אֲשֶׁר","that"],["עָשִׂיתִי","I had made,"],["כִּי־טוֹב","and behold, all things which I had made were"],["מְאֹד","very good."],["׃",""]
  ]},
  { num: "ג", words: [
    ["וַאֲנִי","And I,"],["אֱלֹהִים","God,"],["בֵּרַכְתִּי","blessed"],["אֶת־יוֹם","day"],["הַשְּׁבִיעִי","the seventh,"],["וַאֲקַדֵּשׁ","and sanctified"],["אֹתוֹ","it;"],["כִּי","because"],["בוֹ","that in it"],["שָׁבַתִּי","I had rested"],["מִכָּל־מְלַאכְתִּי","from all my work"],["אֲשֶׁר","which"],["בָּרָאתִי","I,"],["וְעָשִׂיתִי","God, had created and made."],["׃",""]
  ]},
  { num: "ד", words: [
  ...
  { num: "ה", words: [
    ["וְכֹל","And every"],["שִׂיחַ","plant of"],["הַשָּׂדֶה","the field"],["טֶרֶם","before"],["יִהְיֶה","it was"],["בָאָרֶץ","in the earth,"],["וְכָל־עֵשֶׂב","and every herb of"],["הַשָּׂדֶה","the field"],["טֶרֶם","before"],["יִצְמָח","it grew."],["כִּי","For"],["אֲנִי","I,"],["יְהוָה","the Lord"],["אֱלֹהִים","God,"],["בָּרָאתִי","created"],["אֶת־כָּל־הַדְּבָרִים","all things,"],["אֲשֶׁר","of which"],["דִּבַּרְתִּי","I have spoken,"],["בָרוּחַ","spiritually,"],["לִפְנֵי","before"],["הֱיוֹתָם","they were"],["בַּבָּשָׂר","naturally"],["עַל־פְּנֵי","upon the face of"],["הָאָרֶץ","the earth."],["כִּי","For"],["אֲנִי","I,"],["יְהוָה","the Lord"],["אֱלֹהִים","God,"],["לֹא","had not"],["הִמְטַרְתִּי","caused it to rain"],["עַל־הָאָרֶץ","upon the face of the earth."],["וְאֵין","And not"],["אָדָם","a man"],["לַעֲבֹד","to till"],["אֶת־הָאֲדָמָה","the ground;"],["כִּי","for"],["בַשָּׁמַיִם","in heaven"],["בְּרָאתִים","created I them;"],["וְלֹא","and not yet"],["הָיָה","was there"],["בָשָׂר","flesh"],["עַל־הָאָרֶץ","upon the earth,"],["וְלֹא","neither"],["בַמַּיִם","in the water,"],["וְלֹא","neither"],["בָאֲוִיר","in the air;"],["׃",""]
  ]},
  { num: "ו", words: [
    ["אַךְ","But"],["אֵד","a mist"],["עָלָה","went up"],["מִן־הָאָרֶץ","from the earth,"],["וְהִשְׁקָה","and watered"],["אֶת־כָּל־פְּנֵי","the whole face of"],["הָאֲדָמָה","the ground."],["׃",""]
  ]},
  { num: "ז", words: [
  ...
  { num: "יא", words: [
    ["שֵׁם","The name of"],["הָאֶחָד","the first"],["פִּישׁוֹן","is Pison;"],["הוּא","that"],["הַסֹּבֵב","is it which compasseth"],["אֵת",""],["כָּל־אֶרֶץ","the whole land of"],["הַחֲוִילָה","Havilah,"],["אֲשֶׁר־שָׁם","where there is"],["הַזָּהָב","gold;"],["׃",""]
  ]},
  { num: "יב", words: [
  ...
  { num: "יג", words: [
    ["וְשֵׁם","And the name of"],["הַנָּהָר","the river"],["הַשֵּׁנִי","second"],["גִּיחוֹן","is Gihon;"],["הוּא","the same"],["הַסֹּבֵב","is it that compasseth"],["אֵת",""],["כָּל־אֶרֶץ","the whole land of"],["כּוּשׁ","Ethiopia."],["׃",""]
  ]},
  { num: "יד", words: [
  ...
  { num: "יט", words: [
    ["וַאֲנִי","And I,"],["יְהוָה","the Lord"],["אֱלֹהִים","God,"],["יָצַרְתִּי","formed"],["מִן־הָאֲדָמָה","out of the ground"],["כָּל־חַיַּת","every beast of"],["הַשָּׂדֶה","the field,"],["וְאֵת","and"],["כָּל־עוֹף","every fowl of"],["הַשָּׁמַיִם","the air;"],["וָאָבִיא","and commanded that they should come"],["אֶל־הָאָדָם","unto Adam,"],["לִרְאוֹת","to see"],["מַה־יִּקְרָא","what he would call"],["לָהֶם","them;"],["וְהֵם","and they"],["גַּם","were also"],["נַפְשׁוֹת","souls"],["חַיּוֹת","living;"],["כִּי","for"],["נָפַחְתִּי","I breathed"],["בָהֶם","into them"],["נִשְׁמַת","the breath of"],["חַיִּים","life,"],["וְכֹל","and whatsoever"],["אֲשֶׁר","that"],["יִקְרָא־לוֹ","called"],["הָאָדָם","Adam"],["נֶפֶשׁ","every creature"],["חַיָּה","living,"],["הוּא","that"],["שְׁמוֹ","was the name thereof."],["׃",""]
  ]},
  { num: "כ", words: [
    ["וַיִּקְרָא","And gave"],["הָאָדָם","Adam"],["שֵׁמוֹת","names"],["לְכָל־הַבְּהֵמָה","to all cattle,"],["וּלְעוֹף","and to the fowl of"],["הַשָּׁמַיִם","the air,"],["וּלְכֹל","and to every"],["חַיַּת","beast of"],["הַשָּׂדֶה","the field;"],["אַךְ","but"],["לְאָדָם","for Adam"],["לֹא־מָצָא","there was not found"],["עֵזֶר","an help"],["כְּנֶגְדּוֹ","meet for him."],["׃",""]
  ]},
  { num: "כא", words: [
...
var ms_ch4Verses = [
  { num: "א", words: [
    ["וָאֹמַר","And I said"],["אֶל־מֹשֶׁה","unto Moses:"],["הַשָּׂטָן","Satan,"],["אֲשֶׁר","whom"],["צִוִּיתָ","thou hast commanded"],["בְּשֵׁם","in the name of"],["יְחִידִי","mine Only Begotten,"],["הוּא","he is"],["אֲשֶׁר","the same which"],["הָיָה","was"],["מֵרֵאשִׁית","from the beginning,"],["וַיָּבֹא","and he came"],["לְפָנַי","before me,"],["לֵאמֹר","saying:"],["הִנְנִי","Behold,"],["שְׁלָחֵנִי","here am I, send me,"],["אֶהְיֶה","I will be"],["בִנְךָ","thy son,"],["וְאֶגְאַל","and I will redeem"],["אֶת־כָּל־הָאָדָם","all mankind,"],["וְנֶפֶשׁ","that a soul"],["אַחַת","one"],["לֹא","shall not"],["תֹאבַד","be lost,"],["וַאֲנִי","and surely I"],["אֶעֱשֶׂנָּה","will do it;"],["תֶּן־לִי","wherefore give me"],["אֶת־כְּבוֹדֶךָ","thine honor."],["׃",""]
  ]},
  { num: "ב", words: [
  ...
  { num: "ד", words: [
    ["וַיְהִי","And he became"],["לְשָׂטָן","Satan,"],["אַף","yea, even"],["הַשָּׂטָן","the devil,"],["אֲבִי","the father of"],["כָל־הַשְּׁקָרִים","all lies,"],["לְהַשִּׁיא","to deceive"],["וּלְעַוֵּר","and to blind"],["אֲנָשִׁים","men,"],["וְלִשְׁבּוֹת","and to lead captive"],["אֹתָם","them"],["כִּרְצוֹנוֹ","at his will,"],["כָּל־אֲשֶׁר","even as many as"],["לֹא","would not"],["שָׁמְעוּ","hearken"],["בְקוֹלִי","unto my voice."],["׃",""]
  ]},
  { num: "ה", words: [
  ...
  { num: "יב", words: [
    ["וַתֵּרֶא","And saw"],["הָאִשָּׁה","the woman"],["כִּי","that"],["טוֹב","was good"],["הָעֵץ","the tree"],["לְמַאֲכָל","for food,"],["וְכִי","and that"],["תַאֲוָה־הוּא","it was pleasant"],["לָעֵינַיִם","to the eyes,"],["וְנֶחְמָד","and a tree to be desired"],["לְהַשְׂכִּיל","to make one wise;"],["וַתִּקַּח","she took"],["מִפִּרְיוֹ","of the fruit thereof,"],["וַתֹּאכַל","and did eat,"],["וַתִּתֵּן","and gave"],["גַּם־לְאִישָׁהּ","also unto her husband"],["עִמָּהּ","with her,"],["וַיֹּאכַל","and he did eat."],["׃",""]
  ]},
  { num: "יג", words: [
  ...
  { num: "כו", words: [
    ["וַיִּקְרָא","And called"],["הָאָדָם","Adam"],["שֵׁם","the name of"],["אִשְׁתּוֹ","his wife"],["חַוָּה","Eve,"],["כִּי","because"],["הִוא","she"],["אֵם","was the mother of"],["כָּל־חָי","all living;"],["כִּי","for"],["כֵן","thus"],["קָרָאתִי","have I,"],["אֶת־הָרִאשׁוֹנָה","the Lord God, called the first"],["לְכָל־הַנָּשִׁים","of all women,"],["אֲשֶׁר","which"],["הֵן","are"],["רַבּוֹת","many."],["׃",""]
  ]},
  { num: "כז", words: [
...
var ms_ch5Verses = [
  { num: "א", words: [
    ["וַיְהִי","And it came to pass"],["אַחֲרֵי","after"],["אֹתָם","that"],["וַיָּחֶל","began"],["אָדָם","Adam"],["לַעֲבֹד","to till"],["אֶת־הָאֲדָמָה","the earth,"],["וְלִרְדּוֹת","and to have dominion"],["בְּכָל־חַיַּת","over all the beasts of"],["הַשָּׂדֶה","the field,"],["וְלֶאֱכֹל","and to eat"],["לַחְמוֹ","his bread"],["בְּזֵעַת","by the sweat of"],["אַפּוֹ","his brow,"],["כַּאֲשֶׁר","as"],["צִוִּיתִיו","I, the Lord, had commanded him."],["וְחַוָּה","And Eve,"],["אִשְׁתּוֹ","his wife,"],["גַּם־הִיא","also"],["עָבְדָה","did labor"],["עִמּוֹ","with him."],["׃",""]
  ]},
  { num: "ב", words: [
  ...
  { num: "ח", words: [
    ["לָכֵן","Wherefore,"],["כָּל־אֲשֶׁר","whatsoever"],["תַּעֲשֶׂה","thou doest,"],["תַּעֲשֶׂה","do it"],["בְּשֵׁם","in the name of"],["הַבֵּן","the Son,"],["וְתָשׁוּב","and thou shalt repent"],["וְקָרָאתָ","and call"],["אֶל־אֱלֹהִים","upon God"],["בְּשֵׁם","in the name of"],["הַבֵּן","the Son"],["לְעוֹלָם","for evermore."],["׃",""]
  ]},
  { num: "ט", words: [
    ["וּבַיּוֹם","And in the day"],["הַהוּא","that"],["נָפְלָה","fell"],["רוּחַ","the Spirit of"],["הַקֹּדֶשׁ","the Holiness"],["עַל־אָדָם","upon Adam,"],["הַמֵּעִידָה","which beareth record of"],["עַל־הָאָב","the Father"],["וְעַל־הַבֵּן","and the Son,"],["לֵאמֹר","saying:"],["הַבֵּן","The Son"],["יְחִיד","is the Only Begotten of"],["הוּא","he"],["לָאָב","the Father"],["מֵרֵאשִׁית","from the beginning,"],["וְעַד־עוֹלָם","henceforth and forever,"],["וְאַתָּה","that as thou"],["אַף","even"],["כִּי","since"],["נָפַלְתָּ","hast fallen,"],["תִּגָּאֵל","thou mayest be redeemed,"],["וְכָל־הַשֹּׁמֵעַ","and all whoso hearkeneth"],["וּמַאֲמִין","and believeth"],["יִגָּאֵל","shall be redeemed."],["׃",""]
  ]},
  { num: "י", words: [
    ["וּבַיּוֹם","And in the day"],["הַהוּא","that"],["בֵּרַךְ","blessed"],["אָדָם","Adam"],["אֶת־אֱלֹהִים","God"],["וַיִּמָּלֵא","and was filled,"],["וַיָּחֶל","and began"],["לְהִנָּבֵא","to prophesy"],["עַל־כָּל־מִשְׁפְּחוֹת","concerning all the families of"],["הָאָרֶץ","the earth,"],["לֵאמֹר","saying:"],["בָּרוּךְ","Blessed be"],["שֵׁם","the name of"],["אֱלֹהִים","God,"],["כִּי","for"],["בְּפִשְׁעִי","because of my transgression"],["נִפְקְחוּ","are opened"],["עֵינַי","mine eyes,"],["וּבָעוֹלָם","and in world"],["הַזֶּה","this"],["יִהְיֶה־לִּי","I shall have"],["שִׂמְחָה","joy,"],["וּבַבָּשָׂר","and in the flesh"],["עוֹד","again"],["אֶרְאֶה","I shall see"],["אֱלֹהִים","God."],["׃",""]
  ]},
  { num: "יא", words: [
    ["וַתִּשְׁמַע","And heard"],["חַוָּה","Eve,"],["אִשְׁתּוֹ","his wife,"],["אֶת־כָּל־הַדְּבָרִים","all the things"],["הָאֵלֶּה","these"],["וַתִּשְׂמַח","and was glad,"],["לֵאמֹר","saying:"],["לוּלֵי","Were it not for"],["פִשְׁעֵנוּ","our transgression,"],["לֹא","not"],["הָיָה","should we have had"],["לָנוּ","unto us"],["זֶרַע","seed,"],["וְלֹא","and not"],["יָדַעְנוּ","should have known"],["לְעוֹלָם","ever"],["טוֹב","good"],["וָרָע","and evil,"],["וְשִׂמְחַת","and the joy of"],["גְּאֻלָּתֵנוּ","our redemption,"],["וְחַיֵּי","and life"],["עוֹלָם","eternal,"],["אֲשֶׁר","which"],["יִתֵּן","giveth"],["אֱלֹהִים","God"],["לְכָל־הַשֹּׁמְעִים","unto all the obedient."],["׃",""]
  ]},
  { num: "יב", words: [
    ["וַיְבָרֲכוּ","And blessed"],["אָדָם","Adam"],["וְחַוָּה","and Eve"],["אֶת־שֵׁם","the name of"],["אֱלֹהִים","God,"],["וַיּוֹדִיעוּ","and they made known"],["אֶת־כָּל־הַדְּבָרִים","all things"],["לִבְנֵיהֶם","unto their sons"],["וּלְבְנוֹתֵיהֶם","and their daughters."],["׃",""]
  ]},
  { num: "יג", words: [
  ...
  { num: "יד", words: [
    ["וַיִּקְרָא","And called"],["יְהוָה","the Lord"],["אֱלֹהִים","God"],["אֶל־הָאָדָם","upon men"],["בְּכָל־מָקוֹם","everywhere,"],["בְּרוּחַ","by the Spirit of"],["הַקֹּדֶשׁ","the Holiness,"],["וַיְצַו","and commanded"],["אֹתָם","them"],["לָשׁוּב","that they should repent."],["׃",""]
  ]},
  { num: "טו", words: [
  ...
  { num: "ל", words: [
    ["וַיִּשָּׁבַע","And sware"],["הַשָּׂטָן","Satan"],["לְקַיִן","unto Cain"],["לַעֲשׂוֹת","that he would do"],["כְּמִצְוֹתָיו","according to his commands."],["וְכָל־הַדְּבָרִים","And all the things"],["הָאֵלֶּה","these"],["נַעֲשׂוּ","were done"],["בַסֵּתֶר","in secret."],["׃",""]
  ]},
  { num: "לא", words: [
    ["וַיֹּאמֶר","And said"],["קַיִן","Cain:"],["אָמְנָם","Truly,"],["אֲנִי","I am"],["מָהָן","Mahan,"],["אֲדוֹן","the master of"],["הַסּוֹד","mystery"],["הַגָּדוֹל","great"],["הַזֶּה","this,"],["לְמַעַן","that"],["אֶרְצַח","I may murder"],["וְאֶבְצָע","and get gain."],["לָכֵן","Wherefore"],["נִקְרָא","was called"],["קַיִן","Cain"],["מָהָן","Master Mahan,"],["וַיִּתְהַלֵּל","and he gloried"],["בְּרִשְׁעָתוֹ","in his wickedness."],["׃",""]
  ]},
  { num: "לב", words: [
    ["וַיֵּצֵא","And went out"],["קַיִן","Cain"],["הַשָּׂדֶה","into the field,"],["וַיְדַבֵּר","and talked"],["קַיִן","Cain"],["אֶל־הֶבֶל","with Abel,"],["אָחִיו","his brother."],["וַיְהִי","And it came to pass"],["בִּהְיוֹתָם","that, while they were"],["בַּשָּׂדֶה","in the field,"],["וַיָּקָם","rose up"],["קַיִן","Cain"],["עַל־הֶבֶל","against Abel,"],["אָחִיו","his brother,"],["וַיַּהַרְגֵהוּ","and slew him."],["׃",""]
  ]},
  { num: "לג", words: [
    ["וַיִּתְהַלֵּל","And gloried"],["קַיִן","Cain"],["בַּאֲשֶׁר","in that which"],["עָשָׂה","he had done,"],["לֵאמֹר","saying:"],["אֲנִי","I am"],["חָפְשִׁי","free;"],["וּמִקְנֵה","surely the flocks of"],["אָחִי","my brother"],["נָפְלוּ","falleth"],["בְּיָדָי","into my hands."],["׃",""]
  ]},
  { num: "לד", words: [
  ...
  { num: "לט", words: [
    ["הֵן","Behold,"],["גֵּרַשְׁתָּ","thou hast driven"],["אֹתִי","me out"],["הַיּוֹם","this day"],["מֵעַל","from"],["פְּנֵי","the face of"],["הָאֲדָמָה","the Lord,"],["וּמִפָּנֶיךָ","and from thy face"],["אֶסָּתֵר","shall I be hid;"],["וְהָיִיתִי","and I shall be"],["נָע","a fugitive"],["וָנָד","and a vagabond"],["בָּאָרֶץ","in the earth;"],["וְהָיָה","and it shall come to pass,"],["כָל־מֹצְאִי","that every one that findeth me"],["יַהַרְגֵנִי","shall slay me,"],["בַּעֲוֹנֹתַי","because of mine iniquities,"],["כִּי","for"],["הַדְּבָרִים","things"],["הָאֵלֶּה","these"],["לֹא","are not"],["נִסְתָּרִים","hid"],["מֵיְהוָה","from the Lord."],["׃",""]
  ]},
  { num: "מ", words: [
    ["וָאֹמַר","And I said"],["אֲנִי","I,"],["יְהוָה","the Lord:"],["כָּל־הֹרֵג","Whosoever slayeth"],["אֶת־קַיִן","Cain"],["שִׁבְעָתַיִם","sevenfold"],["יֻקָּם","vengeance shall be taken on him."],["וָאָשִׂם","And I set"],["אוֹת","a mark"],["לְקַיִן","upon Cain,"],["לְבִלְתִּי","lest"],["הַכּוֹת","should slay"],["אֹתוֹ","him"],["כָּל־מֹצְאוֹ","any finding him."],["׃",""]
  ]},
  { num: "מא", words: [
  ...
  { num: "מה", words: [
    ["וַתֵּלֶד","And bare"],["עָדָה","Adah"],["אֶת־יָבָל","Jabal;"],["הוּא","he"],["הָיָה","was"],["אֲבִי","the father of"],["יֹשֵׁב","such as dwell in"],["אֹהֶל","tents,"],["וּמִקְנֶה","and of such as have cattle."],["וְשֵׁם","And the name of"],["אָחִיו","his brother"],["יוּבָל","was Jubal;"],["הוּא","he"],["הָיָה","was"],["אֲבִי","the father of"],["כָּל־תֹּפֵשׂ","all such as handle"],["כִּנּוֹר","the harp"],["וְעוּגָב","and organ."],["׃",""]
  ]},
  { num: "מו", words: [
    ["וְצִלָּה","And Zillah,"],["גַם־הִיא","she also"],["יָלְדָה","bare"],["אֶת־תּוּבַל","Tubal"],["קַיִן","Cain,"],["לֹטֵשׁ","an instructor of"],["כָּל־חֹרֵשׁ","every artificer in"],["נְחֹשֶׁת","brass"],["וּבַרְזֶל","and iron."],["וַאֲחוֹת","And the sister of"],["תּוּבַל־קַיִן","Tubal-Cain"],["נַעֲמָה","was Naamah."],["׃",""]
  ]},
  { num: "מז", words: [
  ...
  { num: "נה", words: [
    ["וְכֵן","And thus"],["הֵחֵלּוּ","began"],["מַעֲשֵׂי","the works of"],["הַחֹשֶׁךְ","darkness"],["לִגְבֹּר","to prevail"],["בְּכָל־בְּנֵי","among all the sons of"],["הָאָדָם","men."],["׃",""]
  ]},
  { num: "נו", words: [
    ["וַיְקַלֵּל","And cursed"],["אֱלֹהִים","God"],["אֶת־הָאָרֶץ","the earth"],["קְלָלָה","with a curse"],["קָשָׁה","sore,"],["וַיִּחַר","and was angry"],["לוֹ","to him"],["בָרְשָׁעִים","with the wicked,"],["בְּכָל־בְּנֵי","with all the sons of"],["הָאָדָם","men"],["אֲשֶׁר","whom"],["עָשָׂה","he had made;"],["׃",""]
  ]},
  { num: "נז", words: [
...
var ms_ch6Verses = [
  ...
  { num: "ה", words: [
    ["וְסֵפֶר","And a book of"],["זִכָּרוֹן","remembrance"],["נִכְתַּב","was kept,"],["בּוֹ","in the which"],["בִּלְשׁוֹן","in the language of"],["אָדָם","Adam,"],["כִּי","for"],["נִתַּן","it was given"],["לְכָל־הַקֹּרְאִים","unto as many as called"],["אֶל־אֱלֹהִים","upon God"],["לִכְתֹּב","to write"],["בְּרוּחַ","by the spirit of"],["נְבוּאָה","inspiration;"],["׃",""]
  ]},
  { num: "ו", words: [
  ...
  { num: "ח", words: [
    ["וְאֶת־הַנְּבוּאָה","Now the prophecy"],["הַזֹּאת","this"],["דִּבֶּר","spake"],["אָדָם","Adam,"],["כַּאֲשֶׁר","as"],["נָעָה","he was moved"],["עָלָיו","upon by"],["רוּחַ","the Spirit"],["הַקֹּדֶשׁ","Holy."],["וְסֵפֶר","And a book of"],["תּוֹלְדֹת","generations"],["נִכְתַּב","was kept"],["לִבְנֵי","of the children of"],["הָאֱלֹהִים","God."],["וְזֶה","And this was"],["סֵפֶר","the book of"],["תּוֹלְדֹת","the generations of"],["אָדָם","Adam,"],["לֵאמֹר","saying:"],["בְּיוֹם","In the day that"],["בְּרֹא","created"],["אֱלֹהִים","God"],["אָדָם","man,"],["בִּדְמוּת","in the likeness of"],["אֱלֹהִים","God"],["עָשָׂה","made he"],["אֹתוֹ","him."],["׃",""]
  ]},
  { num: "ט", words: [
  ...
  { num: "יב", words: [
    ["וַיִּהְיוּ","And were"],["כָּל־יְמֵי","all the days of"],["אָדָם","Adam"],["אֲשֶׁר־חַי","which he lived,"],["תְּשַׁע","nine"],["מֵאוֹת","hundred"],["וּשְׁלֹשִׁים","and thirty"],["שָׁנָה","years,"],["וַיָּמֹת","and he died."],["׃",""]
  ]},
  { num: "יג", words: [
    ["וַיְחִי","And lived"],["שֵׁת","Seth"],["מֵאָה","an hundred"],["וְחָמֵשׁ","and five"],["שָׁנִים","years,"],["וַיּוֹלֶד","and begat"],["אֶת־אֱנוֹשׁ","Enos,"],["וַיִּתְנַבֵּא","and he prophesied"],["כָּל־יָמָיו","all his days,"],["וַיְלַמֵּד","and taught"],["אֶת־בְּנוֹ","his son"],["אֱנוֹשׁ","Enos"],["בְּדַרְכֵי","in the ways of"],["אֱלֹהִים","God;"],["לָכֵן","wherefore"],["נִבָּא","prophesied"],["גַּם","also"],["אֱנוֹשׁ","Enos."],["׃",""]
  ]},
  { num: "יד", words: [
  ...
  { num: "טו", words: [
    ["וּבְנֵי","And the children of"],["הָאָדָם","men"],["רַבּוּ","were numerous"],["עַל־כָּל־פְּנֵי","upon all the face of"],["הָאָרֶץ","the land."],["וּבַיָּמִים","And in the days"],["הָהֵם","those"],["מָשַׁל","reigned"],["הַשָּׂטָן","Satan"],["מֶמְשָׁלָה","with dominion"],["גְּדוֹלָה","great"],["בָּאֲנָשִׁים","among men,"],["וַיִּזְעַם","and raged"],["בְּלִבָּם","in their hearts;"],["וּמֵאָז","and from thenceforth"],["בָּאוּ","came"],["מִלְחָמוֹת","wars"],["וּשְׁפִיכוּת","and shedding of"],["דָּמִים","blood,"],["וְיַד־אִישׁ","and a man's hand"],["בְּאָחִיו","was against his own brother,"],["לְהָמִית","in administering death,"],["בִּגְלַל","because of"],["מַעֲשֵׂי","works"],["סֵתֶר","secret,"],["לְבַקֵּשׁ","seeking for"],["כֹּחַ","power."],["׃",""]
  ]},
  { num: "טז", words: [
    ["וַיִּהְיוּ","And were"],["כָּל־יְמֵי","all the days of"],["שֵׁת","Seth"],["תְּשַׁע","nine"],["מֵאוֹת","hundred"],["וּשְׁתֵּים","and two-"],["עֶשְׂרֵה","ten = twelve"],["שָׁנָה","years,"],["וַיָּמֹת","and he died."],["׃",""]
  ]},
  { num: "יז", words: [
  ...
  { num: "כג", words: [
    ["וַיִּהְיוּ","And they were"],["צֶדֶק","preachers of righteousness,"],["וַיְדַבְּרוּ","and they spake"],["וַיִּתְנַבְּאוּ","and prophesied,"],["וַיִּקְרְאוּ","and called"],["אֶל־כָּל־הָאָדָם","upon all men,"],["בְּכָל־מָקוֹם","everywhere,"],["לָשׁוּב","to repent;"],["וֶאֱמוּנָה","and faith"],["נִלְּמְדָה","was taught"],["לִבְנֵי","unto the children of"],["הָאָדָם","men."],["׃",""]
  ]},
  { num: "כד", words: [
    ["וַיְהִי","And were"],["כָּל־יְמֵי","all the days of"],["יֶרֶד","Jared"],["תְּשַׁע","nine"],["מֵאוֹת","hundred"],["וְשִׁשִּׁים","and sixty"],["וּשְׁתַּיִם","and two"],["שָׁנָה","years,"],["וַיָּמֹת","and he died."],["׃",""]
  ]},
  { num: "כה", words: [
  ...
  { num: "כז", words: [
    ["וַיִּשְׁמַע","And he heard"],["קוֹל","a voice"],["מִן־הַשָּׁמַיִם","from heaven,"],["לֵאמֹר","saying:"],["חֲנוֹךְ","Enoch,"],["בְּנִי","my son,"],["הִנָּבֵא","prophesy"],["אֶל־הָעָם","unto people"],["הַזֶּה","this,"],["וְאָמַרְתָּ","and say"],["אֲלֵיהֶם","unto them—"],["שׁוּבוּ","Repent,"],["כִּי","for"],["כֹה","thus"],["אָמַר","saith"],["יְהוָה","the Lord:"],["קָצַפְתִּי","I am angry"],["עַל־הָעָם","with people"],["הַזֶּה","this,"],["וְחֲרוֹן","and my fierce"],["אַפִּי","anger"],["בָּעַר","is kindled"],["בָּם","against them;"],["כִּי","for"],["הִקְשׁוּ","they have hardened"],["אֶת־לִבָּם","their hearts,"],["וְאָזְנֵיהֶם","and their ears"],["כְּבֵדוֹת","are dull"],["מִשְּׁמֹעַ","of hearing,"],["וְעֵינֵיהֶם","and their eyes"],["לֹא","cannot"],["תוּכַלְנָה","be able"],["לִרְאוֹת","to see"],["לְמֵרָחוֹק","afar off;"],["׃",""]
  ]},
  { num: "כח", words: [
  ...
  { num: "לא", words: [
    ["וַיְהִי","And it came to pass"],["כַּאֲשֶׁר","that when"],["שָׁמַע","heard"],["חֲנוֹךְ","Enoch"],["אֶת־הַדְּבָרִים","words"],["הָאֵלֶּה","these,"],["וַיִּשְׁתַּחוּ","he bowed himself"],["אָרְצָה","to the earth"],["לִפְנֵי","before"],["יְהוָה","the Lord,"],["וַיְדַבֵּר","and spake"],["לִפְנֵי","before"],["יְהוָה","the Lord,"],["לֵאמֹר","saying:"],["מַדּוּעַ","Why is it that"],["מָצָאתִי","I have found"],["חֵן","favor"],["בְּעֵינֶיךָ","in thy sight,"],["וַאֲנִי","and am but"],["נַעַר","a lad,"],["וְכָל־הָעָם","and all the people"],["שֹׂנְאִים","hate"],["אֹתִי","me;"],["כִּי","for"],["כְבַד־פֶּה","slow of speech"],["אָנֹכִי","am I;"],["וְלָמָּה","wherefore"],["אֲנִי","am I"],["עַבְדֶּךָ","thy servant?"],["׃",""]
  ]},
  { num: "לב", words: [
    ["וַיֹּאמֶר","And said"],["יְהוָה","the Lord"],["אֶל־חֲנוֹךְ","unto Enoch:"],["לֵךְ","Go forth"],["וַעֲשֵׂה","and do"],["כַּאֲשֶׁר","as"],["צִוִּיתִיךָ","I have commanded thee,"],["וְאִישׁ","and no man"],["לֹא","not"],["יִדְקָרְךָ","shall pierce thee."],["פְּתַח","Open"],["פִּיךָ","thy mouth,"],["וְיִמָּלֵא","and it shall be filled,"],["וְאֶתֵּן","and I will give"],["לְךָ","thee"],["מַעֲנֶה","utterance,"],["כִּי","for"],["כָל־בָּשָׂר","all flesh"],["בְּיָדִי","is in my hands,"],["וְאֶעֱשֶׂה","and I will do"],["כַּטּוֹב","as good"],["בְּעֵינָי","in mine eyes."],["׃",""]
  ]},
  { num: "לג", words: [
  ...
  { num: "לט", words: [
    ["וַיְהִי","And it came to pass"],["כַּאֲשֶׁר","when"],["שָׁמְעוּ","they heard"],["אֹתוֹ","him,"],["וְאִישׁ","no man"],["לֹא","not"],["שָׁלַח","laid"],["בּוֹ","upon him"],["יָד","his hands;"],["כִּי","for"],["פַחַד","fear"],["בָּא","came"],["עַל־כָּל־הַשֹּׁמְעִים","on all them that heard him;"],["כִּי","for"],["הִתְהַלֶּךְ","he walked"],["עִם־אֱלֹהִים","with God."],["׃",""]
  ]},
  { num: "מ", words: [
  ...
  { num: "מא", words: [
    ["וַיֹּאמֶר","And he said"],["אֲלֵיהֶם","unto them:"],["מֵאֶרֶץ","From the land of"],["קֵינָן","Cainan,"],["יָצָאתִי","came I,"],["אֶרֶץ","the land of"],["אֲבוֹתַי","my fathers,"],["אֶרֶץ","a land of"],["צֶדֶק","righteousness"],["עַד","unto"],["הַיּוֹם","day"],["הַזֶּה","this;"],["וְאָבִי","and my father"],["לִמְּדַנִי","taught me"],["בְּכָל־דַּרְכֵי","in all the ways of"],["אֱלֹהִים","God."],["׃",""]
  ]},
  { num: "מב", words: [
  ...
  { num: "נ", words: [
    ["אַךְ","But"],["הוֹדִיעַ","hath made known"],["אֱלֹהִים","God"],["לַאֲבוֹתֵינוּ","unto our fathers"],["כִּי","that"],["כָל־הָאָדָם","all men"],["יָשׁוּבוּ","must repent."],["׃",""]
  ]},
  { num: "נא", words: [
  ...
  { num: "נב", words: [
    ["וְגַם","And he also"],["אָמַר","said"],["אֵלָיו","unto him:"],["אִם־תָּשׁוּב","If thou wilt turn"],["אֵלַי","unto me,"],["וְתִשְׁמַע","and hearken"],["בְּקוֹלִי","unto my voice,"],["וְתַאֲמִין","and believe,"],["וְתָשׁוּב","and repent"],["מִכָּל־פְּשָׁעֶיךָ","of all thy transgressions,"],["וְנִטְבַּלְתָּ","and be baptized,"],["בַּמַּיִם","even in water,"],["בְּשֵׁם","in the name of"],["בְּנִי","my Only Begotten"],["יְחִידִי","Son,"],["הַמָּלֵא","who is full of"],["חֶסֶד","grace"],["וֶאֱמֶת","and truth,"],["אֲשֶׁר","which is"],["הוּא","he,"],["יֵשׁוּעַ","Jesus"],["הַמָּשִׁיחַ","Christ,"],["הַשֵּׁם","the name"],["הַיָּחִיד","the only one"],["אֲשֶׁר","which"],["יִנָּתֵן","shall be given"],["תַּחַת","under"],["הַשָּׁמַיִם","heaven,"],["אֲשֶׁר","whereby"],["בּוֹ","in it"],["תָּבֹא","shall come"],["יְשׁוּעָה","salvation"],["לִבְנֵי","unto the children of"],["הָאָדָם","men;"],["תְּקַבְּלוּ","ye shall receive"],["אֶת־מַתַּת","the gift of"],["רוּחַ","the Spirit"],["הַקֹּדֶשׁ","Holy,"],["וְשָׁאַלְתֶּם","asking"],["כֹּל","all things"],["בִּשְׁמוֹ","in his name,"],["וְכֹל","and whatsoever"],["אֲשֶׁר","which"],["תִּשְׁאֲלוּ","ye shall ask,"],["יִנָּתֵן","it shall be given"],["לָכֶם","unto you."],["׃",""]
  ]},
  { num: "נג", words: [
  ...
  { num: "סא", words: [
    ["לָכֵן","Therefore"],["נִתַּן","it is given"],["לָשֶׁבֶת","to abide"],["בָּכֶם","in you;"],["עֵדוּת","the record of"],["הַשָּׁמַיִם","heaven;"],["הַמְּנַחֵם","the Comforter;"],["שַׁלְוַת","the peaceable things of"],["כְּבוֹד","glory"],["אֲשֶׁר","which"],["לֹא","not"],["יָמוּת","dieth;"],["אֱמֶת","the truth of"],["כָּל־הַדְּבָרִים","all things;"],["הַמְחַיֶּה","that which quickeneth"],["אֶת־כֹּל","all things,"],["הַיֹּדֵעַ","which maketh alive"],["כֹּל","all things;"],["וְלוֹ","that which knoweth"],["כָל־כֹּחַ","all things,"],["כְּחָכְמָה","and hath all power"],["וּכְחֶסֶד","according to wisdom, mercy,"],["וְכֶאֱמֶת","truth,"],["וּכְצֶדֶק","justice,"],["וּכְמִשְׁפָּט","and judgment."],["׃",""]
  ]},
  { num: "סב", words: [
    ["וְעַתָּה","And now,"],["הִנֵּה","behold,"],["אֹמֵר","I say"],["אֲנִי","I"],["לָכֶם","unto you:"],["זֹאת","This"],["הִיא","is"],["תָּכְנִית","the plan of"],["הַיְשׁוּעָה","salvation"],["לְכָל־הָאָדָם","unto all men,"],["בְּדַם","through the blood of"],["יְחִידִי","mine Only Begotten,"],["אֲשֶׁר","who"],["יָבֹא","shall come"],["בְּאֶמְצַע","in the meridian of"],["הָעִתִּים","time."],["׃",""]
  ]},
  { num: "סג", words: [
    ["וְהִנֵּה","And behold,"],["לְכָל־הַדְּבָרִים","all things"],["דְּמוּתָם","have their likeness,"],["וְכָל־הַדְּבָרִים","and all things"],["נִבְרְאוּ","are created"],["וְנַעֲשׂוּ","and made"],["לְהָעִיד","to bear record of"],["עָלַי","me,"],["דְּבָרִים","things"],["זְמַנִּיִּים","temporal,"],["וְדָבָרִים","and things"],["רוּחָנִיִּים","spiritual;"],["דְּבָרִים","things"],["אֲשֶׁר","which are"],["בַּשָּׁמַיִם","in the heavens"],["מִמַּעַל","above,"],["וְדָבָרִים","and things"],["אֲשֶׁר","which are"],["עַל־הָאָרֶץ","on the earth,"],["וְדָבָרִים","and things"],["אֲשֶׁר","which are"],["בָּאָרֶץ","in the earth,"],["וְדָבָרִים","and things"],["אֲשֶׁר","which are"],["מִתַּחַת","under"],["לָאָרֶץ","the earth,"],["מִמַּעַל","both above"],["וּמִתָּחַת","and beneath:"],["כָּל־הַדְּבָרִים","all things"],["מְעִידִים","bear record"],["עָלָי","of me."],["׃",""]
  ]},
  { num: "סד", words: [
  ...
  { num: "סו", words: [
    ["וַיִּשְׁמַע","And he heard"],["קוֹל","a voice"],["מִן־הַשָּׁמַיִם","from heaven,"],["לֵאמֹר","saying:"],["נִטְבַּלְתָּ","Thou art baptized"],["בָּאֵשׁ","with fire,"],["וּבְרוּחַ","and with the Spirit"],["הַקֹּדֶשׁ","Holy."],["זֹאת","This is"],["עֵדוּת","the record of"],["הָאָב","the Father,"],["וְהַבֵּן","and the Son,"],["מֵעַתָּה","from henceforth"],["וְעַד־עוֹלָם","and forever;"],["׃",""]
  ]},
  { num: "סז", words: [
...
var ms_ch7Verses = [
  ...
  { num: "ח", words: [
    ["כִּי","For"],["יְקַלֵּל","shall curse"],["יְהוָה","the Lord"],["אֶת־הָאָרֶץ","the land"],["בְּחֹם","with much"],["רַב","heat,"],["וּשְׁמָמָתָהּ","and the barrenness thereof"],["תֵּצֵא","shall go forth"],["לְדֹרֹתָם","for ever;"],["וַיְהִי","and there was"],["שַׁחֲרוּת","a blackness"],["עַל־בְּנֵי","upon the children of"],["כְנָעַן","Canaan,"],["וַיִּהְיוּ","and they were"],["לְבוּז","despised"],["בְּכָל־הָעַמִּים","among all people."],["׃",""]
  ]},
  { num: "ט", words: [
    ["וַיֹּאמֶר","And said"],["יְהוָה","the Lord"],["אֵלַי","unto me:"],["הַבֵּט","Look;"],["וָאַבֵּט","and I looked,"],["וָאֵרֶא","and beheld"],["אֶרֶץ","the land of"],["שָׁרוֹן","Sharon,"],["וְאֶרֶץ","and the land of"],["חֲנוֹךְ","Enoch,"],["וְאֶרֶץ","and the land of"],["אָמְנֵר","Omner,"],["וְאֶרֶץ","and the land of"],["חֵנִי","Heni,"],["וְאֶרֶץ","and the land of"],["שֵׁם","Shem,"],["וְאֶרֶץ","and the land of"],["וְאֶרֶץ","the land of"],["חֲנַנִּיָּה","Hanannihah,"],["וְאֶת־כָּל־יֹשְׁבֵיהֶן","and all the inhabitants thereof."],["׃",""]
  ]},
  { num: "י", words: [
  ...
  { num: "טו", words: [
    ["וְגַם","And also"],["הַנְּפִילִים","the giants of"],["בָּאָרֶץ","the land,"],["עָמְדוּ","stood"],["מֵרָחוֹק","afar off;"],["וַתֵּצֵא","and there went forth"],["קְלָלָה","a curse"],["עַל־כָּל־הָעָם","upon all people"],["הַנִּלְחָמִים","that fought"],["בֵּאלֹהִים","against God;"],["׃",""]
  ]},
  { num: "טז", words: [
  ...
  { num: "כא", words: [
    ["וַיַּרְא","And showed"],["יְהוָה","the Lord"],["חֲנוֹךְ","unto Enoch"],["אֶת־כָּל־יֹשְׁבֵי","all the inhabitants of"],["הָאָרֶץ","the earth;"],["וַיַּבֵּט","and he beheld,"],["וְהִנֵּה","and lo,"],["צִיּוֹן","Zion,"],["בִּמְרוּצַת","in process of"],["הַיָּמִים","time,"],["נִלְקְחָה","was taken up"],["הַשָּׁמָיְמָה","into heaven."],["וַיֹּאמֶר","And said"],["יְהוָה","the Lord"],["אֶל־חֲנוֹךְ","unto Enoch:"],["הִנֵּה","Behold"],["מִשְׁכָּנִי","mine abode"],["לָעַד","for ever."],["׃",""]
  ]},
  { num: "כב", words: [
    ["וַיַּרְא","And beheld"],["חֲנוֹךְ","Enoch"],["גַּם","also"],["שְׁאָר","the residue of"],["הָעָם","the people"],["בְּנֵי","which were the sons of"],["אָדָם","Adam;"],["וַיִּהְיוּ","and they were"],["מְעֹרָבִים","a mixture of"],["בְּכָל־זֶרַע","all the seed of"],["אָדָם","Adam"],["זוּלָתִי","save it was"],["זֶרַע","the seed of"],["קַיִן","Cain,"],["כִּי","for"],["זֶרַע","the seed of"],["קַיִן","Cain"],["שְׁחֹרִים","black"],["הָיוּ","they were,"],["וְלֹא","and not"],["הָיָה","there was"],["לָהֶם","unto them"],["מָקוֹם","a place"],["בֵּינֵיהֶם","for them."],["׃",""]
  ]},
  { num: "כג", words: [
    ["וְאַחֲרֵי","And after that"],["הִלָּקַח","was taken up"],["צִיּוֹן","Zion"],["הַשָּׁמַיְמָה","into heaven,"],["הִבִּיט","beheld"],["חֲנוֹךְ","Enoch,"],["וְהִנֵּה","and behold,"],["כָּל־גּוֹיֵי","all the nations of"],["הָאָרֶץ","the earth"],["לְפָנָיו","were before him;"],["׃",""]
  ]},
  { num: "כד", words: [
    ["וַיָּבֹא","And there came"],["דוֹר","generation"],["אַחַר","upon"],["דּוֹר","generation;"],["וְחֲנוֹךְ","and Enoch"],["נִשָּׂא","was lifted up,"],["רָם","high,"],["בְּחֵיק","even in the bosom of"],["הָאָב","the Father,"],["וּבֶן־הָאָדָם","and of the Son of Man;"],["וְהִנֵּה","and behold,"],["כֹּחַ","the power of"],["הַשָּׂטָן","Satan was"],["עַל־כָּל־פְּנֵי","upon all the face of"],["הָאָרֶץ","the earth."],["׃",""]
  ]},
  { num: "כה", words: [
  ...
  { num: "כו", words: [
    ["וַיַּרְא","And he beheld"],["אֶת־הַשָּׂטָן","Satan;"],["וְשַׁלְשֶׁלֶת","and a chain"],["גְּדוֹלָה","great"],["בְּיָדוֹ","in his hand,"],["וַיְכַס","and it veiled"],["פְּנֵי","the face of"],["כָל־הָאָרֶץ","the whole earth"],["בְּחֹשֶׁךְ","with darkness;"],["וַיִּשָּׂא","and he lifted up"],["עֵינָיו","his eyes,"],["וַיִּצְחַק","and laughed,"],["וּמַלְאָכָיו","and his angels"],["שָׂמֵחוּ","rejoiced."],["׃",""]
  ]},
  { num: "כז", words: [
    ["וַיַּרְא","And saw"],["חֲנוֹךְ","Enoch"],["מַלְאָכִים","angels"],["יֹרְדִים","descending"],["מִן־הַשָּׁמַיִם","out of heaven,"],["מְעִידִים","bearing testimony of"],["בָּאָב","the Father"],["וּבַבֵּן","and the Son;"],["וְרוּחַ","and the Spirit"],["הַקֹּדֶשׁ","Holy"],["נָפְלָה","fell"],["עַל־רַבִּים","on many,"],["וַיִּלָּקְחוּ","and they were caught up"],["בִּגְבוּרוֹת","by the powers of"],["הַשָּׁמַיִם","heaven"],["אֶל־צִיּוֹן","into Zion."],["׃",""]
  ]},
  { num: "כח", words: [
  ...
  { num: "מ", words: [
    ["לָכֵן","Wherefore,"],["בִּגְלַל","because of"],["זֹאת","this,"],["יִבְכּוּ","shall weep"],["הַשָּׁמַיִם","the heavens,"],["וְכָל־מַעֲשֵׂה","yea, and all the workmanship of"],["יָדָי","mine hands."],["׃",""]
  ]},
  { num: "מא", words: [
    ["וַיְדַבֵּר","And spake"],["יְהוָה","the Lord"],["אֶל־חֲנוֹךְ","unto Enoch,"],["וַיַּגֶּד־לוֹ","and told him"],["כָּל־מַעֲשֵׂה","all the doings of"],["בְנֵי","the children of"],["הָאָדָם","men;"],["וַיֵּדַע","wherefore knew"],["חֲנוֹךְ","Enoch,"],["וַיַּבֵּט","and looked"],["אֶל־רִשְׁעָתָם","upon their wickedness,"],["וְאֶל־עָנְיָם","and their misery,"],["וַיֵּבְךְּ","and wept,"],["וַיִּפְרֹשׂ","and stretched forth"],["יָדָיו","his arms,"],["וְלִבּוֹ","and his heart"],["הִתְרַחֵב","swelled wide"],["כָּעוֹלָם","as eternity;"],["וּמֵעָיו","and his bowels"],["נִכְמָרוּ","yearned;"],["וְכָל־הָעוֹלָם","and all eternity"],["נִזְדַּעֲזֵעַ","shook."],["׃",""]
  ]},
  { num: "מב", words: [
    ["וַיַּרְא","And saw"],["חֲנוֹךְ","Enoch"],["גַּם","also"],["נֹחַ","Noah,"],["וּמִשְׁפַּחְתּוֹ","and his family;"],["כִּי","that"],["זֶרַע","the posterity of"],["כָּל־בְּנֵי","all the sons of"],["נֹחַ","Noah"],["יִוָּשַׁע","should be saved"],["תְּשׁוּעָה","with a salvation"],["לְעֵת","for a time;"],["׃",""]
  ]},
  { num: "מג", words: [
  ...
  { num: "מה", words: [
    ["וַיַּבֵּט","And looked"],["חֲנוֹךְ","Enoch,"],["וּמִנֹּחַ","and from Noah"],["רָאָה","he beheld"],["כָּל־מִשְׁפְּחוֹת","all the families of"],["הָאָרֶץ","the earth;"],["וַיִּצְעַק","and he cried"],["אֶל־יְהוָה","unto the Lord,"],["לֵאמֹר","saying:"],["מָתַי","When"],["יָבֹא","shall come"],["יוֹם","the day of"],["יְהוָה","the Lord?"],["מָתַי","When"],["יִשָּׁפֵךְ","shall be shed"],["דַּם","the blood of"],["הַצַּדִּיק","the Righteous,"],["לְמַעַן","that"],["יִתְקַדְּשׁוּ","may be sanctified"],["כָל־הָאֲבֵלִים","all they that mourn"],["וְיִחְיוּ","and may have life"],["חַיֵּי","of"],["עַד","eternity?"],["׃",""]
  ]},
  { num: "מו", words: [
  ...
  { num: "נב", words: [
    ["וַיִּשְׁלַח","And he sent forth"],["גְּזֵרָה","a decree,"],["אֲשֶׁר","which"],["לֹא","not"],["תָשׁוּב","shall return,"],["כִּי","that"],["שְׁאֵרִית","a remnant of"],["מִזַּרְעוֹ","his seed"],["תִּמָּצֵא","should be found"],["תָמִיד","always"],["בְּכָל־הַגּוֹיִם","among all nations,"],["בְּעוֹד","while"],["הָאָרֶץ","the earth"],["עֹמֶדֶת","should stand;"],["׃",""]
  ]},
  { num: "נג", words: [
    ["וַיֹּאמֶר","And said"],["יְהוָה","the Lord:"],["בָּרוּךְ","Blessed is he"],["אֲשֶׁר","whose"],["מִזַּרְעוֹ","seed"],["יָבֹא","shall come"],["הַמָּשִׁיחַ","Messias;"],["כִּי","for"],["אֲנִי","I am"],["הַמָּשִׁיחַ","Messiah,"],["מֶלֶךְ","the King of"],["צִיּוֹן","Zion,"],["צוּר","the Rock of"],["הַשָּׁמַיִם","Heaven,"],["הָרָחָב","which is broad"],["כָּעוֹלָם","as eternity;"],["כָּל־הַבָּא","whoso cometh"],["בַשַּׁעַר","in at the gate"],["וְעֹלֶה","and climbeth up"],["בִי","by me,"],["לֹא","not"],["יִפֹּל","shall fall"],["לְעוֹלָם","ever."],["לָכֵן","Wherefore,"],["בְּרוּכִים","blessed"],["אֲשֶׁר","are they of whom"],["דִּבַּרְתִּי","I have spoken"],["עֲלֵיהֶם","concerning them,"],["כִּי","for"],["יֵצְאוּ","they shall come forth"],["בְּשִׁירַת","with songs of"],["שִׂמְחַת","joy"],["עַד","everlasting."],["׃",""]
  ]},
  { num: "נד", words: [
  ...
  { num: "סב", words: [
    ["וּצְדָקָה","And righteousness"],["אוֹרִיד","will I send down"],["מִן־הַשָּׁמַיִם","out of heaven;"],["וֶאֱמֶת","and truth"],["אוֹצִיא","will I send forth"],["מִן־הָאָרֶץ","out of the earth,"],["לְהָעִיד","to bear testimony of"],["עַל־יְחִידִי","mine Only Begotten;"],["תְּחִיָּתוֹ","his resurrection"],["מִן־הַמֵּתִים","from the dead;"],["וְגַם","yea, and also"],["תְּחִיַּת","the resurrection of"],["כָּל־הָאָדָם","all men;"],["וּצְדָקָה","and righteousness"],["וֶאֱמֶת","and truth"],["אָגֹרֵם","will I cause"],["לִשְׁטֹף","to sweep"],["הָאָרֶץ","the earth"],["כַּמַּבּוּל","as with a flood,"],["לְאַסֵּף","to gather out"],["בְּחִירַי","mine elect"],["מֵאַרְבַּע","from the four"],["כַּנְפוֹת","quarters of"],["הָאָרֶץ","the earth,"],["אֶל־מָקוֹם","unto a place"],["אֲשֶׁר","which"],["אָכִין","I shall prepare,"],["עִיר","a City of"],["קֹדֶשׁ","Holiness,"],["לְמַעַן","that"],["עַמִּי","my people"],["יַחְגְּרוּ","may gird up"],["מָתְנֵיהֶם","their loins,"],["וְיִצְפּוּ","and be looking forth"],["לְעֵת","for the time of"],["בֹּאִי","my coming;"],["כִּי","for"],["שָׁם","there"],["יִהְיֶה","shall be"],["מִשְׁכָּנִי","my tabernacle,"],["וְיִקָּרֵא","and it shall be called"],["צִיּוֹן","Zion,"],["יְרוּשָׁלַיִם","a Jerusalem"],["חֲדָשָׁה","New."],["׃",""]
  ]},
  { num: "סג", words: [
    ["וַיֹּאמֶר","And said"],["יְהוָה","the Lord"],["אֶל־חֲנוֹךְ","unto Enoch:"],["אָז","Then"],["תִּפְגְּשׁוּ","shall meet"],["אַתָּה","thou"],["וְכָל־עִירְךָ","and all thy city"],["אוֹתָם","them"],["שָׁם","there,"],["וּנְקַבְּלֵם","and we will receive them"],["אֶל־חֵיקֵנוּ","into our bosom,"],["וְיִרְאוּ","and they shall see"],["אֹתָנוּ","us;"],["וְנִפֹּל","and we will fall"],["עַל־צַוָּארֵיהֶם","upon their necks,"],["וְיִפְּלוּ","and they shall fall"],["עַל־צַוָּארֵינוּ","upon our necks,"],["וְנִשַּׁק","and we will kiss"],["אִישׁ","each"],["אָחִיו","other;"],["׃",""]
  ]},
  { num: "סד", words: [
    ["וְשָׁם","And there"],["יִהְיֶה","shall be"],["מִשְׁכָּנִי","mine abode,"],["וְהוּא","and it shall be"],["צִיּוֹן","Zion,"],["הַיּוֹצֵאת","which shall come forth"],["מִכָּל־מַעֲשַׂי","out of all the creations"],["וּלְאֶלֶף","which I have made; and for the space of a thousand"],["שָׁנִים","years"],["תָּנוּחַ","shall rest"],["הָאָרֶץ","the earth."],["׃",""]
  ]},
  { num: "סה", words: [
  ...
  { num: "סז", words: [
    ["וַיַּרְא","And showed"],["יְהוָה","the Lord unto"],["חֲנוֹךְ","Enoch"],["כָּל־הַדְּבָרִים","all things,"],["עַד־קֵץ","even unto the end of"],["הָעוֹלָם","the world;"],["וַיַּרְא","and he saw"],["יוֹם","the day of"],["הַצַּדִּיקִים","the righteous,"],["גְּאֻלָּתָם","the hour of their redemption,"],["וַיְקַבֵּל","and received"],["מְלֹא","a fulness of"],["שִׂמְחָה","joy;"],["׃",""]
  ]},
  { num: "סח", words: [
    ["וְכָל־יְמֵי","And all the days of"],["צִיּוֹן","Zion,"],["בִּימֵי","in the days of"],["חֲנוֹךְ","Enoch,"],["שְׁלֹשׁ","were three"],["מֵאוֹת","hundred"],["וְשִׁשִּׁים","and sixty"],["וְחָמֵשׁ","and five"],["שָׁנִים","years."],["׃",""]
  ]},
  { num: "סט", words: [
    ["וְחֲנוֹךְ","And Enoch"],["וְכָל־עַמּוֹ","and all his people"],["הִתְהַלְּכוּ","walked"],["עִם־אֱלֹהִים","with God,"],["וְהוּא","and he"],["שָׁכַן","dwelt"],["בְּתוֹכָם","in the midst of Zion;"],["וַיְהִי","and it came to pass"],["צִיּוֹן","that Zion"],["אֵינֶנָּה","was not,"],["כִּי","for"],["לָקַח","took"],["אֹתָהּ","her"],["אֱלֹהִים","God"],["אֶל־חֵיקוֹ","up into his own bosom;"],["וּמֵאָז","and from thence"],["יָצָא","went forth"],["הַדָּבָר","the saying,"],["צִיּוֹן","Zion"],["נָסָה","is fled."],["׃",""]
  ]}
];
renderVerseSet(ms_ch7Verses, 'ms-ch7-verses');
var ms_ch8Verses = [
  { num: "א", words: [
    ["וַיִּהְיוּ","And were"],["כָּל־יְמֵי","all the days of"],["חֲנוֹךְ","Enoch"],["אַרְבַּע","four"],["מֵאוֹת","hundred"],["וּשְׁלֹשִׁים","and thirty"],["שָׁנָה","years."],["׃",""]
  ]},
  { num: "ב", words: [
  ...
  { num: "ג", words: [
    ["וַיְהִי","And it came to pass"],["וַיִּתְנַבֵּא","that prophesied"],["מְתוּשֶׁלַח","Methuselah"],["כִּי","that"],["מֵחֲלָצָיו","from his loins"],["יֵצְאוּ","should spring"],["כָּל־מַמְלְכוֹת","all the kingdoms of"],["הָאָרֶץ","the earth"],["בְּיַד","through"],["נֹחַ","Noah,"],["וַיִּקַּח","and he took"],["כָּבוֹד","glory"],["לְעַצְמוֹ","unto himself."],["׃",""]
  ]},
  { num: "ד", words: [
  ...
  { num: "ז", words: [
    ["וַיִּהְיוּ","And were"],["כָּל־יְמֵי","all the days of"],["מְתוּשֶׁלַח","Methuselah"],["תְּשַׁע","nine"],["מֵאוֹת","hundred"],["וְשִׁשִּׁים","and sixty"],["וָתֵשַׁע","and nine"],["שָׁנִים","years,"],["וַיָּמֹת","and he died."],["׃",""]
  ]},
  { num: "ח", words: [
  ...
  { num: "יא", words: [
    ["וַיִּהְיוּ","And were"],["כָּל־יְמֵי","all the days of"],["לֶמֶךְ","Lamech"],["שְׁבַע","seven"],["מֵאוֹת","hundred"],["וְשִׁבְעִים","and seventy"],["וָשֶׁבַע","and seven"],["שָׁנִים","years,"],["וַיָּמֹת","and he died."],["׃",""]
  ]},
  { num: "יב", words: [
  ...
  { num: "יז", words: [
    ["וַיֹּאמֶר","And said"],["יְהוָה","the Lord"],["אֶל־נֹחַ","unto Noah:"],["לֹא־יָדוֹן","Not shall strive"],["רוּחִי","My Spirit"],["בָאָדָם","with man"],["לְעֹלָם","for ever,"],["כִּי","for"],["יֵדַע","he shall know"],["כִּי","that"],["כָל־בָּשָׂר","all flesh"],["יָמוּת","shall die;"],["אַךְ","yet"],["יָמָיו","his days"],["יִהְיוּ","shall be"],["מֵאָה","an hundred"],["וְעֶשְׂרִים","and twenty"],["שָׁנָה","years;"],["וְאִם־לֹא","and if not"],["יָשׁוּבוּ","shall repent"],["אֲנָשִׁים","men,"],["אֲשַׁלַּח","I will send"],["אֶת־הַמַּבּוּל","the floods"],["עֲלֵיהֶם","upon them."],["׃",""]
  ]},
  { num: "יח", words: [
  ...
  { num: "כב", words: [
    ["וַיַּרְא","And saw"],["אֱלֹהִים","God"],["כִּי","that"],["רַבָּה","great was"],["רָעַת","the wickedness of"],["הָאָדָם","man"],["בָּאָרֶץ","on the earth;"],["וְכָל־אִישׁ","and every man"],["נִשָּׂא","was lifted up"],["בְּמַחֲשְׁבֹת","in the imagination of"],["לִבּוֹ","his heart,"],["רַק","being only"],["רַע","evil"],["כָּל־הַיּוֹם","continually."],["׃",""]
  ]},
  { num: "כג", words: [
  ...
  { num: "כד", words: [
    ["הַאֲמִינוּ","Believe"],["וְשׁוּבוּ","and repent"],["מֵחַטֹּאתֵיכֶם","of your sins,"],["וְהִטָּבְלוּ","and be baptized"],["בְּשֵׁם","in the name of"],["יֵשׁוּעַ","Jesus"],["הַמָּשִׁיחַ","Christ,"],["בֶּן־אֱלֹהִים","the Son of God,"],["כַּאֲבוֹתֵינוּ","even as our fathers,"],["וּתְקַבְּלוּ","and ye shall receive"],["אֶת־רוּחַ","the Spirit"],["הַקֹּדֶשׁ","Holy,"],["לְמַעַן","that"],["יִגָּלֶה","may be manifest"],["לָכֶם","unto you"],["כֹּל","all things;"],["וְאִם־לֹא","and if not"],["תַעֲשׂוּ","ye do"],["כֵן","this,"],["יָבֹא","shall come"],["הַמַּבּוּל","the floods"],["עֲלֵיכֶם","upon you;"],["וְלֹא","and not"],["שָׁמֵעוּ","they hearkened."],["׃",""]
  ]},
  { num: "כה", words: [
  ...
  { num: "כט", words: [
    ["וַיַּרְא","And looked"],["אֱלֹהִים","God"],["אֶת־הָאָרֶץ","upon the earth,"],["וְהִנֵּה","and behold,"],["נִשְׁחָתָה","it was corrupt,"],["כִּי־הִשְׁחִית","for had corrupted"],["כָּל־בָּשָׂר","all flesh"],["אֶת־דַּרְכּוֹ","his way"],["עַל־הָאָרֶץ","upon the earth."],["׃",""]
  ]},
  { num: "ל", words: [
    ["וַיֹּאמֶר","And said"],["אֱלֹהִים","God"],["אֶל־נֹחַ","unto Noah:"],["קֵץ","The end of"],["כָּל־בָּשָׂר","all flesh"],["בָּא","is come"],["לְפָנַי","before me,"],["כִּי־מָלְאָה","for is filled"],["הָאָרֶץ","the earth"],["חָמָס","with violence,"],["מִפְּנֵיהֶם","through them;"],["וְהִנְנִי","and behold I"],["מַשְׁחִיתָם","will destroy"],["אֶת־כָּל־בָּשָׂר","all flesh"],["מִן־הָאָרֶץ","from off the earth."],["׃",""]
  ]}
];
