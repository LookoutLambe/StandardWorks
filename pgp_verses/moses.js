...
var ms_ch5Verses = [
  ...
  { num: "יד", words: [
    ["וַיִּקְרָא","And called"],["יְהוָה","the Lord"],["אֱלֹהִים","God"],["אֶל־הָאָדָם","upon men"],["בְּכָל־מָקוֹם","everywhere,"],["בְּרוּחַ","by the Holy Ghost,"],["הַקֹּדֶשׁ",""],["וַיְצַו","and commanded"],["אֹתָם","them"],["לָשׁוּב","that they should repent."],["׃",""]
  ]},
  { num: "טו", words: [
